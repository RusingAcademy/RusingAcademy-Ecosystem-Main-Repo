...
## Admin Control Center Phase 2 (6 Février 2026)

### Bundles Management
- [x] Créer procédures tRPC admin pour bundles (CRUD)
- [x] Ajouter onglet "Bundles" dans le dashboard admin
- [x] Interface de création de bundle (titre, description, sélection de cours, prix)
- [x] Affichage des bundles existants avec actions (éditer, publier, supprimer)

### Quick Actions Bar
- [x] Ajouter barre d'actions rapides en haut du dashboard admin
- [x] Actions: New Course, New Bundle, Manage Users, Applications, Analytics, CRM
- [ ] Raccourcis clavier pour actions fréquentes (future phase)
