...
export async function generateWeeklyProgressReport(
  ...
  if (aiCount >= 5) {
    achievements.push("Practiced 5+ times with Prof Steven AI!");
  }
  if (totalMinutes >= 120) {
...
export async function sendWeeklyProgressEmail(data: LearnerProgressData): Promise<void> {
  ...
  const labels = isEnglish
    ? {
        ...
        aiPractice: "Prof Steven AI Practice",
        ...
        tip3: "Use Prof Steven AI for conversation practice between sessions",
    ...
    : {
        ...
        aiPractice: "Pratique avec Prof Steven IA",
        ...
        tip3: "Utilisez Prof Steven IA pour la pratique de conversation entre les sessions",
