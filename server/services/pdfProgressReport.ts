...
export function generateReportHTML(data: ProgressReportData, language: "fr" | "en" = "en"): string {
  const l = language === "fr" ? {
    ...
    footer: "Ce rapport a été généré automatiquement par RusingAcademy.",
  } : {
    ...
    footer: "This report was automatically generated by RusingAcademy.",
  };
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>${l.footer}</p>
      <p style="margin-top: 4px;">RusingAcademy • Lingueefy • Barholex Media</p>
    </div>
  </div>
</body>
</html>`;
