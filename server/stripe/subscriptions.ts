...
export const SUBSCRIPTION_PLANS = {
  ...
  prof_steven_ai: {
    ...
    description: "Unlimited AI-powered practice sessions with Prof Steven",
  ...
  bundle: {
    ...
    description: "Premium Membership + Prof Steven AI at a discounted rate",
    monthlyPrice: 3999, // $39.99 CAD
    annualPrice: 39900, // $399.00 CAD
    features: [
      "Everything in Premium Membership",
      "Everything in Prof Steven AI Premium",
      "Priority support",
