...
import BecomeCoachNew from "./pages/BecomeCoachNew";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/lingueefy/new" component={LingueefyLanding} />
      ...
      <Route path="/become-a-coach/new" component={BecomeCoachNew} />
