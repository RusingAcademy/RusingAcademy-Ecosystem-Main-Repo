...
export const ECOSYSTEM_PLATFORMS: EcosystemPlatform[] = [
  {
    ...
    icon: "graduation-cap",
    color: "var(--semantic-warning, var(--barholex-gold-hover))",
    bgGradient: "linear-gradient(135deg, var(--semantic-warning, var(--barholex-gold-hover)) 0%, #C45E1A 100%)",
    url: "/rusingacademy",
    isInternal: true,
  },
  {
    ...
    bgGradient: "linear-gradient(135deg, var(--color-teal-400, #2DD4BF) 0%, var(--color-teal-500, #14B8A6) 100%)",
    url: "/",
    isCurrent: true,
    isInternal: true,
  },
