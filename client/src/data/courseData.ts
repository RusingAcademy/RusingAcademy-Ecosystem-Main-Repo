...
// RusingÂcademy — Barholex Media Inc.
// ============================================================
...
const fslPaths: Path[] = [
  {
    ...
    color: "var(--color-blue-600, var(--semantic-info))",
    totalLessons: 16,
    totalActivities: 112,
    completed: false,
    progress: 0,
...
const eslPaths: Path[] = [
  ...
  },
  {
    ...
    cefrLevel: "A2", coverUrl: CDN.covers.esl.pathII, badgeUrl: CDN.badges.pathCompletion[1], color: "var(--semantic-success, var(--success))",
  ...
  },
  {
    ...
    cefrLevel: "B1", coverUrl: CDN.covers.esl.pathIII, badgeUrl: CDN.badges.pathCompletion[2], color: "var(--semantic-warning, var(--warning))",
    totalLessons: 16, totalActivities: 112, completed: false, progress: 0,
    modules: [
  ...
  },
  {
    ...
    cefrLevel: "B2", coverUrl: CDN.covers.esl.pathIV, badgeUrl: CDN.badges.pathCompletion[3], color: "var(--color-violet-600, var(--accent-purple))",
    totalLessons: 16, totalActivities: 112, completed: false, progress: 0,
    modules: [
  ...
  },
  {
    ...
    cefrLevel: "C1", coverUrl: CDN.covers.esl.pathV, badgeUrl: CDN.badges.pathCompletion[4], color: "var(--semantic-danger, var(--danger))",
    totalLessons: 16, totalActivities: 112, completed: false, progress: 0,
    modules: [
