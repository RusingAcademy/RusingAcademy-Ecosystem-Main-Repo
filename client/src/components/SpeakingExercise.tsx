    ...
    <div className="bg-white dark:bg-background rounded-2xl shadow-lg overflow-hidden max-w-2xl mx-auto">
      ...
      <div className="p-6">
        ...
        <div className="bg-foundation-soft rounded-xl p-4 mb-6">
          ...
          <p className="text-black dark:text-foreground font-medium">{displayPrompt}</p>
        </div>
        ...
        {targetPhrase && (
          <div className="bg-white dark:bg-background border border-gray-200 dark:border-border dark:border-border rounded-xl p-4 mb-6">
            ...
            <p className="text-xl font-medium text-black dark:text-foreground italic mb-4">"{targetPhrase}"</p>
            ...
            <div className="flex items-center gap-3">
              {!generatedAudioUrl ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-black dark:text-foreground ml-2">
        ...
        <div className="text-center py-6">
          {!audioUrl ? (
            <>
              ...
              {/* Recording Status */}
              <p className="mt-4 text-black dark:text-foreground">
                {isRecording ? (
              ...
              <div className="bg-gray-100 dark:bg-card rounded-xl p-4 mb-4">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="text-left">
                    <p className="font-medium text-black dark:text-foreground">
                      {language === "fr" ? "Votre enregistrement" : "Your recording"}
                    </p>
                    <p className="text-sm text-black dark:text-foreground">{formatTime(recordingTime)}</p>
                  </div>
                </div>
              </div>
            ...
            {showTips && (
              <ul className="mt-3 space-y-2">
                {displayTips.map((tip, index) => (
                  <li key={index} className="flex items-start gap-2 text-sm text-black dark:text-foreground">
