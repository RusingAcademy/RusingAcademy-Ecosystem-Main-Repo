  ...
  return (
    <div className="glass-card rounded-xl p-5">
      ...
      {audioUrl && !isRecording && (
        <div className="mb-4">
          <div className="flex items-center gap-3 bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-3">
      ...
      {showTranscript && transcript && (
        <div className="mb-4 bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-3">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        {isRecording && (
          <>
            <button aria-label="Action"
              onClick={togglePause}
              className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-gray-700 dark:text-muted-foreground flex items-center justify-center hover:bg-gray-200 transition-colors"
            >
