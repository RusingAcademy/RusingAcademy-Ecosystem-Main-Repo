...
export default function CRMDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-obsidian via-teal-900 to-obsidian text-white p-6">
      ...
      >
        {/* Total Leads */}
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-2xl p-6 border border-white/60">
          ...
          <div className="space-y-4">
            {mockAnalytics.leadsBySource.map((item) => (
              <div key={item.source} className="flex items-center gap-4">
                ...
                <div className="w-24 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-full h-2">
                  <div
      ...
      <motion.div
        ...
        className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-2xl border border-white/60 overflow-hidden"
      >
        {/* Filters */}
        <div className="p-6 border-b border-white/60">
          <div className="flex flex-wrap items-center gap-4">
            ...
            <input
              ...
              className="px-4 py-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-lg border border-white/60 focus:border-teal-500 focus:outline-none text-sm w-64"
            />
            ...
            <select
              ...
              className="px-4 py-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-lg border border-white/60 focus:border-teal-500 focus:outline-none text-sm"
            >
            ...
            <tbody className="divide-y divide-white/5">
              {filteredLeads.map((lead) => (
                <motion.tr
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 transition-colors cursor-pointer"
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <div className="w-12 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-full h-2">
                        <div
          ...
          >
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <button
                  onClick={() => setSelectedLead(null)}
                  className="p-2 hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-lg transition-colors"
                >
                  ✕
                </button>
              </div>
              ...
              {selectedLead.message && (
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-lg p-4 mb-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {selectedLead.interests.map((interest, i) => (
                      <span key={i} className="px-3 py-1 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-full text-sm">
                        {interest}
                      </span>
                    ))}
                  </div>
              ...
              <div className="flex gap-3">
                ...
                <button className="flex-1 px-4 py-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 text-gray-700 dark:text-white rounded-lg hover:bg-gray-50 dark:bg-white/[0.06] dark:backdrop-blur-sm dark:hover:bg-background/20 transition-colors border border-slate-300 dark:border-white/10">
                  {t.assign}
                </button>
              </div>
            </motion.div>
