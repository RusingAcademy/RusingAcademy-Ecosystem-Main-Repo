        ...
        <div className="space-y-4 py-4">
          ...
          <div className="bg-white rounded-lg p-4 space-y-2">
            <div className="flex justify-between">
              <span className="text-gray-700">{labels.coachLabel}:</span>
              <span className="font-medium">{session.coachName}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700">{labels.dateLabel}:</span>
            ...
            <div className="flex justify-between">
              <span className="text-gray-700">{labels.timeLabel}:</span>
              <span className="font-medium">{session.time} ({session.duration} min)</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700">{labels.priceLabel}:</span>
