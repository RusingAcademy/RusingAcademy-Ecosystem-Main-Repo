    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          {/* Session Details */}
          <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg p-4 space-y-2">
            <div className="flex justify-between">
              <span className="text-black dark:text-white dark:text-white">{labels.coachLabel}:</span>
              <span className="font-medium">{session.coachName}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-black dark:text-white dark:text-white">{labels.dateLabel}:</span>
            ...
            <div className="flex justify-between">
              <span className="text-black dark:text-white dark:text-white">{labels.timeLabel}:</span>
              <span className="font-medium">{session.time} ({session.duration} min)</span>
            </div>
            <div className="flex justify-between">
              <span className="text-black dark:text-white dark:text-white">{labels.priceLabel}:</span>
          ...
          <div className={`rounded-lg p-4 ${isRefundEligible ? "bg-green-50 border border-green-200" : "bg-yellow-50 border border-yellow-200"}`}>
            ...
            <ul className="text-sm space-y-1 text-black dark:text-white dark:text-white">
