      ...
      <div className="p-4 border-t border-slate-100">
        <Link href="/ai-coach" onClick={onClose}>
          <div className="flex items-center gap-3 p-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-100">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center"><span className="text-white text-sm font-bold">AI</span></div>
            <div className="flex flex-col">
              <span className="font-semibold text-sm text-slate-800">SLE AI Coach</span>
              <span className="text-xs text-slate-500">{language === "fr" ? "Pratiquez avec l'IA" : "Practice with AI"}</span>
            </div>
          </div>
        </Link>
      </div>
