...
export default function PinchZoomImage({ src, alt, onClose, language = "en" }: PinchZoomImageProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 md:top-6 md:right-6 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white dark:bg-slate-900/10 hover:bg-white dark:bg-slate-900/20 flex items-center justify-center transition-colors z-20"
        aria-label="Close"
      >
      ...
      <div className="hidden md:flex absolute top-6 left-6 items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900/10 backdrop-blur-sm z-20">
      ...
      {/* Instructions - Mobile */}
      <div className="flex md:hidden absolute top-4 left-4 items-center gap-2 px-3 py-1.5 rounded-full bg-white dark:bg-slate-900/10 backdrop-blur-sm z-20">
        <svg className="w-4 h-4 text-white/90" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {scale > 1.1 && (
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full bg-white dark:bg-slate-900/10 backdrop-blur-sm z-20">
      ...
      {scale > 1.1 && (
        <button
          ...
          className="absolute bottom-4 right-4 md:bottom-6 md:right-6 px-4 py-2 rounded-full bg-white dark:bg-slate-900/10 hover:bg-white dark:bg-slate-900/20 flex items-center gap-2 transition-colors z-20"
        >
