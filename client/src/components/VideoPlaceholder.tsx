...
export function VideoPlaceholder({
  ...
  return (
    <div className="bg-white dark:bg-background rounded-2xl shadow-lg overflow-hidden max-w-4xl mx-auto">
      ...
      <div className="p-6">
        {/* Title */}
        <h3 className="text-xl font-bold text-black dark:text-foreground mb-2">{displayTitle}</h3>
        
        {/* Description */}
        {displayDescription && (
          <p className="text-black dark:text-foreground mb-4 line-clamp-2">{displayDescription}</p>
        )}
