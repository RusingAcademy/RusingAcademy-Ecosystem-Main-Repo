...
export default function CRMDashboardWidget({ onNavigateToCRM }: CRMDashboardWidgetProps) {
  ...
  const getPerformanceRating = (openRate: number, clickRate: number) => {
    ...
    return { label: l.needsImprovement, color: "text-amber-500", bg: "bg-cta/10" };
  };
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            {pendingMeetings.length > 0 && (
              <div className="flex items-center gap-3 p-3 rounded-lg bg-cta/10 border border-amber-500/20">
                ...
                {sequenceData ? (
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-3 rounded-lg bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md/50">
