  ...
  const StatBox = ({ 
    ...
    return (
      <div className={cn(
        ...
        <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">{label}</p>
      </div>
    );
  };
      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-4">
          ...
          <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-600/10 dark:from-emerald-500/20 dark:to-emerald-600/20">
            ...
            <p className="text-2xl font-bold text-black dark:text-foreground mb-1">
            ...
            />
            <p className="text-sm text-black dark:text-foreground dark:text-cyan-300 mt-1">{l.targetRate}</p>
          </div>
        </div>
      </CardContent>
    </Card>
