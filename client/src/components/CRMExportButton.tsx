                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none"
                    />
                  </div>
                  <div>
