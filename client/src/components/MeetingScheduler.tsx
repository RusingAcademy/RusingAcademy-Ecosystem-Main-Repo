    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/95 backdrop-blur-xl rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
        ...
        >
          ...
          {/* Quick Templates */}
          <div className="p-6 border-b border-slate-200 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md">
            ...
            <div className="flex flex-wrap gap-2">
              {(Object.keys(meetingTemplates) as Array<keyof typeof meetingTemplates>).map(key => (
                <button
                  ...
                  className="px-3 py-1.5 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-slate-200 rounded-full text-sm text-slate-700 hover:bg-teal-50 hover:border-teal-300 hover:text-teal-700 transition-colors"
                >
                  {t.templates[key]}
                </button>
              ))}
