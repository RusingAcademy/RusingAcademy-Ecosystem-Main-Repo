                      ...
                      >
                        {isImage(item.mimeType) ? (
                          ...
                          <div className="w-full h-full flex flex-col items-center justify-center bg-gray-50">
                            ...
                            <span className="text-xs text-gray-700 mt-1 px-2 truncate w-full text-center">{item.fileName}</span>
                          </div>
                        )}
                        {selectedItem?.id === item.id && (
                ...
                <div className="w-56 shrink-0 border-l pl-4 flex flex-col">
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <div>
                        <Label className="text-xs text-gray-700">Filename</Label>
                      ...
                      {selectedItem.altText && (
                        <div>
                          ...
                          <p className="text-xs text-gray-700">{selectedItem.altText}</p>
                        </div>
                      )}
                      ...
                      {selectedItem.folder && (
                        <div>
                          <Label className="text-xs text-gray-700">Folder</Label>
                          <Badge variant="outline" className="text-xs">{selectedItem.folder}</Badge>
                        </div>
                      )}
                      {selectedItem.tags && (
                        <div>
                          <Label className="text-xs text-gray-700">Tags</Label>
