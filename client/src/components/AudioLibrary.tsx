...
export function AudioLibrary({ language = "en", onSelectPhrase }: AudioLibraryProps) {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      default: return "bg-gray-100 dark:bg-card text-black dark:text-foreground border-gray-200";
    }
  };
  ...
  return (
    <div className="bg-white dark:bg-background rounded-2xl shadow-lg overflow-hidden">
      {/* Header */}
      ...
      {/* Filters */}
      <div className="p-4 border-b border-gray-200 dark:border-border dark:border-border bg-gray-50">
      ...
      <div className="divide-y divide-gray-100 max-h-[500px] overflow-y-auto">
        {filteredAudio.length === 0 ? (
          ...
          filteredAudio.map((phrase) => (
            <div
              key={phrase.id}
              className="p-4 hover:bg-gray-50 dark:bg-background transition-colors"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 text-xs bg-gray-100 dark:bg-card text-black dark:text-foreground rounded">
      ...
      {/* Footer Stats */}
      <div className="p-4 bg-gray-50 dark:bg-background border-t border-gray-200 dark:border-border dark:border-border">
