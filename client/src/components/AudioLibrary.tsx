...
export function AudioLibrary({ language = "en", onSelectPhrase }: AudioLibraryProps) {
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      default: return "bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-black dark:text-foreground border-gray-200";
    }
  };
  ...
  return (
    <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl shadow-lg overflow-hidden">
      {/* Header */}
      ...
      {/* Filters */}
      <div className="p-4 border-b border-gray-200 dark:border-white/15 dark:border-white/15 bg-gray-50 dark:bg-white/[0.06] dark:backdrop-blur-sm">
      ...
      <div className="divide-y divide-gray-100 max-h-[500px] overflow-y-auto">
        {filteredAudio.length === 0 ? (
          ...
          filteredAudio.map((phrase) => (
            <div
              key={phrase.id}
              className="p-4 hover:bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md transition-colors"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  {/* French Text */}
                  <p className="text-black dark:text-foreground font-medium mb-1">
                    {phrase.textFr}
                  </p>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 text-xs bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-black dark:text-foreground rounded">
      ...
      {/* Footer Stats */}
      <div className="p-4 bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md border-t border-gray-200 dark:border-white/15 dark:border-white/15">
        <div className="flex items-center justify-between text-sm text-black dark:text-foreground">
          <span>
            {language === "fr" 
