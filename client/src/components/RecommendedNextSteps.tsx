...
const PRIORITY_COLORS: Record<string, string> = {
  ...
  low: "bg-slate-100 text-black dark:text-white dark:bg-foundation dark:text-cyan-300",
};
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-black dark:text-white dark:text-cyan-300 line-clamp-2">
