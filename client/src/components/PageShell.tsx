    ...
    <div className={`min-h-screen flex flex-col ${className}`}>
      ...
      {decorativeBackground && (
        <div className="fixed inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-slate-200/30 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15/20 rounded-full blur-3xl" />
          <div className="absolute -bottom-40 left-1/4 w-80 h-80 bg-slate-200/20 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15/10 rounded-full blur-3xl" />
        </div>
      )}
