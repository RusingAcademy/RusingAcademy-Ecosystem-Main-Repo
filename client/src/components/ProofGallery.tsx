  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-8 lg:px-12 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <h2 
            ...
            className="text-3xl md:text-4xl font-bold text-black dark:text-white dark:text-white mb-4"
          >
            {language === "fr" 
              ? "Témoignages et Capsules d'Apprentissage" 
              : "Testimonials & Learning Capsules"}
          </h2>
          <p className="text-black dark:text-white dark:text-white max-w-2xl mx-auto text-lg">
            {language === "fr"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVideos.map((video) => (
            <button
              ...
              className="group bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg hover:border-teal-200 transition-all duration-300 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
            >
              {/* Thumbnail */}
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute inset-0 bg-black/30 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="h-14 w-14 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/90 flex items-center justify-center">
              ...
              {/* Content */}
              <div className="p-4">
                <h3 className="font-semibold text-black dark:text-white dark:text-white mb-1 line-clamp-2 group-hover:text-teal-600 transition-colors">
                  {language === "fr" ? video.titleFr : video.title}
                </h3>
                <p className="text-sm text-black dark:text-white dark:text-white line-clamp-2">
      ...
      {selectedVideo && (
        ...
        >
          <div
            className="relative bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl overflow-hidden shadow-2xl w-full max-w-4xl"
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b">
              ...
              <button
                onClick={handleCloseModal}
                className="h-10 w-10 rounded-full bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-black dark:text-white dark:text-white hover:bg-gray-200 hover:text-black dark:text-white dark:text-white transition-colors"
