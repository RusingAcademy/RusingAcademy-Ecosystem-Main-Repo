...
const badgeColors: Record<string, string> = {
  ...
  silver: "bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm text-black dark:text-foreground border-slate-400 dark:bg-white/[0.08] dark:backdrop-blur-md/50 dark:text-foreground dark:border-slate-400/60 font-medium",
