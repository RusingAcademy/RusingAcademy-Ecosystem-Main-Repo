...
function CoachCard({ coach, language, onClick }: CoachCardProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div 
          className="w-20 h-20 rounded-full flex items-center justify-center bg-white dark:bg-slate-800 dark:bg-slate-900/20 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/30 transition-all duration-300 hover:scale-110"
          style={{ 
...
function VideoModal({ coach, language, onClose }: VideoModalProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onClose}
        className="absolute top-4 right-4 w-12 h-12 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/10 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/20 flex items-center justify-center transition-colors z-10"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
          <div className="flex items-center justify-between mb-4">
            <button
              onClick={togglePlay}
              className="w-12 h-12 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/20 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/30 flex items-center justify-center transition-colors"
