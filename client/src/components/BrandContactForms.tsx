...
export function RusingAcademyContactForm({ language, theme }: Omit<ContactFormProps, "brand">) {
  ...
  const t = theme === "glass" 
    ? { bg: "bg-white/5 backdrop-blur-xl border border-white/10", text: "text-white", textSecondary: "text-white/70", input: "bg-white/10 border-white/20 text-white placeholder:text-white/50" }
    : { bg: "bg-white border border-gray-200 shadow-lg", text: "text-gray-900", textSecondary: "text-gray-600", input: "bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-400" };
