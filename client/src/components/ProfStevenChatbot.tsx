  ...
  return (
    <>
      ...
      <div 
        ...
        className={`fixed bottom-[120px] right-6 w-[380px] max-w-[calc(100vw-40px)] bg-white dark:bg-slate-800 rounded-2xl shadow-2xl z-[10000] overflow-hidden font-sans transition-all duration-300 ${
