...
function GoogleSnippetPreview({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg p-4 border border-gray-200 dark:border-slate-700 dark:border-slate-700 space-y-1">
      <div className="text-xs text-black dark:text-white dark:text-white flex items-center gap-1">
      ...
      <p className="text-sm text-black dark:text-white dark:text-white leading-snug line-clamp-2">
        {displayDesc}
      </p>
    </div>
  );
...
function SocialCardPreview({
  ...
  if (platform === "twitter") {
    return (
      <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden max-w-[400px]">
        {image ? (
          <div className="h-[200px] bg-gray-100 dark:bg-slate-800 relative">
        ...
        <div className="p-3 space-y-1">
          <h4 className="text-sm font-semibold text-black dark:text-white dark:text-white truncate">{displayTitle}</h4>
          <p className="text-xs text-black dark:text-white dark:text-white line-clamp-2">{displayDesc}</p>
  ...
  return (
    <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden max-w-[400px]">
      {image ? (
        <div className="h-[210px] bg-gray-100 dark:bg-slate-800 relative">
          <img src={image} alt="OG" className="w-full h-full object-cover" />
        </div>
      ) : (
      ...
      <div className="p-3 bg-[#f2f3f5] space-y-0.5">
        <div className="text-xs text-black dark:text-white dark:text-white uppercase tracking-wide">
          {displayUrl.replace(/https?:\/\//, "").split("/")[0]}
        </div>
        <h4 className="text-sm font-semibold text-black dark:text-white dark:text-white truncate">{displayTitle}</h4>
        <p className="text-xs text-black dark:text-white dark:text-white line-clamp-1">{displayDesc}</p>
      </div>
    </div>
  );
}
