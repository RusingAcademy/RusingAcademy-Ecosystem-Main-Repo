...
function GoogleSnippetPreview({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-lg p-4 border border-gray-200 dark:border-slate-700 space-y-1">
...
function SocialCardPreview({
  ...
  if (platform === "twitter") {
    return (
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden max-w-[400px]">
        {image ? (
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 overflow-hidden max-w-[400px]">
      {image ? (
