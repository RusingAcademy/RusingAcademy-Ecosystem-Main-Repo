...
function GoogleSnippetPreview({
  ...
  return (
    <div className="bg-white dark:bg-background rounded-lg p-4 border border-gray-200 dark:border-border dark:border-border space-y-1">
      ...
      <p className="text-sm text-black dark:text-foreground leading-snug line-clamp-2">
        {displayDesc}
      </p>
    </div>
  );
    ...
    return (
      <div className="bg-white dark:bg-background rounded-xl border border-gray-200 dark:border-border dark:border-border overflow-hidden max-w-[400px]">
        ...
        <div className="p-3 space-y-1">
          <h4 className="text-sm font-semibold text-black dark:text-foreground truncate">{displayTitle}</h4>
          <p className="text-xs text-black dark:text-foreground line-clamp-2">{displayDesc}</p>
  ...
  return (
    <div className="bg-white dark:bg-background rounded-lg border border-gray-200 dark:border-border dark:border-border overflow-hidden max-w-[400px]">
      ...
      <div className="p-3 bg-[#f2f3f5] space-y-0.5">
        <div className="text-xs text-black dark:text-foreground uppercase tracking-wide">
          {displayUrl.replace(/https?:\/\//, "").split("/")[0]}
        </div>
        <h4 className="text-sm font-semibold text-black dark:text-foreground truncate">{displayTitle}</h4>
        <p className="text-xs text-black dark:text-foreground line-clamp-1">{displayDesc}</p>
      </div>
    </div>
  );
}
