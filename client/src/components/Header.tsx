                ...
                <Link
                  ...
                  className={`relative px-4 py-2.5 text-sm font-medium rounded-full transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 ${
                    isActive(link.href)
                      ...
                      : "text-black dark:text-foreground hover:text-teal-700 hover:bg-white/60"
                  }`}
              ...
              {isAuthenticated ? (
                ...
                <>
                  <a href={getLoginUrl()}>
                    <Button 
                      variant="ghost" 
                      className="glass-btn-outline text-black dark:text-foreground rounded-full px-5 h-11 font-medium"
                    >
                      {t("nav.signIn")}
                    </Button>
                  </a>
                      ...
                      <Link
                        ...
                        className={`flex items-center text-base font-medium py-4 px-6 transition-all duration-300 ${
                          isActive(link.href)
                            ...
                            : "text-black dark:text-foreground hover:bg-white/80 border-l-4 border-transparent hover:border-teal-200"
                        }`}
                        aria-current={isActive(link.href) ? "page" : undefined}
                      >
                        {link.label}
