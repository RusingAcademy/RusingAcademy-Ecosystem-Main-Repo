  ...
  return (
    ...
    >
      <Button
        variant="ghost"
        size="icon"
        className="absolute top-4 right-4 text-white hover:bg-white dark:bg-background/20 z-50"
        onClick={onClose}
      >
        <X className="h-6 w-6" />
      </Button>
      ...
      {images.length > 1 && (
        <>
          <Button
            variant="ghost"
            size="icon"
            className="absolute left-4 top-1/2 -translate-y-1/2 text-white hover:bg-white dark:bg-background/20 h-12 w-12"
          ...
          <Button
            variant="ghost"
            size="icon"
            className="absolute right-4 top-1/2 -translate-y-1/2 text-white hover:bg-white dark:bg-background/20 h-12 w-12"
            onClick={handleNext}
          >
      ...
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/50 rounded-full px-4 py-2">
        <Button
          variant="ghost"
          size="icon"
          className="text-white hover:bg-white dark:bg-background/20 h-8 w-8"
        ...
        <div className="w-px h-4 bg-white dark:bg-background/30 mx-2" />
        <Button
          variant="ghost"
          size="icon"
          className="text-white hover:bg-white dark:bg-background/20 h-8 w-8"
