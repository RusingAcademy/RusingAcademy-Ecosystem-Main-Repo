    ...
    <aside className="hidden xl:flex flex-col w-[300px] shrink-0 gap-5 py-5 pr-5">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-1 text-[11px] text-muted-foreground">
                  <Star className="w-3 h-3" style={{ fill: "var(--brand-gold, var(--barholex-gold))", color: "var(--brand-gold, var(--barholex-gold))" }} />
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(90deg, var(--brand-gold, var(--barholex-gold)), #E8CB6A, transparent)" }}
        />
      ...
      >
        ...
        <div
          ...
          style={{ background: "linear-gradient(135deg, var(--brand-gold, var(--barholex-gold)), var(--brand-obsidian, var(--accent-purple-deep)))" }}
        />
