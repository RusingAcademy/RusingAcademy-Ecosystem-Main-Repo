    ...
    <div className="space-y-8">
      ...
      {selectedTeam && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-8 max-w-2xl w-full mx-4">
            <div className="flex items-center justify-between mb-6">
            ...
            <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-4 mb-6">
