        ...
        <div className="relative aspect-video bg-black flex items-center justify-center">
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-primary/20 to-primary/5">
            ...
            <div className="absolute top-4 right-4">
              <Badge variant="outline" className="bg-cta/20 text-amber-300 border-amber-500">
      ...
      <CardContent className="p-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <Badge variant="outline" className="mt-2 bg-cta/20 text-amber-300 border-amber-500">
