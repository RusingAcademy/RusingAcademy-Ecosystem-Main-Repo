    ...
    <div className="space-y-8">
        ...
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            {milestones.map((milestone) => (
              <div key={milestone.id} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-4">
      ...
      {selectedBadge && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-8 max-w-md w-full mx-4">
            <div className="text-center">
...
export function EnhancedLeaderboard({
  ...
  return (
    <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg shadow overflow-hidden">
      <div className="p-6 border-b border-gray-200 dark:border-white/15 dark:border-white/15">
        ...
        <table className="w-full">
          ...
          <tbody>
            {leaderboardData.map((admin, index) => {
              ...
              return (
                <tr key={admin.adminId} className="border-b border-gray-100 dark:border-white/15 hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md">
