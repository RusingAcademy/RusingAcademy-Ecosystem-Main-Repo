        ...
        <div className="bg-white dark:bg-background rounded-lg shadow p-6">
          ...
          <div className="space-y-4">
            {milestones.map((milestone) => (
              <div key={milestone.id} className="bg-white dark:bg-background rounded-lg p-4">
...
export function EnhancedLeaderboard({
  ...
  return (
    <div className="bg-white dark:bg-background rounded-lg shadow overflow-hidden">
      <div className="p-6 border-b border-gray-200 dark:border-border dark:border-border">
        ...
        <table className="w-full">
          ...
          <tbody>
            {leaderboardData.map((admin, index) => {
              ...
              return (
                <tr key={admin.adminId} className="border-b border-gray-100 dark:border-border hover:bg-white dark:bg-background">
