            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-black dark:text-foreground">Duplicate to target</p>
                </div>
              </button>
              <button
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-black dark:text-foreground">Remove from current</p>
                </div>
              </button>
            </div>
          </div>
