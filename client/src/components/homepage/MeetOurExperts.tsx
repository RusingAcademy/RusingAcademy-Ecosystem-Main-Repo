    ...
    <section className="py-24 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white dark:text-white mb-4 font-serif italic">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {experts.map((expert, index) => (
            <div 
              key={index}
              className="group bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100"
            >
              ...
              {/* Info Card */}
              <div className="p-6 bg-white dark:bg-slate-800 dark:bg-slate-900">
                <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-1 font-serif">
                  {expert.name}
                </h3>
                <p className="text-teal-600 font-medium text-sm mb-1">
                  {language === 'fr' ? expert.titleFr : expert.title}
                </p>
                <p className="text-black dark:text-white dark:text-white text-xs mb-4">
                  {expert.company}
                </p>
                <p className="text-black dark:text-white dark:text-white text-sm leading-relaxed mb-4 line-clamp-4">
