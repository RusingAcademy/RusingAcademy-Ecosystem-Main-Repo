    ...
    <section className="py-12 md:py-16 lg:py-24 bg-slate-100 relative overflow-hidden">
      <div className="container relative z-10">
        ...
        <div className="text-center mb-6">
          <h2 className="text-3xl md:text-4xl font-bold text-black dark:text-foreground mb-2">
            {language === 'fr' ? 'Trucs et astuces d\'apprentissage :' : 'Learning Tips & Tricks:'}
          </h2>
          <h3 className="text-xl md:text-2xl font-semibold text-black dark:text-foreground mb-4">
            {language === 'fr' 
          ...
          <p className="text-black dark:text-foreground max-w-4xl mx-auto leading-relaxed">
            {language === 'fr' 
