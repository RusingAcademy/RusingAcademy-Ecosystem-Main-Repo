          ...
          <CardContent>
            <div className="space-y-3">
              {potentialDuplicates.slice(0, 5).map((group, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-3 rounded-lg bg-white dark:bg-slate-800 dark:bg-foundation"
                >
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label>{l.name}</Label>
                <div className="p-2 rounded bg-white dark:bg-slate-800 dark:bg-foundation">
