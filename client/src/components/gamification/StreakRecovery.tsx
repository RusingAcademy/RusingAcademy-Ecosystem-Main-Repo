  ...
  return (
    <Card className={cn("overflow-hidden", className)}>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 sm:gap-3">
          <div className="p-3 rounded-lg bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 border border-orange-200/50 dark:border-orange-800/50">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-black dark:text-foreground dark:text-cyan-300">{l.currentStreak}</span>
            </div>
            <p className="text-2xl font-bold text-orange-600">
              {currentStreak}
              <span className="text-sm font-normal text-black dark:text-foreground ml-1">{l.days}</span>
            </p>
          </div>
        ...
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-white/[0.08] dark:backdrop-blur-md/50 border border-slate-200 dark:border-teal-800">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-black dark:text-foreground/90">{l.streakFreezes}</span>
            <span className="text-xs text-black dark:text-foreground">{streakFreezes} {l.available}</span>
          </div>
              ...
              <motion.div
                ...
                className={cn(
                  ...
                  i < streakFreezes
                    ...
                    : "bg-slate-200 dark:bg-teal-800 text-cyan-300"
                )}
                initial={false}
            ...
            <Dialog open={showPurchaseDialog} onOpenChange={setShowPurchaseDialog}>
              ...
              <DialogContent>
                ...
                <div className="space-y-3">
                  <p className="text-sm font-medium text-black dark:text-foreground/90">{l.earnMethods}:</p>
        ...
        {lastActivityDate && (
          <div className="flex items-center justify-between text-xs text-black dark:text-foreground dark:text-cyan-300 pt-2 border-t border-slate-200 dark:border-teal-800">
