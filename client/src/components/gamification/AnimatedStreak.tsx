    ...
    <div className={cn("flex flex-col items-center", className)}>
      ...
      >
        ...
        {milestone && showMilestones && (
          <motion.div
            className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md shadow-lg flex items-center justify-center text-lg"
      ...
      >
        <p className={cn(config.text, "font-bold text-black dark:text-foreground")}>
          {currentStreak}
        </p>
        <p className="text-sm text-black dark:text-foreground dark:text-cyan-300 font-medium">
          {l.streak}
        </p>
      </motion.div>
      ...
      {(longestStreak > 0 || streakFreezes > 0) && (
        ...
        >
          {longestStreak > 0 && (
            <div className="flex items-center gap-1 text-black dark:text-foreground dark:text-cyan-300">
    ...
    <motion.div
      className={cn(
        ...
        isActive && currentStreak > 0
          ...
          : "bg-slate-100 dark:bg-white/[0.08] dark:backdrop-blur-md text-black",
        className
      )}
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.95 }}
