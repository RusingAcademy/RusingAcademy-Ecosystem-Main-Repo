      ...
      <CardContent className="space-y-2">
        {entries.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">{l.noData}</p>
            <p className="text-xs text-black dark:text-foreground mt-1">{l.beFirst}</p>
          </motion.div>
        ) : (
          <>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={cn(
                      ...
                      entry.isCurrentUser ? "text-primary" : "text-black dark:text-foreground"
                    )}>
                      {entry.name}
                      {entry.isCurrentUser && (
                        <span className="text-xs text-black dark:text-foreground ml-1">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="text-right">
                      ...
                      <p className="text-xs text-black dark:text-foreground">{l.xp}</p>
                    </div>
            ...
            <Link href="/app/badges">
              <Button
                variant="ghost"
                size="sm"
                className="w-full mt-2 text-black dark:text-foreground hover:text-black dark:text-foreground"
              >
                {l.viewFull}
