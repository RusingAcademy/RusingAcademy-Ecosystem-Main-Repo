    ...
    <motion.div
      className={cn(
        ...
        challenge.isCompleted
          ...
          : "bg-white dark:bg-obsidian border-slate-200 dark:border-teal-800 hover:border-slate-300 dark:hover:border-slate-600"
      )}
      onClick={onClick}
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {description && (
            <p className="text-xs text-black dark:text-cyan-300 mb-2 line-clamp-1">
              {description}
            </p>
          )}
      ...
      <CardContent className="space-y-3">
        {challenges.length === 0 ? (
          ...
          >
            ...
            <p className="text-black dark:text-cyan-300 font-medium">{l.noChallenges}</p>
