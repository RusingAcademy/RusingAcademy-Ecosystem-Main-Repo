  ...
  return (
    <div className="bg-[#1A1A2E] rounded-2xl p-6 border border-white/10">
      <div className="mb-6">
        ...
        <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 rounded-xl p-4">
        ...
        <AnimatePresence mode="wait">
          ...
          {state === 'recording' && (
            <motion.div key="recording" className="text-center">
              ...
              <button onClick={stopRecording} className="mt-4 px-6 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg text-white">Terminer</button>
            </motion.div>
          )}
          {state === 'processing' && (
          ...
          {state === 'feedback' && feedback && (
            <motion.div key="feedback" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 rounded-xl p-4 text-center">
              ...
              {feedback.suggestions.length > 0 && (
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 rounded-xl p-4 mb-4">
              ...
              <div className="flex gap-3">
                {attempts < VOICE_CONFIG.retryLimit && feedback.overallScore < VOICE_CONFIG.passingScore && (
                  <button onClick={retry} className="flex-1 py-3 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-xl text-white">Réessayer</button>
                )}
