    ...
    >
      ...
      >
        ...
        {isUnlocked ? (
          ...
          <Lock className={cn(iconSizes[size], "text-cyan-300 dark:text-black")} />
        )}
      ...
      <AnimatePresence>
        {isHovered && description && (
          <motion.div
            className="absolute bottom-full mb-2 px-3 py-2 bg-obsidian dark:bg-white/[0.08] dark:backdrop-blur-md text-white text-xs rounded-lg shadow-xl z-30 max-w-[150px] text-center"
