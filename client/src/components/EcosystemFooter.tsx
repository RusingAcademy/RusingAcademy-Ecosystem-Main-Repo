      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className={`text-sm leading-relaxed max-w-md ${isGlass ? 'text-gray-400' : 'text-gray-600'}`}>
              {t.tagline}
            </p>
            <p className={`text-sm mt-4 ${isGlass ? 'text-gray-500' : 'text-gray-500'}`}>
              {t.location}
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  ...
                  className={`text-sm transition-colors hover:underline ${
                    isGlass ? 'text-gray-400 hover:text-orange-400' : 'text-gray-600 hover:text-orange-600'
                  }`}
              ...
              <li>
                <Link
                  href="/lingueefy"
                  className={`text-sm transition-colors hover:underline ${
                    isGlass ? 'text-gray-400 hover:text-teal-400' : 'text-gray-600 hover:text-teal-600'
                  }`}
              ...
              <li>
                <Link
                  href="/barholex-media"
                  className={`text-sm transition-colors hover:underline ${
                    isGlass ? 'text-gray-400 hover:text-violet-400' : 'text-gray-600 hover:text-violet-600'
                  }`}
