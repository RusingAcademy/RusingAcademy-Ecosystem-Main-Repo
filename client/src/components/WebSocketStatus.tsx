        ...
        <span
          ...
          style={{
            background: connected
              ? "linear-gradient(135deg, var(--semantic-success, var(--success)), var(--semantic-success, #16a34a))"
              : "linear-gradient(135deg, var(--semantic-danger, var(--danger)), var(--semantic-danger, var(--danger)))",
            boxShadow: connected
