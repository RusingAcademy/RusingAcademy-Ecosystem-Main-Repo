    ...
    <div className="bg-gradient-to-r from-orange-50 to-orange-50 border border-orange-100 rounded-lg p-6 my-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-orange-100 rounded-lg p-4 mb-4">
            <div className="flex items-start gap-3">
              <div className="text-amber-600 font-semibold">
                {isEn ? "Feedback:" : "Commentaires :"}
              </div>
              <div className="text-gray-700 dark:text-muted-foreground flex-1">{rejectionReason}</div>
            </div>
          </div>
            ...
            {canResubmit ? (
              <>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-amber-300 text-amber-700 rounded-lg hover:bg-amber-50 transition-colors font-medium"
                >
          ...
          {/* Tips Section */}
          {showDetails && (
            <div className="mt-4 p-4 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-orange-100 rounded-lg">
