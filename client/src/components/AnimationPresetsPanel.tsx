...
function AnimationPreviewBox({ presetId, duration }: { presetId: string; duration: number }) {
  ...
  if (!preset || presetId === "none") {
    return (
      <div className="w-full h-24 rounded-lg border-2 border-dashed border-gray-200 dark:border-slate-700 dark:border-slate-700 flex items-center justify-center text-cyan-300 text-xs">
  ...
  return (
    <div className="space-y-2">
      <div className="w-full h-24 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 bg-gradient-to-br from-indigo-50 to-white overflow-hidden flex items-center justify-center relative">
        <div
