      ...
      <DialogContent className="max-w-lg z-[200]">
        ...
        <ScrollArea className="max-h-[60vh]">
          <div className="space-y-5 pr-2">
            ...
            {/* Basic */}
            <div>
              <Label className="text-xs font-medium text-gray-700 mb-2 block">Basic</Label>
            ...
            {/* Directional */}
            <div>
              <Label className="text-xs font-medium text-gray-700 mb-2 block">Directional</Label>
              <div className="grid grid-cols-2 gap-2">
            ...
            {/* Emphasis */}
            <div>
              <Label className="text-xs font-medium text-gray-700 mb-2 block">Emphasis</Label>
              <div className="grid grid-cols-2 gap-2">
            ...
            {selectedPreset !== "none" && (
              <div className="space-y-4 pt-2 border-t border-gray-100">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <Label className="text-xs font-medium text-gray-700">Delay</Label>
