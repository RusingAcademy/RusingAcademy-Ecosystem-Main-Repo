    ...
    <Dialog open={open} onOpenChange={(v) => { if (!v) onClose(); }}>
      <DialogContent className="max-w-lg z-[200]">
        <DialogHeader>
          ...
          <p className="text-xs text-black dark:text-foreground mt-1">
        ...
        <ScrollArea className="max-h-[60vh]">
          <div className="space-y-5 pr-2">
            ...
            {/* Preview */}
            <div>
              <Label className="text-xs font-medium text-black dark:text-foreground mb-2 block">Preview</Label>
              <AnimationPreviewBox presetId={selectedPreset} duration={duration} />
            </div>

            {/* Basic */}
            <div>
              <Label className="text-xs font-medium text-black dark:text-foreground mb-2 block">Basic</Label>
            ...
            {/* Directional */}
            <div>
              <Label className="text-xs font-medium text-black dark:text-foreground mb-2 block">Directional</Label>
              <div className="grid grid-cols-2 gap-2">
            ...
            {/* Emphasis */}
            <div>
              <Label className="text-xs font-medium text-black dark:text-foreground mb-2 block">Emphasis</Label>
              <div className="grid grid-cols-2 gap-2">
              ...
              <div className="space-y-4 pt-2 border-t border-gray-100">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <Label className="text-xs font-medium text-black dark:text-foreground">Duration</Label>
                  ...
                  <Slider
                    ...
                    className="w-full"
                  />
                  <div className="flex justify-between text-[10px] text-cyan-300 mt-1">
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <Label className="text-xs font-medium text-black dark:text-foreground">Delay</Label>
