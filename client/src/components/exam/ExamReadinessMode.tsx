    ...
    <div className="p-6 bg-slate-950 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-foundation/20 to-teal-700/20 rounded-2xl p-8 mb-8 text-center border border-foundation/30">
          ...
          <div className="w-full bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-full h-3"><div className="bg-gradient-to-r from-foundation to-teal-700 h-3 rounded-full" style={{ width: `${readinessScore || 0}%` }} /></div>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          {section === 'writing' && (
            <div>
              ...
              <textarea className="w-full h-64 bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/10 rounded-xl p-4 text-white resize-none" placeholder="Commencez à écrire..." onChange={(e) => setResponses([e.target.value])} />
