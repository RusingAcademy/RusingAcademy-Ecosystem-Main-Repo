  ...
  return (
    <div className="mt-6">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-6 border-2 border-dashed border-gray-200 dark:border-white/15 dark:border-white/15 rounded-lg">
        ...
        <div className="space-y-2">
          {items.map((att: any) => {
            ...
            return (
              <div key={att.id} className="flex items-center justify-between p-2 bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg hover:bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 transition-colors">
