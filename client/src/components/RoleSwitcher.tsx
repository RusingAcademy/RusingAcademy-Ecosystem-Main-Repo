    ...
    <DropdownMenu open={open} onOpenChange={setOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="gap-2 h-9 px-3 rounded-lg border-slate-200 bg-white dark:bg-slate-800 dark:bg-slate-900/50 backdrop-blur-sm hover:bg-white dark:bg-slate-800 dark:bg-slate-900/80"
        >
