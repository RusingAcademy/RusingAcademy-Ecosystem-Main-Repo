    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="absolute top-0 left-0 right-0 h-1 bg-white dark:bg-slate-900/20 cursor-pointer group"
        >
          <div
        ...
        <div className="flex items-center gap-4 px-4 h-[72px]">
          ...
          {track.thumbnailUrl ? (
            ...
            <div className="w-12 h-12 rounded-lg bg-white dark:bg-slate-900/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={skipBack}
              className="p-1.5 hover:bg-white dark:bg-slate-900/10 rounded-full transition-colors"
          ...
          <button
            ...
            className="p-1.5 hover:bg-white dark:bg-slate-900/10 rounded-full transition-colors hidden md:block"
              ...
              {playlist
                ...
                .map((t) => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white dark:bg-slate-900/10 transition-colors text-left"
                  >
                    {t.thumbnailUrl ? (
                      <img
                        src={t.thumbnailUrl}
                      ...
                      <div className="w-8 h-8 rounded bg-white dark:bg-slate-900/10 flex items-center justify-center">
