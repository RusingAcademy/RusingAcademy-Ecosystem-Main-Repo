...
export function MotivationalNudge({ userState, language = "en", onDismiss }: MotivationalNudgeProps) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl shadow-xl border border-gray-100 dark:border-white/15 overflow-hidden">
        {/* Colored top bar based on type */}
        <div className={`h-1 ${
          nudge.type === "streak" ? "bg-cta" :
          nudge.type === "milestone" ? "bg-yellow-500" :
          nudge.type === "progress" ? "bg-teal-500" :
          nudge.type === "comeback" ? "bg-foundation-soft" :
        ...
        <div className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-gray-700 dark:text-muted-foreground text-sm leading-relaxed">{message}</p>
