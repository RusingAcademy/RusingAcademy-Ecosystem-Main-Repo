...
const roleBadgeStyles: Record<string, { bg: string; text: string; border: string }> = {
  ...
  "Professional Teacher": {
    ...
    text: "var(--brand-obsidian, var(--accent-purple-deep))",
    border: "rgba(27, 20, 100, 0.12)",
  },
  Student: {
    bg: "rgba(45, 37, 128, 0.05)",
    text: "var(--brand-obsidian, var(--accent-purple-dark))",
...
const typeIcons: Record<string, { icon: typeof Mic; label: string; color: string; bg: string }> = {
  podcast: { icon: Mic, label: "Podcast", color: "var(--brand-obsidian, var(--accent-purple-deep))", bg: "rgba(27, 20, 100, 0.06)" },
  exercise: { icon: BookOpen, label: "Exercise", color: "var(--brand-gold, var(--barholex-gold))", bg: "rgba(212, 175, 55, 0.08)" },
  question: { icon: HelpCircle, label: "Question", color: "var(--brand-obsidian, var(--accent-purple-dark))", bg: "rgba(45, 37, 128, 0.06)" },
};
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-1.5 h-1 rounded-full bg-border overflow-hidden">
                  <div
                    ...
                    style={{
                      width: "0%",
                      background: "linear-gradient(90deg, var(--brand-obsidian, var(--accent-purple-deep)), var(--brand-gold, var(--barholex-gold)))",
                    }}
                  />
                </div>
              </div>
          ...
          {post.tags.map((tag) => (
            <span
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.color = "var(--brand-obsidian, var(--accent-purple-deep))";
              }}
              onMouseLeave={(e) => {
        ...
        <div className="flex items-center gap-1">
          ...
          <motion.button
            ...
            style={{
              ...
              color: liked ? "var(--brand-gold, var(--barholex-gold))" : undefined,
            }}
            whileTap={{ scale: 0.92 }}
          >
            <ThumbsUp
