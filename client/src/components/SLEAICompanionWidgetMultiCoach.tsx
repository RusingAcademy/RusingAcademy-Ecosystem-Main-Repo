            ...
            <div className="flex items-center justify-between px-5 py-3.5 flex-shrink-0 relative" style={{ zIndex: 2 }}>
              ...
              <div className="flex items-center gap-3 relative" style={{ zIndex: 1 }}>
                {currentScreen === "session" && (
                  <button onClick={handleBack} className="p-2 -ml-2 rounded-full hover:bg-white dark:bg-slate-900/10 transition-all duration-200" aria-label="Back">
              ...
              <div className="flex items-center gap-1 relative" style={{ zIndex: 1 }}>
                ...
                <button onClick={handleClose} className="p-2 rounded-full hover:bg-white dark:bg-slate-900/10 transition-all duration-200" aria-label="Close">
                  <svg className="w-5 h-5 text-white/90" fill="none" stroke="currentColor" viewBox="0 0 24 24">
