    ...
    <div className={cn("rounded-xl border border-slate-200 dark:border-teal-800 bg-white dark:bg-card dark:bg-obsidian p-6", className)}>
      ...
      {certifications.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-black dark:text-foreground dark:text-cyan-300 mb-1">{l.noCertifications}</p>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <p className={cn("text-sm font-medium", 
                        ...
                        "text-black dark:text-foreground dark:text-cyan-300"
                      )}>
      ...
      <div className="mt-4 pt-4 border-t border-slate-200 dark:border-teal-800">
        <p className="text-xs text-black dark:text-foreground dark:text-cyan-300 flex items-center gap-2">
