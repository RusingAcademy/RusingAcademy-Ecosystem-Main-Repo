    ...
    <div className={cn("rounded-xl border border-slate-200 dark:border-[#0a6969] bg-white dark:bg-[#062b2b] p-6", className)}>
      ...
      {certifications.length === 0 ? (
        <div className="text-center py-8">
          <Award className="h-12 w-12 text-white/90 dark:text-slate-600 mx-auto mb-3" />
          <p className="text-slate-500 dark:text-[#67E8F9] mb-1">{l.noCertifications}</p>
          <p className="text-sm text-[#67E8F9] dark:text-slate-500">{l.startJourney}</p>
        </div>
      ) : (
                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <p className={cn("text-sm font-medium", 
                        ...
                        "text-slate-600 dark:text-[#67E8F9]"
                      )}>
      ...
      <div className="mt-4 pt-4 border-t border-slate-200 dark:border-[#0a6969]">
        <p className="text-xs text-slate-500 dark:text-[#67E8F9] flex items-center gap-2">
