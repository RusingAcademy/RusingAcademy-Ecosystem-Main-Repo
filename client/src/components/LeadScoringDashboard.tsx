...
export default function LeadScoringDashboard() {
  ...
  const getScoreColor = (score: number) => {
    ...
    return "text-black bg-slate-100 dark:bg-foundation";
  };
              ...
              <div className="space-y-3">
                {leads.map((lead: Lead, index: number) => {
                  ...
                  return (
                    <div
                      key={lead.id}
                      className={`flex items-center gap-4 p-3 rounded-lg border cursor-pointer transition-colors hover:bg-white dark:hover:bg-foundation/50 ${
          ...
          <CardContent>
            {selectedLead ? (
              <div className="space-y-4">
                {/* Score Breakdown */}
                <div className="p-4 rounded-lg bg-white dark:bg-foundation/50">
