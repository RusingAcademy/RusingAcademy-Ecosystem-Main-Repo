      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === "sequences" && (
          ...
          >
            {sequences.map((seq) => (
              <div
                key={seq.sequenceId}
                className="bg-white dark:bg-background/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden"
              >
                <div
                  className="p-6 cursor-pointer hover:bg-white dark:bg-background/5 transition-colors"
                  ...
                  {expandedSequence === seq.sequenceId && (
                    ...
                    >
                      <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-white dark:bg-background/5 rounded-lg p-4">
        ...
        {activeTab === "steps" && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <div className="bg-white dark:bg-background/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-white dark:bg-background/5">
                    <tr>
                  ...
                  <tbody className="divide-y divide-white/5">
                    {steps.map((step) => (
                      <tr key={step.stepId} className="hover:bg-white dark:bg-background/5 transition-colors">
