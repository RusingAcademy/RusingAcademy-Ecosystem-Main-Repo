  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-obsidian via-teal-900 to-obsidian text-white p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/20 rounded-lg transition-colors">
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm rounded-xl p-4 border border-white/60">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm rounded-xl p-6 border border-white/60">
                ...
                <div className="w-full bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-full h-2">
                  <div
        ...
        {activeTab === "sequences" && (
          ...
          >
            {sequences.map((seq) => (
              <div
                key={seq.sequenceId}
                className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden"
              >
                <div
                  className="p-6 cursor-pointer hover:bg-white dark:bg-slate-800 dark:bg-slate-900/5 transition-colors"
                    ...
                    >
                      ...
                      <div className="px-6 pb-6">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div className="text-black dark:text-white dark:text-white">→</div>
                          <div className="flex-1">
        ...
        {activeTab === "steps" && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-white/5">
                    {steps.map((step) => (
                      <tr key={step.stepId} className="hover:bg-white dark:bg-slate-800 dark:bg-slate-900/5 transition-colors">
