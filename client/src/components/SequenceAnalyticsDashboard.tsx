  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-obsidian via-teal-900 to-obsidian text-white p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button aria-label="Action" className="flex items-center gap-2 px-4 py-2 bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/10 hover:bg-white/20 dark:bg-white/[0.08] dark:backdrop-blur-md/20 rounded-lg transition-colors text-white">
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === "overview" && (
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-4 border border-white/15">
                <div className="flex items-center gap-3 mb-2">
                  <div className="p-2 bg-teal-500/20 rounded-lg">
                    <BarChart3 className="w-5 h-5 text-teal-400" />
                  </div>
                  <span className="text-cyan-300 text-sm">{t.totalSequences}</span>
                </div>
              ...
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-4 border border-white/15">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-cyan-300 text-sm">{t.totalEnrollments}</span>
                </div>
              ...
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-4 border border-white/15">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-cyan-300 text-sm">{t.totalEmailsSent}</span>
                </div>
              ...
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-4 border border-white/15">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-cyan-300 text-sm">{t.avgConversionRate}</span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-6 border border-white/15">
                ...
                <div className="w-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-full h-2">
                  <div
              ...
              <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-6 border border-white/15">
                ...
                <div className="text-xs text-cyan-300 mt-2">{t.benchmark}: 8-15%</div>
              </div>
            </div>
            ...
            <div className="bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl p-6 border border-white/15">
              ...
              <div className="flex items-center justify-center gap-6 mt-4 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-cyan-300">{t.emailsSent}</span>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        {activeTab === "sequences" && (
          ...
          >
            {sequences.map((seq) => (
              <div
                key={seq.sequenceId}
                className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden"
              >
                <div
                  className="p-6 cursor-pointer hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 transition-colors"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right">
                        ...
                        <div className="text-xs text-cyan-300">{t.conversionRate}</div>
                      </div>
                  ...
                  {expandedSequence === seq.sequenceId && (
                    ...
                    >
                      <div className="p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-lg p-4">
                      ...
                      <div className="px-6 pb-6">
                        <h4 className="text-sm font-medium text-cyan-300 mb-3">{t.conversionFunnel}</h4>
                        <div className="flex items-center gap-2">
                          ...
                          <div className="text-black dark:text-foreground">→</div>
                          <div className="flex-1">
        ...
        {activeTab === "steps" && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
          >
            <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 backdrop-blur-sm rounded-xl border border-white/60 overflow-hidden">
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5">
                    <tr>
                      ...
                      <th className="px-6 py-4 text-left text-sm font-semibold text-cyan-300">{t.delay}</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-cyan-300">{t.emailsSent}</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-cyan-300">{t.openRate}</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-cyan-300">{t.clickRate}</th>
                      <th className="px-6 py-4 text-left text-sm font-semibold text-cyan-300">{t.dropOff}</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-white/5">
                    {steps.map((step) => (
                      <tr key={step.stepId} className="hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 transition-colors">
