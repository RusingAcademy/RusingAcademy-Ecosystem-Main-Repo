...
function fireConfetti(type: "standard" | "gold" | "stars" | "fireworks" = "standard") {
  ...
  switch (type) {
    case "gold":
      confetti({ ...defaults, particleCount: 100, colors: ["var(--semantic-warning, var(--warning))", "#ffd700", "#ffec8b", "#daa520"], origin: { x: 0.5, y: 0.4 } });
      setTimeout(() => confetti({ ...defaults, particleCount: 50, colors: ["var(--semantic-warning, var(--warning))", "#ffd700"], origin: { x: 0.3, y: 0.5 } }), 200);
      setTimeout(() => confetti({ ...defaults, particleCount: 50, colors: ["#ffd700", "#ffec8b"], origin: { x: 0.7, y: 0.5 } }), 400);
      break;
    case "stars":
      confetti({ ...defaults, particleCount: 80, shapes: ["star"], colors: ["var(--brand-teal, var(--teal))", "var(--semantic-warning, var(--warning))", "var(--color-violet-500, var(--accent-purple))", "var(--semantic-danger, var(--danger))"], origin: { x: 0.5, y: 0.3 } });
      break;
    case "fireworks":
      ...
      const interval = setInterval(() => {
        ...
        confetti({
          ...
          colors: ["var(--semantic-warning, var(--warning))", "var(--brand-teal, var(--teal))", "var(--semantic-danger, var(--danger))", "var(--color-violet-500, var(--accent-purple))", "var(--semantic-success, var(--success))"],
          zIndex: 10000,
        });
      }, 150);
      break;
    default:
      confetti({ ...defaults, particleCount: 80, colors: ["var(--brand-teal, var(--teal))", "var(--semantic-warning, var(--warning))", "var(--semantic-danger, var(--danger))", "var(--color-violet-500, var(--accent-purple))"], origin: { x: 0.5, y: 0.5 } });
  }
}
  ...
  switch (eventType) {
    ...
    case "badge_earned":
      return {
        ...
        color: (meta.badgeColor as string) || "var(--color-violet-500, var(--accent-purple))",
        xpReward: null,
      };
    case "challenge_completed":
      return {
        ...
        color: "var(--semantic-success, var(--success))",
