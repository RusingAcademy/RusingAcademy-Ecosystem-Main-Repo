    ...
    <div className={cn("rounded-xl border border-slate-200 dark:border-teal-800 bg-white dark:bg-card dark:bg-obsidian p-6", className)}>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">{getStreakMessage()}</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center mb-6">
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="text-2xl md:text-4xl lg:text-5xl font-bold text-black dark:text-foreground">{currentStreak}</span>
        </div>
      ...
      {/* Weekly Progress */}
      <div className="mb-6">
        <p className="text-sm font-medium text-black dark:text-foreground dark:text-cyan-300 mb-3">{l.thisWeek}</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-3 rounded-lg bg-slate-50 dark:bg-foundation">
          ...
          <p className="text-xl font-bold text-black dark:text-foreground">
            {longestStreak} <span className="text-sm font-normal text-black dark:text-foreground">{l.days}</span>
          </p>
        </div>
        ...
        {nextMilestone && (
          <div className="p-3 rounded-lg bg-slate-50 dark:bg-foundation">
            ...
            <p className="text-xl font-bold text-black dark:text-foreground">
              {nextMilestone} <span className="text-sm font-normal text-black dark:text-foreground">{l.days}</span>
            </p>
          </div>
        )}
      </div>
