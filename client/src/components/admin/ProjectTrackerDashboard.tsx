      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <section className="bg-white dark:bg-slate-900/5 backdrop-blur-sm border border-white/60 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center"><div className="text-2xl md:text-4xl lg:text-5xl font-bold text-amber-400">{data.mediaProduction.totalAssets}</div><p className="text-cyan-300 mt-2">Assets Média Total</p><p className="text-xs text-black dark:text-white">{data.mediaProduction.videosTotal} vidéos + {data.mediaProduction.audiosTotal} audios</p></div>
            <div className="text-center"><div className="text-2xl md:text-4xl lg:text-5xl font-bold text-blue-400">{data.mediaProduction.estimatedMonths}</div><p className="text-cyan-300 mt-2">Mois de Production</p><p className="text-xs text-black dark:text-white">Avec équipe dédiée</p></div>
