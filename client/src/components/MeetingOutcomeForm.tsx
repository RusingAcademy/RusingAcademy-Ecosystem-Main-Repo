  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-foundation rounded-2xl p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        {/* Meeting Info */}
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-xl p-4 mb-6">
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="flex-1 h-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-lg appearance-none cursor-pointer accent-teal-500"
                  />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0"
                        className="w-full pl-8 pr-4 py-3 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors"
                      />
                    </div>
                  </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors resize-none"
                />
              </div>
        ...
        <div className="flex gap-3 mt-6 pt-6 border-t border-white/60">
          <button
            onClick={onClose}
            className="flex-1 px-4 py-3 bg-white/10 dark:bg-white/[0.08] dark:backdrop-blur-md/10 text-white rounded-lg hover:bg-white/20 dark:bg-white/[0.08] dark:backdrop-blur-md/20 transition-colors border border-white/10"
          >
            {t.cancel}
          </button>
          <button aria-label="Action"
