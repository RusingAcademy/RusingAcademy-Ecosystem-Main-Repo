  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Meeting Info */}
        <div className="bg-white dark:bg-background/5 rounded-xl p-4 mb-6">
            ...
            >
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="flex-1 h-2 bg-white dark:bg-background/10 rounded-lg appearance-none cursor-pointer accent-teal-500"
                  />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0"
                        className="w-full pl-8 pr-4 py-3 bg-white dark:bg-background/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors"
                      />
                    </div>
                  </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-background/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-white dark:bg-background/5 border border-white/60 rounded-lg focus:outline-none focus:border-teal-500 transition-colors resize-none"
                />
              </div>
