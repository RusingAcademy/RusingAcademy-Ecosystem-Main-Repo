  ...
  return (
    ...
    >
      <div className={`rounded-2xl shadow-2xl overflow-hidden ${
        ...
        {leveledUp && newLevel && (
          <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/20 backdrop-blur p-4 border-t border-white/60">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md flex items-center justify-center">
        ...
        <div className="h-1 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/20">
          <div 
            className="h-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md transition-all duration-[4000ms] ease-linear"
