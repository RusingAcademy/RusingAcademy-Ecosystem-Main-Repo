...
export default function CoachOnboardingWizard() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-800 dark:bg-slate-900 py-8 px-4">
          ...
          <CardContent className="space-y-6">
            ...
            {currentStep === 4 && (
              <div className="text-center py-8">
                ...
                <Button onClick={() => updateFormData("stripeConnected", true)} className="bg-foundation-soft hover:bg-foundation-soft">
