  ...
  return (
    <div className="min-h-screen bg-white py-8 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-black mb-2">Devenir Coach RusingÂcademy</h1>
          <Progress value={progress} className="h-2" />
          <p className="text-sm text-black mt-2">Étape {currentStep} sur {STEPS.length}</p>
        </div>
        
        <div className="flex gap-2 mb-8 overflow-x-auto pb-2">
          {STEPS.map((step) => (
            <div key={step.id} className={`flex items-center gap-2 px-3 py-2 rounded-lg ${currentStep === step.id ? "bg-amber-100 text-amber-800" : currentStep > step.id ? "bg-green-100 text-green-800" : "bg-slate-100 text-black"}`}>
          ...
          <CardContent className="space-y-6">
            ...
            {currentStep === 3 && (
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-black">Glissez votre photo de profil ici</p>
              </div>
            )}
            {currentStep === 4 && (
              <div className="text-center py-8">
                ...
                <p className="text-black mb-4">Pour recevoir vos paiements de coaching</p>
            ...
            {currentStep === 6 && (
              <div className="text-center py-8">
                ...
                <p className="text-black">Votre candidature sera examinée sous 48-72 heures.</p>
              </div>
            )}
          </CardContent>
        </Card>
