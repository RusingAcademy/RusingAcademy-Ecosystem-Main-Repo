          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-foreground dark:text-foreground text-lg">
                    Rusinga Ecosystem
                  </h3>
                      ...
                      >
                        ...
                        <div className="flex-1 text-left">
                          <div className="flex items-center gap-2">
                            <span className="font-medium text-gray-900 dark:text-foreground dark:text-foreground">
                              {platform.name}
                            </span>
                            {isActive && (
              ...
              <div className="flex items-center justify-between">
                {isAuthenticated ? (
                  <>
                    <Link href="/dashboard">
                      <button className="p-2 rounded-lg hover:bg-gray-100 dark:bg-card dark:hover:bg-zinc-800 transition-colors">
                ...
                <a
                  ...
                  className="flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 dark:text-muted-foreground dark:hover:text-gray-300 transition-colors"
                >
      ...
      >
        <Grid3X3
          className={cn(
            ...
            isOpen ? "text-gray-700 dark:text-muted-foreground rotate-45" : "text-white"
          )}
        />
      </motion.button>
    </div>
