    ...
    return (
      <Card className={className}>
        <CardContent className="p-6 text-center">
          <Activity className="h-10 w-10 text-white/90 dark:text-slate-600 mx-auto mb-3" />
          ...
          return (
            ...
            >
              <div className="p-1.5 rounded-md bg-slate-100 dark:bg-[#0a4040]">
                <Icon className="h-3.5 w-3.5 text-slate-500 dark:text-[#67E8F9]" />
              </div>
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <span className="text-[10px] text-[#67E8F9] dark:text-slate-500">
