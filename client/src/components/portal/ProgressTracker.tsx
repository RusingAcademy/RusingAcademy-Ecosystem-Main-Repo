...
export default function ProgressTracker({ 
  ...
  return (
    <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl border border-slate-200 p-6 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-black dark:text-white dark:text-white">Progression SLE</h3>
          <p className="text-sm text-black dark:text-white dark:text-white">Votre parcours vers la maîtrise bilingue</p>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h4 className="font-semibold text-black dark:text-white dark:text-white">{level.name}</h4>
                    {isActive && (
                  ...
                  <p className="text-sm text-black dark:text-white dark:text-white mb-3">{level.description}</p>
                      ...
                      {level.modules.map((module, idx) => (
                        <div
                          ...
                          className={cn(
                            ...
                            module.completed ? "bg-white dark:bg-slate-800 text-black" : "bg-white/50 text-black"
                          )}
                        >
                          {module.completed ? (
