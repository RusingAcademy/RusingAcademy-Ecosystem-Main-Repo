  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        {/* Label */}
        <span className="text-xs font-medium text-black dark:text-white dark:text-white whitespace-nowrap">
          SLE AI Companion
        </span>
      </div>
                ...
                <div className="space-y-3">
                  {menuOptions.map((option) => (
                    ...
                    >
                      ...
                      <span className="text-black dark:text-white dark:text-white group-hover:text-foundation transition-colors">›</span>
                    </button>
                  ))}
                </div>
              </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-6">
                  ...
                  <div className="relative mb-6">
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-3 py-1 bg-emerald-500/90 rounded-full flex items-center gap-1.5 shadow-lg">
                      <div className="w-2 h-2 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-full animate-pulse" />
