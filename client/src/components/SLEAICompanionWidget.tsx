  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        {/* Label */}
        <span className="text-xs font-medium text-black dark:text-foreground whitespace-nowrap">
          SLE AI Companion
        </span>
      </div>
                ...
                <div className="space-y-3">
                  {menuOptions.map((option) => (
                    ...
                    >
                      ...
                      <span className="text-black dark:text-foreground group-hover:text-foundation transition-colors">›</span>
                    </button>
                  ))}
                </div>
              </div>
