        ...
        <div className="grid grid-cols-2 gap-1.5">
          {items.map(preset => (
            <button
              ...
              className="group relative flex items-center gap-2 p-2 rounded-lg border border-gray-200 dark:border-slate-700 hover:border-indigo-300 hover:shadow-sm transition-all text-left"
            >
              <div className="flex gap-0.5 shrink-0">
                <div className="w-4 h-4 rounded-sm border border-gray-200 dark:border-slate-700" style={{ backgroundColor: preset.styles.backgroundColor || "#fff" }} />
                <div className="w-4 h-4 rounded-sm border border-gray-200 dark:border-slate-700" style={{ backgroundColor: preset.styles.textColor || "#000" }} />
              </div>
  ...
  return (
    <div className="space-y-3">
      ...
      {presetsQuery.isLoading ? (
        <div className="flex items-center gap-2 p-3 text-xs text-cyan-300">
        ...
        <div className="space-y-3">
          ...
          {renderPresetGroup("Minimal", minimalPresets, <Sparkles className="h-3 w-3 text-cyan-300" />)}
      ...
      <div className="p-2.5 rounded-lg border border-dashed border-gray-200 dark:border-slate-700 bg-gray-50/50">
