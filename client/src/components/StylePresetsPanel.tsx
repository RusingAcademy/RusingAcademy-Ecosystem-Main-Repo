    ...
    return (
      <div className="space-y-1.5">
        <div className="flex items-center gap-1.5">
          {icon}
          <span className="text-[10px] font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">{title}</span>
        </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider flex items-center gap-1.5">
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-3 py-2">
            <div className="p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
              <p className="text-xs text-black dark:text-white dark:text-white mb-1">Current Style</p>
              <div className="flex items-center gap-3">
                ...
                <div className="text-[10px] text-black dark:text-white dark:text-white">
