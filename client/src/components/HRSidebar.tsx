 ...
 * Design: White sidebar with blue accents, "Institutional Elegance" theme
    ...
    <>
      ...
      <aside className={`fixed top-0 left-0 h-full z-50 flex flex-col transition-transform duration-200 w-[240px] bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-700 ${collapsed ? "-translate-x-full lg:translate-x-0" : "translate-x-0"}`}
        ...
        <div className="p-4 border-t border-gray-100">
          <div className="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-800 transition-all cursor-pointer">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center text-white font-bold text-sm shadow-sm">
          ...
          <button onClick={() => setLocation("/")} className="w-full mt-2 py-1.5 rounded-lg text-[11px] font-medium text-gray-400 hover:text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5">
