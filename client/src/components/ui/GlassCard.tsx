...
export function GlassCard({
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case 'dark':
        return 'bg-[#062b2b]/80 border-[#0a6969]/50 text-white';
      case 'teal':
      ...
      default:
        return 'bg-white/80 dark:bg-[#0a4040]/80 border-white/20 dark:border-[#0a6969]/50 text-slate-900 dark:text-white';
    }
  };
