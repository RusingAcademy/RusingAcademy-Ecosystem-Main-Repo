        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.h1
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-black dark:text-foreground"
            >
              {renderTitle()}
            </motion.h1>
            ...
            <motion.p
              variants={fadeInUp}
              className="text-lg md:text-xl text-black dark:text-foreground/90 max-w-xl"
            >
              {subtitle}
            </motion.p>
