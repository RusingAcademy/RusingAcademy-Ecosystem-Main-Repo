  ...
  return (
    <div className={cn("rounded-xl border border-slate-200 dark:border-teal-800 bg-white dark:bg-slate-800 dark:bg-obsidian p-6", className)}>
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex-1 mx-4 relative">
            ...
            <div 
              className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-white dark:bg-slate-800 dark:bg-slate-900 border-2 border-blue-500 rounded-full shadow-md"
        ...
        <p className="text-center text-sm text-black dark:text-white dark:text-cyan-300">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="p-4 rounded-lg bg-slate-50 dark:bg-foundation">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-sm text-black dark:text-white dark:text-cyan-300">{l.weeklyHours}</span>
          </div>
          <p className="text-2xl font-bold text-black dark:text-white dark:text-white">{weeklyHours}h</p>
        </div>
        <div className="p-4 rounded-lg bg-slate-50 dark:bg-foundation">
          <div className="flex items-center gap-2 mb-1">
            <TrendingUp className="h-4 w-4 text-black dark:text-white dark:text-white" />
            <span className="text-sm text-black dark:text-white dark:text-cyan-300">{l.avgProgress}</span>
          </div>
          <p className="text-2xl font-bold text-black dark:text-white dark:text-white">+{averageProgress}%</p>
        </div>
        <div className="p-4 rounded-lg bg-slate-50 dark:bg-foundation">
          <div className="flex items-center gap-2 mb-1">
            <Calendar className="h-4 w-4 text-black dark:text-white dark:text-white" />
            <span className="text-sm text-black dark:text-white dark:text-cyan-300">{l.estimatedReady}</span>
          </div>
          <p className="text-lg font-bold text-black dark:text-white dark:text-white">
        ...
        {daysUntilExam && (
          <div className="p-4 rounded-lg bg-slate-50 dark:bg-foundation">
            <div className="flex items-center gap-2 mb-1">
              <Target className="h-4 w-4 text-black dark:text-white dark:text-white" />
              <span className="text-sm text-black dark:text-white dark:text-cyan-300">{l.daysUntilExam}</span>
            </div>
            <p className="text-2xl font-bold text-black dark:text-white dark:text-white">{daysUntilExam}</p>
          </div>
        )}
      </div>
      ...
      <div className={cn(
        ...
        <p className="text-sm font-medium text-black dark:text-white dark:text-white/90 mb-1">{l.recommendation}</p>
        <p className={cn(
          "text-sm",
