            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="date"
                    className="w-full px-4 py-2 bg-white dark:bg-background/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none"
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 bg-white dark:bg-background/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none">
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-white dark:bg-background/10 text-white rounded-lg hover:bg-white dark:bg-background/20 transition-colors"
                >
