  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-3">
        <div className="flex-1 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-full h-2">
          <div 
      ...
      <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
        <button
          ...
          className="flex-1 px-3 py-1.5 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg text-xs text-slate-300 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/20 transition-colors"
        >
          {t.viewDetails}
        </button>
        <button
          ...
          >
            ...
            >
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  onClick={() => setSelectedLead(null)}
                  className="p-2 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg"
                >
                  ✕
                </button>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="date"
                    className="w-full px-4 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none"
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none">
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-4 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg border border-white/10 text-white focus:border-teal-500 focus:outline-none resize-none"
                    rows={3}
              ...
              <div className="flex gap-3 mt-6">
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 text-white rounded-lg hover:bg-white dark:bg-slate-800 dark:bg-slate-900/20 transition-colors"
                >
