      ...
      <main id="main-content" className="flex-1" role="main" aria-label={isEn ? "Learner Dashboard" : "Tableau de bord apprenant"}>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-teal-600 via-teal-700 to-emerald-800 text-white">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-96 h-96 bg-white dark:bg-slate-900 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
            ...
            {enrollmentsLoading ? (
              <div className="flex items-center justify-center py-8">
                <div className="animate-pulse flex flex-col items-center gap-4">
                  <div className="h-8 w-64 bg-white dark:bg-slate-900/20 rounded-lg" />
                  <div className="h-4 w-48 bg-white dark:bg-slate-900/10 rounded" />
                </div>
              </div>
            ) : lastCourse ? (
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8">
                <div className="flex-1 text-center lg:text-left">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white dark:bg-slate-900/10 text-sm mb-4">
                  ...
                  <div className="bg-white dark:bg-slate-900/10 backdrop-blur-sm rounded-2xl p-5 border border-white/60 max-w-xl mx-auto lg:mx-0">
                    <div className="flex items-start gap-4">
                      <div className="h-14 w-14 rounded-xl bg-white dark:bg-slate-900/20 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          <Progress value={lastCourse.progressPercent} className="flex-1 h-2 bg-white dark:bg-slate-900/20" />
                        ...
                        {nextLesson && !nextLessonLoading && (
                          <div className="bg-white dark:bg-slate-900/10 rounded-lg p-3 mt-2">
                ...
                <div className="flex-shrink-0">
                  <Link href={`/courses/${lastCourse.courseId}${nextLesson ? `?lesson=${nextLesson.lessonId}` : ''}`}>
                    <Button 
                      size="lg" 
                      className="bg-white dark:bg-slate-900 text-teal-700 hover:bg-white dark:bg-slate-900/90 shadow-xl shadow-black/20 text-lg px-8 py-6 h-auto gap-3 font-semibold"
                    >
