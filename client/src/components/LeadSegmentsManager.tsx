...
const COLORS = [
  "var(--semantic-danger, var(--danger))", "#f97316", "var(--semantic-warning, var(--warning))", "#eab308", "#84cc16",
  "var(--semantic-success, var(--success))", "var(--semantic-success, var(--success))", "#14b8a6", "#06b6d4", "#0ea5e9",
  "var(--color-blue-500, var(--semantic-info))", "#6366f1", "var(--color-violet-500, var(--accent-purple))", "var(--color-purple-500, #a855f7)", "#d946ef",
  "#ec4899", "#f43f5e",
];
...
export default function LeadSegmentsManager() {
  ...
  const [formData, setFormData] = useState({
    ...
    color: "var(--color-blue-500, var(--semantic-info))",
  });
  ...
  const handleEdit = (segment: Segment) => {
    ...
    setFormData({
      ...
      color: segment.color || "var(--color-blue-500, var(--semantic-info))",
    });
    setShowDialog(true);
  };
          ...
          {segmentsQuery.data?.segments.map((segment: Segment) => (
            <Card key={segment.id} className="relative overflow-hidden">
              <div
                ...
                style={{ backgroundColor: segment.color || "var(--color-blue-500, var(--semantic-info))" }}
              />
