...
export default function FloatingAICompanion() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div
          className="fixed bottom-20 right-4 z-[60] w-[380px] max-w-[calc(100vw-2rem)] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700 flex flex-col overflow-hidden"
        ...
        >
                ...
                <div className="grid grid-cols-2 gap-2 w-full">
                  {QUICK_PROMPTS.map((qp) => (
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 hover:border-teal-700/30 hover:bg-teal-700/5 transition-all text-left"
                    >
              ...
              <>
                ...
                {chatMutation.isPending && (
                  <div className="flex justify-start">
                    ...
                    <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl rounded-bl-sm px-4 py-3 shadow-sm">
          ...
          {/* Input */}
          <div className="px-3 py-3 border-t border-gray-100 bg-white dark:bg-slate-900 flex-shrink-0">
            <form
              onSubmit={(e) => {
                e.preventDefault();
                handleSend(input);
            ...
            >
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none rounded-xl border border-gray-200 dark:border-slate-700 px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-700/20 focus:border-teal-700/40 max-h-20 bg-gray-50"
              />
              <button
                type="submit"
      ...
      <button
        ...
        className={`fixed bottom-4 right-4 z-[60] w-14 h-14 rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 ${
          isOpen
            ...
            : "bg-gradient-to-br from-teal-700 to-[#006d7a] hover:shadow-xl"
        }`}
