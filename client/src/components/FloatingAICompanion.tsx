          ...
          <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-3 space-y-3 bg-gray-50/50">
            {displayMessages.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center px-4">
                ...
                <p className="text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1">Hello! I'm your SLE Companion</p>
          ...
          <div className="px-3 py-3 border-t border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-800 dark:bg-slate-900 flex-shrink-0">
            ...
            >
              <textarea
                ...
                rows={1}
                className="flex-1 resize-none rounded-xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 px-3 py-2 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-700/20 focus:border-teal-700/40 max-h-20 bg-gray-50"
              />
              <button
                type="submit"
