...
const learningCapsules = [
  ...
  },
  {
    ...
    ringColor: "ring-[var(--brand-foundation, var(--brand-foundation))]/30 hover:ring-[var(--brand-foundation, var(--brand-foundation))]",
                              ...
                              <div className="border-t border-white/10 bg-white dark:bg-background">
                                <div className="p-3 border-b border-slate-200 flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-xs font-medium text-black dark:text-foreground">
                                  ...
                                  >
                                    <X className="w-3.5 h-3.5 text-black dark:text-foreground" />
                                  </button>
                                </div>
