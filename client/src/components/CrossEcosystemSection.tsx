  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {particles.map((p) => (
        <motion.div
          key={p.id}
          className="absolute rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900"
          style={{
            left: `${p.x}%`,
            top: `${p.y}%`,
            width: p.size,
...
function StatsPill({ icon: IconComp, value, label }: { icon: React.ElementType; value: string; label: string }) {
  return (
    <div className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm border border-white/10">
  ...
  return (
    <section className="section-dark py-28 px-0 bg-gradient-to-b from-[#031818] via-[#0a3d3d] to-[#031818] relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        >
          <div className="inline-flex gap-1.5 p-1.5 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-xl border border-white/10">
            <button
                      ...
                      return (
                        ...
                        >
                          <div className="relative bg-gradient-to-br from-[#0a4545]/80 via-[#0a5555]/60 to-teal-900/80 backdrop-blur-sm rounded-2xl overflow-hidden shadow-xl hover:shadow-[0_20px_60px_-12px_rgba(0,200,200,0.15)] transition-all duration-500 ring-1 ring-white/10 hover:ring-white/25 hover:-translate-y-2 group">
                            ...
                            <div className="p-4 bg-gradient-to-t from-obsidian via-[#0a3d3d]/95 to-teal-900/90">
                              ...
                              <div className="flex items-center gap-2">
                                {!isPlaying ? (
                                  ...
                                  <button
                                    onClick={handleStop}
                                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm border border-white/10 text-white text-xs font-semibold hover:bg-white dark:bg-slate-800 dark:bg-slate-900/15 transition-all duration-300"
                                  >
                                    <Square className="w-3 h-3" fill="white" />
                            ...
                            {isCommentsOpen && (
                              <div className="border-t border-white/10 bg-white dark:bg-slate-800 dark:bg-slate-900">
                                <div className="p-3 border-b border-slate-200 flex items-center justify-between">
                                  <div className="flex items-center gap-2">
                                    <MessageCircle className="w-3.5 h-3.5 text-black dark:text-white dark:text-white" />
                                    <span className="text-xs font-medium text-black dark:text-white dark:text-white">
                                  ...
                                  >
                                    <X className="w-3.5 h-3.5 text-black dark:text-white dark:text-white" />
                                  </button>
                                </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/#videos">
              <motion.button 
                className="inline-flex items-center gap-2 px-8 py-4 bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-xl border border-white/15 text-white font-semibold rounded-full hover:border-cta/50 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 hover:shadow-xl hover:shadow-orange-700/10 transition-all duration-300"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
