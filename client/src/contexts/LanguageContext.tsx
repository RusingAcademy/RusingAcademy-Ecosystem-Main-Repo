...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "flashcards.streak": "Day Streak",
    "flashcards.longestStreak": "Longest Streak",
    "flashcards.accuracy": "Accuracy",
    "flashcards.totalReviewed": "Total Reviewed",
    "flashcards.sessionSummary": "Session Summary",
    "flashcards.cardsReviewed": "Cards Reviewed",
    "flashcards.correctRate": "Correct Rate",
    "flashcards.sessionTime": "Session Time",
    "flashcards.keepGoing": "Keep Going!",
    "flashcards.greatSession": "Great session! Your streak continues.",
    "flashcards.keyboardTip": "Keyboard: Space to flip, 1-4 to rate",
    "flashcards.studyMore": "Study More",
    "flashcards.viewStats": "View Stats",
    "flashcards.min": "min",
    "flashcards.sec": "sec",
  ...
  fr: {
    ...
    "flashcards.streak": "Jours consécutifs",
    "flashcards.longestStreak": "Plus longue série",
    "flashcards.accuracy": "Précision",
    "flashcards.totalReviewed": "Total révisé",
    "flashcards.sessionSummary": "Résumé de la session",
    "flashcards.cardsReviewed": "Cartes révisées",
    "flashcards.correctRate": "Taux de réussite",
    "flashcards.sessionTime": "Durée de la session",
    "flashcards.keepGoing": "Continuez !",
    "flashcards.greatSession": "Excellente session ! Votre série continue.",
    "flashcards.keyboardTip": "Clavier : Espace pour retourner, 1-4 pour évaluer",
    "flashcards.studyMore": "Étudier plus",
    "flashcards.viewStats": "Voir les statistiques",
    "flashcards.min": "min",
    "flashcards.sec": "sec",
    "flashcards.newCards": "Nouvelles",
    "flashcards.learning": "En cours",
    "flashcards.review": "Révision",
