...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Skill Labs — Flashcards
    "flashcards.title": "Flashcards",
    "flashcards.newDeck": "New Deck",
    "flashcards.deckName": "Deck Name",
    "flashcards.color": "Color",
    "flashcards.cancel": "Cancel",
    "flashcards.create": "Create",
    "flashcards.save": "Save",
    "flashcards.delete": "Delete",
    "flashcards.addCard": "Add Flashcard",
    "flashcards.front": "Front (Question/Term)",
    "flashcards.back": "Back (Answer/Definition)",
    "flashcards.hint": "Hint (optional)",
    "flashcards.emptyTitle": "No flashcard decks yet",
    "flashcards.emptyDesc": "Create your first deck to start learning with spaced repetition!",
    "flashcards.emptyCards": "No cards in this deck",
    "flashcards.emptyCardsDesc": "Add your first flashcard to start studying!",
    "flashcards.tapReveal": "Tap to reveal answer",
    ...
    "flashcards.perfect": "Perfect",
    "flashcards.reviewComplete": "Review Complete!",
    "flashcards.reviewCompleteDesc": "Great work! You've reviewed all due cards.",
    "flashcards.backToDecks": "Back to Decks",
    "flashcards.startReview": "Start Review",
    ...
    // Skill Labs — Vocabulary
    "vocab.title": "Vocabulary Builder",
    "vocab.addWord": "Add Word",
    "vocab.word": "Word",
    "vocab.translation": "Translation",
    "vocab.context": "Context sentence (optional)",
    "vocab.category": "Category",
    "vocab.emptyTitle": "Your vocabulary bank is empty",
    "vocab.emptyDesc": "Start building your personal word bank to track and master new vocabulary!",
    "vocab.mastery": "Mastery",
    "vocab.review": "Review",
    "vocab.totalWords": "Total Words",
    "vocab.masteredWords": "Mastered",
    "vocab.avgMastery": "Avg. Mastery",
    "vocab.aiSuggest": "AI Suggestions",
    "vocab.aiSuggestDesc": "Get vocabulary suggestions tailored to your SLE level.",
    "vocab.getSuggestions": "Get Suggestions",
    "vocab.topic": "Topic",
    "vocab.level": "CEFR Level",

    // Skill Labs — Grammar Drills
    "grammar.title": "Grammar Drills",
    "grammar.startDrill": "Start Drill",
    "grammar.topic": "Topic",
    "grammar.difficulty": "Difficulty",
    "grammar.score": "Score",
    "grammar.emptyTitle": "No grammar drill results yet",
    "grammar.emptyDesc": "Complete your first grammar drill to track your progress!",
    "grammar.history": "History",
    "grammar.stats": "Statistics",
    "grammar.byTopic": "By Topic",
    "grammar.totalDrills": "Total Drills",
    "grammar.avgScore": "Avg. Score",
    "grammar.checkAnswer": "Check Answer",
    "grammar.next": "Next",
    "grammar.finish": "Finish",
    "grammar.correct": "Correct!",
    "grammar.incorrect": "Incorrect",

    // Skill Labs — Reading Lab
    "reading.title": "Reading Lab",
    "reading.emptyTitle": "No reading exercises completed yet",
    "reading.emptyDesc": "Start a reading comprehension exercise to build your skills!",
    "reading.start": "Start Exercise",
    "reading.history": "History",
    "reading.stats": "Statistics",
    "reading.totalExercises": "Total Exercises",
    "reading.avgScore": "Avg. Score",
    "reading.passage": "Passage",
    "reading.questions": "Questions",

    // Skill Labs — Writing Portfolio
    "writing.title": "Writing Portfolio",
    "writing.newEntry": "New Entry",
    "writing.emptyTitle": "Your writing portfolio is empty",
    "writing.emptyDesc": "Start writing to build your portfolio and track your progress!",
    "writing.prompt": "Writing Prompt",
    "writing.submit": "Submit",
    "writing.getAIFeedback": "Get AI Feedback",
    "writing.history": "Submissions",
    "writing.draft": "Draft",
    "writing.submitted": "Submitted",
    "writing.reviewed": "Reviewed",

    // Skill Labs — Listening Lab
    "listening.title": "Listening Lab",
    "listening.emptyTitle": "No listening exercises completed yet",
    "listening.emptyDesc": "Start a listening comprehension exercise to sharpen your skills!",
    "listening.start": "Start Exercise",
    "listening.history": "History",
    "listening.stats": "Statistics",
    "listening.totalExercises": "Total Exercises",
    "listening.avgScore": "Avg. Score",
    "listening.playAudio": "Play Audio",
    "listening.replay": "Replay",

    // Skill Labs — Daily Review
    "daily.title": "Daily Review",
    "daily.emptyTitle": "No cards due for review",
    "daily.emptyDesc": "Great job! You're all caught up. Come back tomorrow for your next review session.",
    "daily.streak": "Day Streak",
    "daily.cardsReviewed": "Cards Reviewed",
    "daily.startReview": "Start Daily Review",

    // Skill Labs — Study Groups
    "groups.title": "Study Groups",
    "groups.create": "Create Group",
    "groups.join": "Join",
    "groups.leave": "Leave",
    "groups.myGroups": "My Groups",
    "groups.publicGroups": "Public Groups",
    "groups.emptyTitle": "No study groups yet",
    "groups.emptyDesc": "Create or join a study group to learn with others!",
    "groups.members": "members",
    "groups.name": "Group Name",
    "groups.description": "Description",
    "groups.isPublic": "Public Group",

    // Skill Labs — Weekly Challenges
    "challenges.title": "Weekly Challenges",
    "challenges.emptyTitle": "No active challenges",
    "challenges.emptyDesc": "Check back soon for new weekly challenges to test your skills!",
    "challenges.progress": "Progress",
    "challenges.daysLeft": "days left",
    "challenges.completed": "Completed!",

    // Skill Labs — Common
    "skillLabs.signInTitle": "Sign in to access Skill Labs",
    "skillLabs.signInDesc": "Create a free account to start practicing and tracking your progress.",
    "skillLabs.signIn": "Sign In",
    "skillLabs.loading": "Loading...",
  },
  fr: {
    // Navigation
    ...
    "flashcards.newDeck": "Nouveau paquet",
    "flashcards.deckName": "Nom du paquet",
    "flashcards.color": "Couleur",
    "flashcards.cancel": "Annuler",
    "flashcards.create": "Créer",
    "flashcards.save": "Enregistrer",
    "flashcards.delete": "Supprimer",
    "flashcards.addCard": "Ajouter une carte",
    "flashcards.front": "Recto (Question/Terme)",
    "flashcards.back": "Verso (Réponse/Définition)",
    "flashcards.hint": "Indice (optionnel)",
    "flashcards.emptyTitle": "Aucun paquet de cartes",
    "flashcards.emptyDesc": "Créez votre premier paquet pour commencer à apprendre avec la répétition espacée !",
    "flashcards.emptyCards": "Aucune carte dans ce paquet",
    "flashcards.emptyCardsDesc": "Ajoutez votre première carte pour commencer à étudier !",
    "flashcards.tapReveal": "Appuyez pour révéler la réponse",
    "flashcards.howWell": "Dans quelle mesure connaissiez-vous cette réponse ?",
    "flashcards.again": "Encore",
    "flashcards.hard": "Difficile",
    "flashcards.good": "Bien",
    "flashcards.easy": "Facile",
    "flashcards.perfect": "Parfait",
    "flashcards.reviewComplete": "Révision terminée !",
    "flashcards.reviewCompleteDesc": "Excellent travail ! Vous avez révisé toutes les cartes du jour.",
    "flashcards.backToDecks": "Retour aux paquets",
    "flashcards.startReview": "Commencer la révision",
    "flashcards.cards": "cartes",
    "flashcards.due": "en attente",
    "flashcards.totalDecks": "Total des paquets",
    "flashcards.totalCards": "Total des cartes",
    "flashcards.dueToday": "À réviser aujourd'hui",
    "flashcards.mastered": "Maîtrisées",

    // Skill Labs — Vocabulary
    "vocab.title": "Banque de vocabulaire",
    "vocab.addWord": "Ajouter un mot",
    "vocab.word": "Mot",
    "vocab.translation": "Traduction",
    "vocab.context": "Phrase contextuelle (optionnel)",
    "vocab.category": "Catégorie",
    "vocab.emptyTitle": "Votre banque de vocabulaire est vide",
    "vocab.emptyDesc": "Commencez à construire votre banque de mots personnelle pour suivre et maîtriser le nouveau vocabulaire !",
    "vocab.mastery": "Maîtrise",
    "vocab.review": "Réviser",
    "vocab.totalWords": "Total des mots",
    "vocab.masteredWords": "Maîtrisés",
    "vocab.avgMastery": "Maîtrise moy.",
    "vocab.aiSuggest": "Suggestions IA",
    "vocab.aiSuggestDesc": "Obtenez des suggestions de vocabulaire adaptées à votre niveau ELS.",
    "vocab.getSuggestions": "Obtenir des suggestions",
    "vocab.topic": "Sujet",
    "vocab.level": "Niveau CECR",

    // Skill Labs — Grammar Drills
    "grammar.title": "Exercices de grammaire",
    "grammar.startDrill": "Commencer l'exercice",
    "grammar.topic": "Sujet",
    "grammar.difficulty": "Difficulté",
    "grammar.score": "Score",
    "grammar.emptyTitle": "Aucun exercice de grammaire complété",
    "grammar.emptyDesc": "Complétez votre premier exercice de grammaire pour suivre vos progrès !",
    "grammar.history": "Historique",
    "grammar.stats": "Statistiques",
    "grammar.byTopic": "Par sujet",
    "grammar.totalDrills": "Total des exercices",
    "grammar.avgScore": "Score moyen",
    "grammar.checkAnswer": "Vérifier la réponse",
    "grammar.next": "Suivant",
    "grammar.finish": "Terminer",
    "grammar.correct": "Correct !",
    "grammar.incorrect": "Incorrect",

    // Skill Labs — Reading Lab
    "reading.title": "Labo de lecture",
    "reading.emptyTitle": "Aucun exercice de lecture complété",
    "reading.emptyDesc": "Commencez un exercice de compréhension écrite pour développer vos compétences !",
    "reading.start": "Commencer l'exercice",
    "reading.history": "Historique",
    "reading.stats": "Statistiques",
    "reading.totalExercises": "Total des exercices",
    "reading.avgScore": "Score moyen",
    "reading.passage": "Passage",
    "reading.questions": "Questions",

    // Skill Labs — Writing Portfolio
    "writing.title": "Portfolio d'écriture",
    "writing.newEntry": "Nouvelle entrée",
    "writing.emptyTitle": "Votre portfolio d'écriture est vide",
    "writing.emptyDesc": "Commencez à écrire pour construire votre portfolio et suivre vos progrès !",
    "writing.prompt": "Sujet d'écriture",
    "writing.submit": "Soumettre",
    "writing.getAIFeedback": "Obtenir un retour IA",
    "writing.history": "Soumissions",
    "writing.draft": "Brouillon",
    "writing.submitted": "Soumis",
    "writing.reviewed": "Révisé",

    // Skill Labs — Listening Lab
    "listening.title": "Labo d'écoute",
    "listening.emptyTitle": "Aucun exercice d'écoute complété",
    "listening.emptyDesc": "Commencez un exercice de compréhension orale pour affiner vos compétences !",
    "listening.start": "Commencer l'exercice",
    "listening.history": "Historique",
    "listening.stats": "Statistiques",
    "listening.totalExercises": "Total des exercices",
    "listening.avgScore": "Score moyen",
    "listening.playAudio": "Lire l'audio",
    "listening.replay": "Rejouer",

    // Skill Labs — Daily Review
    "daily.title": "Révision quotidienne",
    "daily.emptyTitle": "Aucune carte à réviser",
    "daily.emptyDesc": "Excellent travail ! Vous êtes à jour. Revenez demain pour votre prochaine session de révision.",
    "daily.streak": "Jours consécutifs",
    "daily.cardsReviewed": "Cartes révisées",
    "daily.startReview": "Commencer la révision quotidienne",

    // Skill Labs — Study Groups
    "groups.title": "Groupes d'étude",
    "groups.create": "Créer un groupe",
    "groups.join": "Rejoindre",
    "groups.leave": "Quitter",
    "groups.myGroups": "Mes groupes",
    "groups.publicGroups": "Groupes publics",
    "groups.emptyTitle": "Aucun groupe d'étude",
    "groups.emptyDesc": "Créez ou rejoignez un groupe d'étude pour apprendre avec d'autres !",
    "groups.members": "membres",
    "groups.name": "Nom du groupe",
    "groups.description": "Description",
    "groups.isPublic": "Groupe public",

    // Skill Labs — Weekly Challenges
    "challenges.title": "Défis hebdomadaires",
    "challenges.emptyTitle": "Aucun défi actif",
    "challenges.emptyDesc": "Revenez bientôt pour de nouveaux défis hebdomadaires !",
    "challenges.progress": "Progrès",
    "challenges.daysLeft": "jours restants",
    "challenges.completed": "Complété !",

    // Skill Labs — Common
    "skillLabs.signInTitle": "Connectez-vous pour accéder aux labos de compétences",
    "skillLabs.signInDesc": "Créez un compte gratuit pour commencer à pratiquer et suivre vos progrès.",
    "skillLabs.signIn": "Se connecter",
    "skillLabs.loading": "Chargement...",
  },
};
