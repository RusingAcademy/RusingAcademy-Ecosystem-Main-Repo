      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Path Summary Card */}
            {path && (
              <Card className="max-w-md mx-auto mb-8 border-green-200 bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      ...
                      <div className="flex items-center gap-3 text-sm text-black dark:text-white dark:text-white mt-1">
            ...
            {nextSteps.map((step, index) => (
              ...
              >
                <Card className={`h-full ${step.primary ? "border-amber-300 bg-amber-50/50" : ""}`}>
                  ...
                  <CardContent>
                    <p className="text-black dark:text-white dark:text-white mb-4">{step.description}</p>
                    <Link href={step.href}>
                      <Button
