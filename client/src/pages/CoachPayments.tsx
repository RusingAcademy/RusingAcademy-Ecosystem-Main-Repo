    ...
    return (
      <div className="min-h-screen bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md">
        ...
        <main className="max-w-4xl mx-auto px-4 py-8 md:py-12 lg:py-16 text-center">
          ...
          <p className="text-black dark:text-foreground dark:text-cyan-300">
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-black dark:text-foreground mb-2">
            Payments & Payouts
          </h1>
          <p className="text-black dark:text-foreground dark:text-cyan-300">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-[var(--text-inverse)] dark:from-indigo-900/20 dark:to-teal-700/20 rounded-xl p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-black dark:text-foreground">Fast Payouts</h4>
                      <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-black dark:text-foreground">Secure</h4>
                      <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-black dark:text-foreground">Track Earnings</h4>
                      <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">
          ...
          <div className="grid md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl p-6 shadow-sm border border-gray-200 dark:border-white/15 dark:border-teal-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-black dark:text-foreground dark:text-cyan-300">Total Earned</span>
              </div>
              <div className="text-2xl font-bold text-black dark:text-foreground">
            ...
            <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl p-6 shadow-sm border border-gray-200 dark:border-white/15 dark:border-teal-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-black dark:text-foreground dark:text-cyan-300">This Month</span>
              </div>
              <div className="text-2xl font-bold text-black dark:text-foreground">
            ...
            <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl p-6 shadow-sm border border-gray-200 dark:border-white/15 dark:border-teal-800">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-sm text-black dark:text-foreground dark:text-cyan-300">Sessions</span>
              </div>
              <div className="text-2xl font-bold text-black dark:text-foreground">
        ...
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl shadow-sm border border-gray-200 dark:border-white/15 dark:border-teal-800 p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between py-3">
              <div>
                <span className="font-medium text-black dark:text-foreground">High Volume (50+ hrs/month)</span>
                <p className="text-sm text-black dark:text-foreground dark:text-cyan-300">For active coaches</p>
              </div>
