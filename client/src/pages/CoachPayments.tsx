  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-800 dark:bg-obsidian">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-slate-800 dark:bg-foundation rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 dark:border-teal-800 p-6 mb-8">
          <div className="flex items-start justify-between mb-6">
            ...
            {hasAccount ? (
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium bg-gray-100 dark:bg-slate-800 dark:bg-teal-800 text-black dark:text-white dark:text-cyan-300">
                Not Connected
              </span>
            )}
          </div>
          ...
          {!hasAccount ? (
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-[var(--text-inverse)] dark:from-indigo-900/20 dark:to-teal-700/20 rounded-xl p-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 bg-white dark:bg-slate-800 dark:bg-foundation rounded-lg flex items-center justify-center shadow-sm">
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-slate-800 dark:bg-teal-800/50 rounded-xl p-4">
        ...
        {earnings && (
          <div className="grid md:grid-cols-4 gap-4 mb-8">
            <div className="bg-white dark:bg-slate-800 dark:bg-foundation rounded-xl p-6 shadow-sm border border-gray-200 dark:border-slate-700 dark:border-teal-800">
