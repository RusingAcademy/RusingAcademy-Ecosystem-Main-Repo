        ...
        const htmlContent = `
          ...
          <head>
            ...
            <style>
              ...
              h1 { color: var(--brand-foundation, var(--brand-foundation)); border-bottom: 2px solid var(--brand-foundation, var(--brand-foundation)); padding-bottom: 10px; }
              .header { margin-bottom: 20px; }
              .company { font-size: 12px; color: #666; }
              table { width: 100%; border-collapse: collapse; margin-top: 20px; }
              th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }
              th { background-color: var(--brand-foundation, var(--brand-foundation)); color: white; }
          ...
          <div className="relative mb-8 overflow-hidden rounded-2xl bg-foundation dark:bg-obsidian p-8 md:p-10 border border-teal-800/50">
            ...
            <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-white/90 text-lg max-w-xl">{l.subtitle}</p>
              </div>
