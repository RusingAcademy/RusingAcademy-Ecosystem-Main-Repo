  ...
  en: {
    ...
    posts: [
      ...
      },
      {
        ...
        excerpt: "How a policy analyst improved her French proficiency in just 6 months using Lingueefy coaches and Prof Steven AI.",
        category: "success",
  ...
  fr: {
    ...
    posts: [
      ...
      },
      {
        ...
        excerpt: "Comment une analyste de politiques a amélioré sa maîtrise du français en seulement 6 mois en utilisant les coachs Lingueefy et Prof Steven IA.",
        category: "success",
