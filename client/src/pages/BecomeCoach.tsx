      ...
      <div className="min-h-screen bg-gradient-to-b from-teal-900 via-teal-800 to-obsidian flex items-center justify-center p-4">
        <Card className="max-w-lg w-full">
          <CardContent className="pt-8 text-center">
            ...
            <div className="text-left bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-4 mb-6">
          ...
          <div className="container relative py-20 md:py-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6 md:mb-8 lg:mb-12">
                {!isAuthenticated ? (
                  <a href={getLoginUrl()}>
                    <Button size="lg" className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md text-teal-700 hover:bg-teal-50 shadow-xl shadow-teal-900/20 gap-2 w-full sm:w-auto">
                      {l.loginToApply}
                  ...
                  <Button
                    size="lg"
                    className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md text-teal-700 hover:bg-teal-50 shadow-xl shadow-teal-900/20 gap-2"
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {l.requirementsList.map((req, i) => {
                  const Icon = req.icon;
                  return (
                    <div key={i} className="flex items-center gap-4 p-5 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl shadow-sm hover:shadow-md transition-shadow">
