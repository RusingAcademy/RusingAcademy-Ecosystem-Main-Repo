      ...
      <div className="min-h-screen bg-gradient-to-b from-teal-900 via-teal-800 to-obsidian flex items-center justify-center p-4">
        <Card className="max-w-lg w-full">
          <CardContent className="pt-8 text-center">
            ...
            <p className="text-black dark:text-white dark:text-white mb-6">{l.successMessage}</p>
            <div className="text-left bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg p-4 mb-6">
              ...
              <ul className="space-y-2">
                {l.successSteps.map((step, i) => (
                  <li key={i} className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-black dark:text-white dark:text-white">{step}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="container relative py-20 md:py-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                {!isAuthenticated ? (
                  <a href={getLoginUrl()}>
                    <Button size="lg" className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-teal-700 hover:bg-teal-50 shadow-xl shadow-teal-900/20 gap-2 w-full sm:w-auto">
                      {l.loginToApply}
                  ...
                  <Button
                    size="lg"
                    className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-teal-700 hover:bg-teal-50 shadow-xl shadow-teal-900/20 gap-2"
                ...
                return (
                  <Card key={i} className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 shadow-md">
                    <CardContent className="pt-6">
                      ...
                      <p className="text-black dark:text-white dark:text-white">{benefit.description}</p>
                    </CardContent>
                  </Card>
                );
              })}
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {l.requirementsList.map((req, i) => {
                  const Icon = req.icon;
                  return (
                    <div key={i} className="flex items-center gap-4 p-5 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-black dark:text-white dark:text-white">{isEn ? "Via Stripe Connect" : "Via Stripe Connect"}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-black dark:text-white dark:text-white">{isEn ? "Volume-based tiers" : "Paliers basés sur le volume"}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-black dark:text-white dark:text-white">{isEn ? "$40-$100+/hour" : "40-100$+/heure"}</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {l.faqs.map((faq, i) => (
                <Card key={i} className="border-0 shadow-sm hover:shadow-md transition-shadow">
                  <CardContent className="pt-6">
                    ...
                    <p className="text-black dark:text-white dark:text-white">{faq.a}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
