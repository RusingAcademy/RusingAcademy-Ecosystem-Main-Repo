  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-obsidian via-teal-900 to-obsidian flex items-center justify-center p-6">
        <Card className="max-w-md bg-white dark:bg-background/5 border-white/60">
          <CardHeader>
    ...
    <div className="min-h-screen bg-gradient-to-br from-obsidian via-teal-900 to-obsidian p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/dashboard">
            <Button variant="outline" className="border-white/60 text-white hover:bg-white dark:bg-background/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Card className="bg-white dark:bg-background/5 border-white/60">
        ...
        <div className="flex flex-wrap gap-3 mb-6 items-center">
          <Select value={dateRange} onValueChange={setDateRange}>
            <SelectTrigger className="w-44 bg-white dark:bg-background/5 border-white/60 text-white">
          ...
          <Select value={levelFilter} onValueChange={setLevelFilter}>
            <SelectTrigger className="w-40 bg-white dark:bg-background/5 border-white/60 text-white">
          ...
          <Select value={skillFilter} onValueChange={setSkillFilter}>
            <SelectTrigger className="w-48 bg-white dark:bg-background/5 border-white/60 text-white">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {filteredSessions.map((session) => (
              <Card
                key={session.id}
                className="bg-white dark:bg-background/5 border-white/60 hover:border-cyan-400/30 transition-colors"
              >
                <CardContent className="p-4">
