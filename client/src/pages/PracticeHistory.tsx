      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-6 items-center">
          <Select value={dateRange} onValueChange={setDateRange}>
            <SelectTrigger className="w-44 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border-white/60 text-white">
          ...
          <Select value={levelFilter} onValueChange={setLevelFilter}>
            <SelectTrigger className="w-40 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border-white/60 text-white">
          ...
          <Select value={skillFilter} onValueChange={setSkillFilter}>
            <SelectTrigger className="w-48 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border-white/60 text-white">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {filteredSessions.map((session) => (
              <Card
                key={session.id}
                className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border-white/60 hover:border-cyan-400/30 transition-colors"
              >
                <CardContent className="p-4">
