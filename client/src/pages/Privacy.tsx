...
export default function Privacy() {
  ...
  const content = {
    en: {
      ...
      intro: "Rusinga International Consulting Ltd. (\"we\", \"us\", \"our\") operates Lingueefy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform.",
      sections: [
        {
        ...
        {
          title: "12. Contact Us",
          content: `For privacy-related questions or to exercise your rights, contact our Privacy Officer at: admin@rusingacademy.ca or Rusinga International Consulting Ltd., Ottawa, Ontario, Canada.`,
        },
      ],
    },
    fr: {
      ...
      intro: "Rusinga International Consulting Ltd. (« nous », « notre », « nos ») exploite Lingueefy. Cette Politique de confidentialité explique comment nous collectons, utilisons, divulguons et protégeons vos informations lorsque vous utilisez notre plateforme.",
      sections: [
        {
        ...
        },
        {
          ...
          content: `Pour les questions relatives à la confidentialité ou pour exercer vos droits, contactez notre Responsable de la confidentialité à : admin@rusingacademy.ca ou Rusinga International Consulting Ltd., Ottawa, Ontario, Canada.`,
        },
      ],
    },
  };
