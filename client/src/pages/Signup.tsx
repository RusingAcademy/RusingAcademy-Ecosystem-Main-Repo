...
function SignupContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-obsidian via-teal-900 to-obsidian p-4 relative">
      {/* Home Button */}
      <Link href="/">
        <button className="absolute top-4 left-4 p-3 rounded-full bg-white dark:bg-background/10 hover:bg-white dark:bg-background/20 transition-colors border border-white/60">
      ...
      <Card className="w-full max-w-md bg-foundation/50 border-teal-800">
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="text-center text-xs text-black dark:text-foreground">
