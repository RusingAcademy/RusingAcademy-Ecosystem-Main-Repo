  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {/* Trusted By Section */}
        <section className="py-12 bg-white dark:bg-background border-y border-slate-100">
          <div className="container">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
              {federalOrgs.map((org, i) => (
                <div 
                  key={i}
                  className="flex items-center gap-2 text-black dark:text-foreground hover:text-black dark:text-foreground transition-colors"
                >
