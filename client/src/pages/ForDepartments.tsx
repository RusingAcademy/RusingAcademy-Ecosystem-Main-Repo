            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                ...
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-white/60 text-white hover:bg-white dark:bg-slate-900/10 backdrop-blur-sm px-8"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div 
                    key={i}
                    className="bg-white dark:bg-slate-900/10 backdrop-blur-md rounded-2xl p-6 border border-white/60 hover:bg-white dark:bg-slate-900/15 transition-all duration-300"
                  >
          ...
          <div className="container">
            ...
            <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-700 ${
              ...
              {t.benefits.map((benefit, i) => {
                ...
                return (
                  <div                    key={i}
                    className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
          ...
          <div className="container">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
              {federalOrgs.map((org, i) => (
                <div 
                  key={i}
                  className="flex items-center gap-2 text-black dark:text-white hover:text-black dark:text-white transition-colors"
                >
          ...
          <div className="container">
            <div className="max-w-2xl mx-auto">
              ...
              {formSubmitted ? (
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-lg border border-slate-100">
          ...
          <div className="container">
            ...
            <div className={`max-w-3xl mx-auto space-y-4 transition-all duration-700 ${
              ...
              {t.faqs.map((faq, i) => (
                <div 
                  key={i} 
                  className="bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-100 hover:border-teal-200 transition-colors cursor-pointer"
                  style={{ transitionDelay: `${i * 100}ms` }}
