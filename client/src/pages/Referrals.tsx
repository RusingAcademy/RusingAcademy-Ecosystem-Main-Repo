  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-barholex-gold/5 to-background">
      <div className="max-w-5xl mx-auto px-4 pt-8 pb-16">
        ...
        {/* Referral Link Card */}
        <Card className="mb-8 border-2" style={{ borderColor: "var(--brand-gold, var(--barholex-gold))" + "40" }}>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            { icon: MousePointerClick, label: "Total Clicks", value: stats?.totalClicks ?? 0, color: "var(--brand-obsidian, var(--accent-purple-deep))" },
            { icon: Users, label: "Referrals", value: stats?.totalReferrals ?? 0, color: "#2EC4B6" },
            { icon: TrendingUp, label: "Conversions", value: stats?.conversions ?? 0, color: "var(--brand-gold, var(--barholex-gold))" },
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="text-center p-6 bg-card rounded-2xl border">
                <div className="w-10 h-10 rounded-full mx-auto mb-3 flex items-center justify-center text-white font-bold" style={{ backgroundColor: "var(--brand-gold, var(--barholex-gold))" }}>
                  {item.step}
                </div>
