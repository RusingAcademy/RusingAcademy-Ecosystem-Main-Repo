      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <div className="inline-block px-8 py-6 md:px-12 md:py-8 rounded-3xl bg-white/[0.07] backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.2)] mb-8">
...
function FilterBar({
  ...
  return (
    <section className="sticky top-0 z-30 bg-white/95 backdrop-blur-xl border-b border-slate-200/80 shadow-sm">
      ...
      >
        ...
        <div className="relative aspect-[3/4] overflow-hidden bg-gradient-to-br from-slate-100 to-slate-50 rounded-t-2xl">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            ...
            {item.is_featured && (
              <Badge className="bg-[#0F3D3E] text-white border-0 text-xs font-semibold shadow-md">
          ...
          <div className="absolute top-3 right-3">
            <Badge variant="secondary" className="bg-white/90 backdrop-blur-sm text-slate-700 text-xs shadow-sm">
          ...
          <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-400">
            <Button
              size="sm"
              className="w-full bg-white/95 backdrop-blur-md text-[#0F3D3E] hover:bg-white rounded-full font-medium text-xs shadow-lg"
            >
        ...
        <CardContent className="p-4 flex-1 flex flex-col">
          ...
          {/* Title */}
          <h3 className="font-semibold text-slate-900 text-sm md:text-base leading-snug mb-2 line-clamp-2 group-hover:text-[#0F3D3E] transition-colors duration-300">
            {title}
          </h3>
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-slate-100">
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full gap-2 border-slate-200 hover:border-[#0F3D3E] hover:text-[#0F3D3E] transition-all duration-200"
              onClick={() => {
                onClose();
            ...
            <div className="space-y-20">
              ...
              <section>
                <motion.div
                  ...
                  className="bg-gradient-to-br from-[#0F3D3E]/5 via-[#14B8A6]/5 to-[#0F3D3E]/5 rounded-3xl p-8 md:p-12 text-center border border-[#0F3D3E]/10"
                >
                  <div className="max-w-2xl mx-auto">
                    ...
                    <Button
                      size="lg"
                      variant="outline"
                      className="rounded-full border-[#0F3D3E] text-[#0F3D3E] hover:bg-[#0F3D3E] hover:text-white transition-all duration-300"
                    >
