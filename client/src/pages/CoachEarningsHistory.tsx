        ...
        <main className="flex-1 flex items-center justify-center">
          <Card className="max-w-md w-full mx-4">
            <CardHeader className="text-center">
              <Wallet className="w-12 h-12 mx-auto text-black dark:text-foreground mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <DollarSign className="h-4 w-4 text-black dark:text-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{formatCurrency(earnings.totalEarnings)}</div>
              <p className="text-xs text-black dark:text-foreground flex items-center">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CheckCircle className="h-4 w-4 text-black dark:text-foreground" />
            </CardHeader>
            <CardContent>
          ...
          <CardContent>
            {filteredTransactions.length === 0 ? (
              <div className="text-center py-12">
                <BarChart3 className="w-12 h-12 mx-auto text-black dark:text-foreground mb-4" />
                <h3 className="text-lg font-medium mb-2">{l.noTransactions}</h3>
                <p className="text-black dark:text-foreground">{l.noTransactionsDesc}</p>
              </div>
            ) : (
                  ...
                  <TableBody>
                    {filteredTransactions.map((transaction) => (
                      <TableRow key={transaction.id}>
                        ...
                        <TableCell className="text-right text-black dark:text-foreground">
