...
export default function LearnCourse() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      {/* Header */}
      <div className="border-b bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm sticky top-0 z-10">
      ...
      <div className="container max-w-5xl py-8">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-black dark:text-white dark:text-white mb-2">{course.title}</h1>
