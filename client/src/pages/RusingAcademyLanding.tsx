        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 rounded-3xl bg-gray-50 border border-gray-200 dark:border-slate-700 relative overflow-hidden"
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 p-6 bg-gradient-to-b from-white/80 to-white border-t border-gray-100/50">
                    ...
                    <Link
                      href="/curriculum"
                      className="flex-1 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold transition-all hover:scale-[1.02] bg-white dark:bg-slate-900 text-slate-900 border-2 border-gray-200 dark:border-slate-700 hover:border-teal-400 hover:text-teal-600 text-lg shadow-sm"
                    >
              ...
              <div className="space-y-6">
                {t.testimonials.items.map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="p-6 rounded-2xl bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-gray-100 shadow-sm hover:shadow-lg transition-all"
                  >
