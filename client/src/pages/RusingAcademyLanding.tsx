    ...
    >
      ...
      >
        ...
        <div className="relative flex items-center justify-center gap-3 flex-wrap">
          ...
          <div className="hidden sm:block w-px h-4 bg-white/30" />
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/20 backdrop-blur-sm text-white text-xs font-bold border border-white/30">
      ...
      >
        ...
        <div className="relative max-w-5xl mx-auto px-6 md:px-8 lg:px-12 py-24 text-center">
          <div className="flex flex-col items-center">
            ...
            >
              <div className="px-6 py-4 rounded-2xl shadow-lg bg-white/90 backdrop-blur-sm border border-slate-200/80 hover:shadow-xl transition-all hover:-translate-y-0.5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#082038]">3-4x</p>
              ...
              <div className="px-6 py-4 rounded-2xl shadow-lg bg-white/90 backdrop-blur-sm border border-slate-200/80 hover:shadow-xl transition-all hover:-translate-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[#082038]">95% {lang === 'fr' ? 'R\u00e9ussite' : 'Success'}</span>
                </div>
              </div>
              ...
              <div className="px-6 py-4 rounded-2xl shadow-lg bg-white/90 backdrop-blur-sm border border-slate-200/80 hover:shadow-xl transition-all hover:-translate-y-0.5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-[#082038]">2,500+</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 rounded-3xl bg-gray-50 border border-gray-200 relative overflow-hidden"
            >
      ...
      <section className="py-24 bg-white relative overflow-x-clip">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-5 text-[#082038]">
            ...
            <div className="flex justify-center mt-8">
              <div className="inline-flex rounded-2xl bg-gray-100 p-1.5 gap-1 shadow-inner">
                <button
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-4 p-6 bg-gradient-to-b from-white/80 to-white border-t border-gray-100/50">
                    ...
                    <Link
                      href="/curriculum"
                      className="flex-1 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-bold transition-all hover:scale-[1.02] bg-white text-[#082038] border-2 border-gray-200 hover:border-teal-400 hover:text-teal-600 text-lg shadow-sm"
                    >
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
                      <div>
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span className="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-slate-700">
                            {currentPath.level}
                          </span>
                        </div>
            ...
            {t.whyUs.items.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative p-7 rounded-2xl bg-gradient-to-br from-gray-50/80 to-white border border-gray-100 hover:border-teal-200 transition-all hover:shadow-xl hover:-translate-y-1"
                >
                  <div 
            ...
            {t.offerings.items.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: index * 0.1 }}
                  className="group relative p-8 rounded-3xl bg-gradient-to-br from-gray-50/80 to-white border border-gray-100 hover:border-teal-200 transition-all hover:shadow-xl hover:-translate-y-1"
                >
                  <div 
              ...
              <div className="space-y-6">
                {t.testimonials.items.map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: index * 0.1 }}
                    className="p-6 rounded-2xl bg-white/90 backdrop-blur-sm border border-gray-100 shadow-sm hover:shadow-lg transition-all"
                  >
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold transition-all hover:scale-105 bg-white text-[#082038] shadow-xl hover:shadow-2xl"
              >
                {t.cta.button1}
                <ArrowRight className="w-4 h-4" />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold transition-all hover:scale-105 bg-white/10 text-white border-2 border-white/60 hover:bg-white/20 backdrop-blur-sm"
              >
                {t.cta.button2}
              </a>
            </div>
