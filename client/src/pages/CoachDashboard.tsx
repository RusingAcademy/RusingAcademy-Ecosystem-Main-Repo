        ...
        <div className="px-4 sm:px-6 lg:px-8 xl:px-12 py-8 max-w-[1600px] mx-auto">
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="flex-1 p-6">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    ...
                    <div className="flex flex-col gap-2 text-sm text-black dark:text-white dark:text-white">
                  ...
                  {coachProfile.bio && (
                    <p className="text-sm text-black dark:text-white dark:text-white mt-4 line-clamp-2">
                      {coachProfile.bio}
                    </p>
                  )}
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <StatCard
              ...
              value="30%"
              icon={Percent}
              iconColor="text-black dark:text-white dark:text-white"
          ...
          <div className="grid lg:grid-cols-3 gap-6">
                ...
                <CardContent>
                  {todaysSessions.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <Calendar className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
                      <p className="text-black dark:text-white dark:text-white">{l.noSessionsToday}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  {pendingRequests.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <Clock className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
                      <p className="text-black dark:text-white dark:text-white">{l.noPendingRequests}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              ...
              {/* Stripe Connect Card */}
              {coachProfile && (
                <Card className={stripeStatus?.isOnboarded ? "border-emerald-200 bg-emerald-50/50" : "border-orange-100 bg-amber-50/50"}>
                  ...
                  <CardContent>
                    {stripeLoading ? (
                      <div className="flex items-center justify-center py-4">
                        <Loader2 className="h-6 w-6 animate-spin text-black dark:text-white dark:text-white" />
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-black dark:text-white dark:text-white">{l.stripeComplete}</p>
                        <Button
                          variant="outline"
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-black dark:text-white dark:text-white">{l.stripePending}</p>
                        <Button
                          className="w-full gap-2"
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-black dark:text-white dark:text-white">{l.stripeOnboarding}</p>
                        <Button
                          className="w-full gap-2"
                          onClick={handleConnectStripe}
                          disabled={isConnectingStripe}
