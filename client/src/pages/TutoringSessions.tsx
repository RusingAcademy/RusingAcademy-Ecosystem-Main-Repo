...
const bookingTypes = [
  {
    ...
    badge: "FREE",
    badgeColor: "var(--semantic-success, var(--success))",
  },
  {
    id: "diagnostic",
  ...
  },
  {
    ...
    calendlyUrl: "https://calendly.com/rusingacademy",
    badge: "POPULAR",
    badgeColor: "var(--semantic-warning, var(--warning))",
  },
  {
    id: "intensive",
    ...
    calendlyUrl: "https://calendly.com/rusingacademy",
    badge: "INTENSIVE",
    badgeColor: "var(--semantic-danger, var(--danger))",
  },
];
        ...
        {activeTab === "book" && (
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-xl p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                How It Works
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={s.step} className="text-center">
                    ...
                    <h4 className="font-semibold text-gray-900 dark:text-foreground text-sm mb-1">{s.title}</h4>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-[rgba(0,128,144,0.06)]">
                    <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">
                      <div className="flex items-center gap-1">
                        Date
                        <span className="material-icons text-sm text-gray-400">unfold_more</span>
                      </div>
                    </th>
                    <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Time</th>
                    <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Duration</th>
                    <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Coach</th>
                    <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Type</th>
