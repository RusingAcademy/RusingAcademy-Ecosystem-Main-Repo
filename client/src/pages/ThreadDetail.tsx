      ...
      <div className="max-w-[900px] mx-auto px-6 py-8">
        ...
        {thread.content && (
          <motion.div
            ...
            className="p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/10 mb-8"
          >
            ...
            <AnimatePresence>
              {posts.map((post, index) => (
                <motion.div
                  ...
                  className="p-5 rounded-xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/10 hover:border-white/20 transition-all"
                >
                          ...
                          <div className="absolute right-0 top-8 z-10 bg-[#1A2A44] border border-white/10 rounded-lg shadow-xl py-1 min-w-[140px]">
                            {post.authorId === user.id && (
                              <button
                                ...
                                className="w-full px-4 py-2 text-left text-sm text-white/80 hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 flex items-center gap-2"
                              >
                            ...
                            <button
                              ...
                              className="w-full px-4 py-2 text-left text-sm text-red-400 hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 flex items-center gap-2"
                            >
                  ...
                  {editingPostId === post.id ? (
                    <div className="space-y-3">
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/20 focus:border-teal-400 focus:outline-none text-white resize-none"
                        rows={4}
                      />
        ...
        {!thread.isLocked ? (
          user ? (
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              className="p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/10"
            >
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/10 text-center">
          ...
          <div className="p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-red-400/20 text-center">
