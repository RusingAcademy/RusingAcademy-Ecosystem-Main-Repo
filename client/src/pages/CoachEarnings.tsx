              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-black dark:text-white dark:text-white">{l.netEarnings}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-black dark:text-white dark:text-white">{l.pendingPayout}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-full bg-foundation-soft flex items-center justify-center">
                    <Receipt className="h-5 w-5 text-foundation" />
                  </div>
                  <div>
                    <p className="text-2xl font-bold">{earnings.sessionCount}</p>
                    <p className="text-xs text-black dark:text-white dark:text-white">{l.sessionsCompleted}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-black dark:text-white dark:text-white">{l.commissionRate}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-black dark:text-white dark:text-white">
                    ...
                    <div className="bg-muted/50 rounded-lg p-4 mt-4">
                      <div className="flex items-start gap-2">
                        <Info className="h-4 w-4 text-black dark:text-white dark:text-white mt-0.5" />
                        <div className="text-sm text-black dark:text-white dark:text-white">
                          {language === "fr" ? (
                            <>
                              <p className="mb-2">
                ...
                <CardContent>
                  {ledgerData && ledgerData.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                      <Receipt className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
                      <p className="text-black dark:text-white dark:text-white">{l.noTransactions}</p>
                    </div>
                  )}
                </CardContent>
              </Card>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm text-black dark:text-white dark:text-white">{l.referralDescription}</p>
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-2">
                        <div className="text-center p-3 bg-muted/50 rounded-lg">
                          ...
                          <p className="text-xs text-black dark:text-white dark:text-white">{l.referralClicks}</p>
                        </div>
                        <div className="text-center p-3 bg-muted/50 rounded-lg">
                          <p className="text-2xl font-bold">{referralLink.bookingCount || 0}</p>
                          <p className="text-xs text-black dark:text-white dark:text-white">{l.referralConversions}</p>
                        </div>
                      </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-black dark:text-white dark:text-white">{l.totalEarnings}</span>
                    <span className="font-medium">{formatCurrency(earnings.totalGross)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-black dark:text-white dark:text-white">{l.platformFees}</span>
