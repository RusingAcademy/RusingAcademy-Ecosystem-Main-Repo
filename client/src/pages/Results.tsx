      ...
      <div className="max-w-[1200px]">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-[rgba(0,128,144,0.08)]">
                  ...
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Quiz</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Score</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Passing Grade</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Status</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Date</th>
                </tr>
              </thead>
              <tbody>
        ...
        {activeTab === 1 && (
          <div className="glass-card rounded-xl p-6">
            <h3 className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-4">Final Quiz Results per Module</h3>
            <div className="h-[350px]">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
                  ...
                  <Bar dataKey="score" fill="var(--brand-teal, var(--teal))" radius={[2, 2, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </div>
        ...
        {activeTab === 2 && (
          <div className="glass-card rounded-xl overflow-hidden">
            <table className="w-full">
              <thead>
                <tr className="bg-[rgba(0,128,144,0.08)]">
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Skill</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Level</th>
                  <th className="text-left text-xs font-medium text-gray-700 dark:text-muted-foreground px-4 py-3">Date</th>
                </tr>
              </thead>
              <tbody>
