...
const uiStrings = {
  en: {
    ...
    featuredBadge: 'GC Bilingual Path Series',
    featuredTitle: 'Our Curriculum Courses',
    featuredSubtitle: 'Explore our complete FSL and ESL Path Series — 12 structured courses designed for Canadian public servants. Each Path includes 4 modules, 16 lessons, quizzes, and a certificate of completion.',
  ...
  fr: {
    ...
    // Featured Courses from DB
    featuredBadge: 'Série de parcours bilingues GC',
    featuredTitle: 'Nos cours du curriculum',
    featuredSubtitle: 'Explorez nos séries complètes de parcours FLS et ALS — 12 cours structurés conçus pour les fonctionnaires canadiens. Chaque parcours comprend 4 modules, 16 leçons, des quiz et un certificat.',
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="container">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 lg:gap-12">
              {federalOrgs.map((org, index) => (
                <div key={index} className="flex items-center gap-2 text-cyan-300 hover:text-black dark:text-foreground transition-colors">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="flex items-center gap-1 text-sm text-black dark:text-foreground">
                      ...
                      {/* Title & Tagline */}
                      <h3 className="text-xl font-bold text-black dark:text-foreground mb-2">{course.name}</h3>
                      ...
                      <div className="space-y-2 mb-4 p-3 rounded-xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md">
                        ...
                        <div className="flex items-start gap-2 text-sm">
                          ...
                          <span className="text-black dark:text-foreground"><strong>{ui.outcomeLabel}</strong> {course.outcome}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div>
                          {FREE_ACCESS_MODE ? (
                            ...
                            <>
                              <p className="text-2xl font-bold text-black dark:text-foreground">{course.priceDisplay}</p>
                              <p className="text-xs text-black dark:text-foreground">{ui.cadLifetime}</p>
                            </>
                          )}
                        </div>
                        <button
        ...
        {/* FEATURED COURSES FROM DATABASE — Removed: redundant with the course grid above */}
