  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <section className="py-4 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-700 sticky top-0 z-50">
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-10">
                <a
                  href="#courses"
                  className="inline-flex items-center gap-2 px-8 py-4 rounded-full font-semibold bg-white dark:bg-slate-900 text-foundation hover:bg-gray-100 dark:bg-slate-800 transition-all hover:scale-105 shadow-xl"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {valueProps.map((prop, index) => (
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-700 hover:border-teal-200 hover:shadow-lg transition-all group"
                >
        ...
        {/* Filter Section */}
        <section id="courses" className="py-8 border-b border-gray-100 dark:border-slate-700 bg-white dark:bg-slate-900 sticky top-0 z-40 shadow-sm">
          <div className="container">
              ...
              >
                {filteredCourses.map((course, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: index * 0.1 }}
                    className="group relative bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 overflow-hidden hover:shadow-2xl transition-all duration-300"
                  >
                    {/* Popular Badge */}
                    {course.popular && (
