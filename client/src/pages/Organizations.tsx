      ...
      <main className="pt-20 pb-20">
        ...
        <section className="px-6 md:px-8 lg:px-12 lg:px-8 py-16 sm:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-black dark:text-foreground mb-6">
              {language === "fr"
                ? "Lingueefy pour les Organisations"
                : "Lingueefy for Organizations"}
            </h1>

            <p className="text-xl text-black dark:text-foreground/90 mb-8 max-w-2xl mx-auto">
              {language === "fr"
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-black dark:text-foreground/90 text-sm">{desc}</p>
                  </div>
                );
              })}
            </div>
              ...
              {features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-black dark:text-foreground font-medium">{title}</span>
                  </div>
                );
              })}
            </div>
        ...
        <section className="px-6 md:px-8 lg:px-12 lg:px-8 py-8 md:py-12 lg:py-16">
          <div className="max-w-2xl mx-auto">
            <div className="p-8 rounded-xl bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border border-teal-200/50 dark:border-white/15 backdrop-blur-sm">
              ...
              <p className="text-black dark:text-foreground/90 text-center mb-6">
                {language === "fr"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="px-6 py-3 rounded-lg bg-white/50 dark:bg-white/10 hover:bg-white/70 dark:hover:bg-white/20 text-black dark:text-foreground font-semibold border border-slate-200 dark:border-white/60 transition-colors duration-300 text-center"
                >
