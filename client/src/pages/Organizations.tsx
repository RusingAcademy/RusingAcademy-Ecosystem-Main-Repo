      ...
      <main className="pt-20 pb-20">
        ...
        <section className="px-6 md:px-8 lg:px-12 lg:px-8 py-8 md:py-12 lg:py-16">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white mb-6 md:mb-8 lg:mb-12 text-center">
              ...
              {benefits.map((benefit, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-black dark:text-white/90 text-sm">{desc}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="px-6 md:px-8 lg:px-12 lg:px-8 py-8 md:py-12 lg:py-16">
          <div className="max-w-2xl mx-auto">
            <div className="p-8 rounded-xl bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border border-teal-200/50 dark:border-teal-800/50 backdrop-blur-sm">
              ...
              <p className="text-black dark:text-white/90 text-center mb-6">
                {language === "fr"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  className="px-6 py-3 rounded-lg bg-white/50 dark:bg-white/10 hover:bg-white/70 dark:hover:bg-white/20 text-black dark:text-white font-semibold border border-slate-200 dark:border-white/60 transition-colors duration-300 text-center"
                >
