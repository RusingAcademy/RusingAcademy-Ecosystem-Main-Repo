          ...
          <div className="container max-w-2xl">
            ...
            >
              ...
              <motion.p
                ...
                className="text-xl text-black dark:text-foreground mb-6"
              >
                {l.subtitle}
              </motion.p>
              ...
              <motion.p
                ...
                className="text-lg text-black dark:text-foreground mb-8"
              >
                      ...
                      <Card>
                        <CardContent className="pt-6">
                          <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <p className="text-sm text-black dark:text-foreground">{step.desc}</p>
                          </div>
                        </CardContent>
                      </Card>
                    </motion.div>
