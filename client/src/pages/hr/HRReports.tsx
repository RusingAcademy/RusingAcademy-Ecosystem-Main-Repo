    ...
    <HRLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            { label: ui.avgProgress, value: "—", icon: "trending_up", color: "#2563eb" },
            { label: ui.completionRate, value: "—", icon: "check_circle", color: "#16a34a" },
            { label: ui.activeParticipants, value: "—", icon: "groups", color: "#7c3aed" },
