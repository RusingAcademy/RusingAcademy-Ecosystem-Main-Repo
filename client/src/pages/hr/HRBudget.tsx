      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div key={card.label} className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-700 p-5 hover:shadow-md transition-shadow">
        ...
        {stats.totalInvoiced > 0 && (
          <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-700 p-5 mb-6">
            <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-3">
              {lang === "fr" ? "Progression des paiements" : "Payment Progress"}
            </h2>
            <div className="h-6 bg-gray-100 dark:bg-slate-800 rounded-full overflow-hidden flex">
                ...
                <tbody>
                  {records.map((rec: any) => {
                    const statusStyles: Record<string, string> = {
                      ...
                      draft: "bg-gray-50 dark:bg-slate-900 text-gray-600 border-gray-200",
                    };
