    ...
    <HRLayout>
      <div className="max-w-7xl mx-auto">
        ...
        {stats.totalInvoiced > 0 && (
          <div className="bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-5 mb-6">
                ...
                <tbody>
                  {records.map((rec: any) => {
                    const statusStyles: Record<string, string> = {
                      ...
                      draft: "bg-gray-50 dark:bg-background text-gray-600 border-gray-200",
                    };
