  ...
  return (
    <HRLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Filter Tabs */}
        <div className="flex gap-2 bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 p-1 rounded-xl">
          {filters.map((f) => (
            <button
              key={f.key}
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg text-sm font-medium transition-all ${
                filter === f.key
                  ? "bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-blue-600 shadow-sm"
        ...
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl border border-gray-100 dark:border-white/15 p-12 text-center">
          <div className="w-16 h-16 rounded-full bg-blue-600/10 flex items-center justify-center mx-auto mb-4">
            <span className="material-icons text-lg md:text-2xl lg:text-3xl text-blue-600">notifications_none</span>
          </div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-2">{ui.noNotifications}</h3>
            ...
            {[
              ...
              <div key={i} className="flex items-center justify-between p-4 rounded-lg border border-gray-100 dark:border-white/15 hover:bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md transition-colors">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600" />
                </label>
              </div>
            ))}
          </div>
