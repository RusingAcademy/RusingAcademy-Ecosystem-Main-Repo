        ...
        <div className="bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-100">
              ...
              <select className="text-sm border border-gray-200 dark:border-border dark:border-border rounded-lg px-3 py-2 bg-white dark:bg-background focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600">
