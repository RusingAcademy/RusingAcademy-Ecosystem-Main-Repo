    ...
    <HRLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border border-gray-100">
              ...
              <select className="text-sm border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2 bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 p-6">
          ...
          <div className="mt-4 p-8 text-center border border-dashed border-gray-200 dark:border-slate-700 rounded-lg">
