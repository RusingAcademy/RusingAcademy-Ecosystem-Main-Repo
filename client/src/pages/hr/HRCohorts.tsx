...
function CohortCard({ cohort, lang }: { cohort: any; lang: string }) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 p-5 hover:shadow-md transition-shadow cursor-pointer group">
      ...
      <div className="mt-3 flex items-center justify-end">
        <span className="material-icons text-gray-300 group-hover:text-blue-600 text-lg transition-colors">arrow_forward</span>
      </div>
    </div>
  );
}
