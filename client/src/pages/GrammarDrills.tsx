        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          ...
          {showHistory ? (
            ...
            <div role="region" aria-label={selectedDrill.topic}>
              ...
              {/* Current Question */}
              <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-gray-100 shadow-sm mb-6">
                ...
                {selectedDrill.questions[currentQ].options ? (
                  ...
                  <div>
                    ...
                    <input id="reorder-input" type="text" value={reorderInput} onChange={e => setReorderInput(e.target.value)}
                      ...
                      className="w-full p-4 rounded-xl border border-gray-200 dark:border-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-teal-700/30"
                      autoFocus />
