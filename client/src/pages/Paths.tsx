...
<SEO title="Learning Paths" description="Structured learning paths for bilingual excellence with guided SLE preparation courses." canonical="/paths" />
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black dark:text-white dark:text-white mb-6">
            ...
            <p className="text-lg md:text-xl text-black dark:text-white dark:text-white mb-8 max-w-2xl mx-auto">
              {langTab === 'esl'
                ? (t
      ...
      <section className="py-4 bg-white dark:bg-slate-800 dark:bg-slate-900 border-b border-slate-100">
            ...
            <div className="inline-flex rounded-xl bg-slate-100 p-1 gap-1">
              <button
                ...
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 flex items-center gap-2 ${
                  langTab === 'fsl'
                    ? 'bg-white dark:bg-slate-800 text-indigo-700 shadow-md'
      ...
      {/* Filters Section */}
      <section className="py-8 border-b border-slate-200 bg-white dark:bg-slate-800 dark:bg-slate-900 sticky top-0 z-20">
        <div className="container px-4 sm:px-6 lg:px-8">
                  ...
                  <Link href={`/paths/${path.slug}`}>
                    <Card className="group h-full cursor-pointer hover:shadow-xl transition-all duration-300 overflow-hidden border-slate-200 hover:border-amber-300">
                      ...
                      {path.thumbnailUrl ? (
                        <div className="relative h-40 overflow-hidden">
                          ...
                          <div className="absolute top-3 left-3 flex items-center gap-2">
                            <Badge className="bg-white dark:bg-slate-800 dark:bg-slate-900/90 text-black dark:text-white dark:text-white border-0 text-xs font-semibold shadow-sm">
                      ...
                      <CardHeader className={`${!path.thumbnailUrl ? (path.bgColor || 'bg-amber-50') : ''} pb-4`}>
                        ...
                        <CardTitle className={`text-xl ${path.thumbnailUrl ? 'mt-1' : 'mt-3'} text-black dark:text-white group-hover:text-amber-700 transition-colors`}>
                      ...
                      <CardContent className="pt-4 space-y-4">
                        {/* Stats Row */}
                        <div className="flex items-center gap-4 text-sm text-black dark:text-white dark:text-white">
                          ...
                          <div>
                            {FREE_ACCESS_MODE ? (
                              ...
                              <>
                                ...
                                <span className="text-2xl font-bold text-black dark:text-white dark:text-white">
                                  {formatPrice(path.price)}
                                </span>
                              </>
                            )}
        ...
        <div className="container px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/sle-diagnostic">
              <Button size="lg" variant="secondary" className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-amber-700 hover:bg-amber-50">
