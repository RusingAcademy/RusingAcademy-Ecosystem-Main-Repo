...
<SEO title="Learning Paths" description="Structured learning paths for bilingual excellence with guided SLE preparation courses." canonical="/paths" />
      ...
      <section className="py-4 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border-b border-slate-100">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center">
            <div className="inline-flex rounded-xl bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm p-1 gap-1">
              <button
                ...
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all duration-300 flex items-center gap-2 ${
                  langTab === 'fsl'
                    ? 'bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-indigo-700 shadow-md'
      ...
      {/* Filters Section */}
      <section className="py-8 border-b border-slate-200 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md sticky top-0 z-20">
        <div className="container px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <Card key={i} className="animate-pulse">
                  <CardHeader className="h-32 bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm" />
                  <CardContent className="space-y-4 p-6">
                    <div className="h-6 bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm rounded w-3/4" />
                    <div className="h-4 bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm rounded w-full" />
                    <div className="h-4 bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm rounded w-2/3" />
                  </CardContent>
                </Card>
              ))}
            </div>
                      ...
                      {path.thumbnailUrl ? (
                        <div className="relative h-40 overflow-hidden">
                          ...
                          <div className="absolute top-3 left-3 flex items-center gap-2">
                            <Badge className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/90 text-black dark:text-foreground border-0 text-xs font-semibold shadow-sm">
