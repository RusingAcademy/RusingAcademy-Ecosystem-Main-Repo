      ...
      <main className="flex-1">
        ...
        {sessionState === "active" && (
          <div className="flex flex-col h-[calc(100vh-64px)]">
            {/* Session Header */}
            <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-b px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                      ...
                      <div
                        className={`rounded-2xl px-4 py-3 ${
                          msg.role === "user"
                            ...
                            : "bg-white dark:bg-slate-800 shadow-sm border rounded-bl-sm"
                        }`}
                      >
              ...
              {isSending && (
                <div className="flex justify-start">
                  <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-sm border rounded-2xl rounded-bl-sm px-4 py-3">
            ...
            {/* Input Area */}
            <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-t p-4">
