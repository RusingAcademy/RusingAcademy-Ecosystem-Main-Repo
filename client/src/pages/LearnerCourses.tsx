        ...
        <div className="px-4 sm:px-6 lg:px-8 xl:px-12 py-8 max-w-[1400px] mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-black dark:text-white flex items-center gap-3">
                  <BookOpen className="h-8 w-8 text-blue-600" />
                  {l.title}
                </h1>
                <p className="text-black dark:text-white dark:text-cyan-300 mt-1">{l.subtitle}</p>
              </div>
  ...
  return (
    <Link href={`/curriculum/${course.courseId || course.id}`}>
      <div className="group relative h-full p-5 rounded-xl bg-gradient-to-br from-slate-50 to-white dark:from-teal-900 dark:to-obsidian border border-slate-200/50 dark:border-teal-800/50 hover:shadow-lg transition-all duration-300 cursor-pointer">
        ...
        <p className="text-sm text-black dark:text-white dark:text-cyan-300 mb-4 line-clamp-2">
