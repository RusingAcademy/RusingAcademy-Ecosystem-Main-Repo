...
function TestimonialsCarousel({ testimonials }: { testimonials: Array<{
  ...
  return (
    <div className="relative">
                ...
                <div className="bg-gradient-to-br from-slate-50 to-teal-50/30 rounded-3xl p-8 md:p-12 shadow-xl relative">
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      <p className="text-xl md:text-2xl text-black dark:text-white dark:text-white leading-relaxed mb-6 italic">
                        "{testimonial.quote}"
                      </p>
      ...
      <button 
        onClick={goToPrev}
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:translate-x-0 h-12 w-12 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-lg flex items-center justify-center text-teal-600 hover:bg-teal-50 transition-colors z-10"
      ...
      <button 
        onClick={goToNext}
        className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-0 h-12 w-12 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-lg flex items-center justify-center text-teal-600 hover:bg-teal-50 transition-colors z-10"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div 
              key={index}
              className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-100 overflow-hidden transition-all duration-300 hover:shadow-md"
            >
              <button
      ...
      <main id="main-content" className="flex-1">
        ...
        <section className="py-10 bg-gradient-to-r from-teal-600 to-teal-700 relative overflow-hidden">
          ...
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-40 h-40 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-full -translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 right-0 w-60 h-60 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-full translate-x-1/3 translate-y-1/3" />
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {statistics.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/20 mb-2">
        ...
        >
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
              {/* Marketplace Option */}
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-3xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-shadow">
            ...
            <div id="pricing-plans" className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* Starter Plan */}
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-3xl p-8 shadow-lg border border-slate-100 hover:shadow-xl transition-all hover:-translate-y-1">
              ...
              <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-3xl p-8 shadow-2xl text-white relative transform md:-translate-y-4">
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-400 text-black dark:text-white dark:text-white text-xs font-bold px-4 py-1 rounded-full">
                  {t("plans.mostPopular")}
                </div>
                <div className="text-center mb-8">
                ...
                <Button 
                  className="w-full bg-white dark:bg-slate-800 dark:bg-slate-900 text-teal-600 hover:bg-teal-50 rounded-full font-semibold"
            ...
            <div className="mt-16 text-center">
              <div className="inline-flex flex-wrap justify-center gap-6 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl px-8 py-4 shadow-lg">
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={index} className="flex items-center gap-4 pb-5 border-b border-cta/50 last:border-0 last:pb-0">
                      ...
                      <span className="text-black dark:text-white dark:text-white font-medium">{item.text}</span>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  <div className="flex items-center gap-4 mb-6 relative z-10">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-2xl text-black dark:text-white dark:text-white">{item.title}</h3>
                      </div>
                      <Badge className="glass-badge text-xs mt-2 bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-slate-200">{t("sle.skills")}</Badge>
                    </div>
                  </div>
                  
                  {/* Description with better typography */}
                  <p className="text-black dark:text-white dark:text-white leading-relaxed text-base relative z-10">{item.description}</p>
        ...
        {/* How It Works */}
        <section 
          className="py-24 relative overflow-hidden bg-white dark:bg-slate-800 dark:bg-slate-900"
        ...
        <section className="py-24 bg-white dark:bg-slate-800 dark:bg-slate-900 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                {[
                  ...
                  <div key={index} className="flex items-center gap-4 p-4 bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl">
      ...
      {youtubeModalOpen && (
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-5xl animate-in zoom-in-95 fade-in duration-300">
            ...
            <button
              onClick={() => setYoutubeModalOpen(false)}
              className="absolute -top-12 right-0 md:-right-12 md:top-0 z-20 w-10 h-10 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm border border-white/60 flex items-center justify-center text-white hover:bg-white dark:bg-slate-800 dark:bg-slate-900/20 transition-all duration-200 group"
              aria-label="Close video"
            >
            ...
            <p className="text-center text-white/90 text-xs mt-4">
              Press <kbd className="px-1.5 py-0.5 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded text-white/90">ESC</kbd> to close
            </p>
          </div>
        </div>
      )}
