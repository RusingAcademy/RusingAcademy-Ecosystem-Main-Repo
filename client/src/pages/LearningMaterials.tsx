        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <Link href={`/programs/${programId}/${path.id}`}>
              <span className="text-sm font-medium text-gray-900 dark:text-foreground hover:text-teal-700 transition-colors cursor-pointer">
                {path.title}
              </span>
            </Link>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr style={{ background: "linear-gradient(135deg, rgba(0,128,144,0.08), rgba(245,166,35,0.04))" }}>
                        <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Path</th>
                        <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Progress</th>
                        <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Status</th>
                        <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Modules</th>
                        <th className="text-center text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Go</th>
                      </tr>
                    </thead>
                    <tbody>
        ...
        {activeTab === 1 && (
          <div className="glass-card rounded-xl overflow-hidden">
            <table className="w-full">
              <thead>
                <tr style={{ background: "linear-gradient(135deg, rgba(0,128,144,0.08), rgba(245,166,35,0.04))" }}>
                  <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Assessment</th>
                  <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Type</th>
                  <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Status</th>
                  <th className="text-left text-[11px] font-semibold text-gray-900 dark:text-foreground px-4 py-3 uppercase tracking-wider">Score</th>
                </tr>
              </thead>
              <tbody>
                {[
