  ...
  return (
    <DashboardLayout>
      <div className="max-w-[900px]">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-b-md border border-gray-200 dark:border-slate-700 border-t-0 p-6">
          <div className="space-y-5 max-w-md">
            ...
            <div>
              ...
              <select className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-800 bg-white dark:bg-slate-900">
