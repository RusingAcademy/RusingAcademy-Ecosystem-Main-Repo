      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-white dark:bg-background rounded-2xl p-4 border border-gray-100 dark:border-border shadow-sm text-center">
          ...
          {/* Tabs */}
          <div className="flex gap-1 mb-6 bg-white dark:bg-background rounded-xl p-1 border border-gray-100 dark:border-border shadow-sm w-fit">
          ...
          {activeTab === "guide" && (
            <div className="bg-white dark:bg-background rounded-2xl p-8 border border-gray-100 dark:border-border shadow-sm">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-xl bg-gray-50 dark:bg-background border border-gray-100">
            ...
            <div>
              {activeReview ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white dark:bg-background rounded-2xl p-6 border border-gray-100 dark:border-border shadow-sm">
                    <h3 className="font-semibold text-gray-900 dark:text-foreground mb-2">Submission to Review</h3>
                    <div className="p-4 bg-gray-50 dark:bg-background rounded-xl text-sm text-gray-700 dark:text-muted-foreground leading-relaxed font-serif whitespace-pre-wrap">
                  ...
                  <div className="bg-white dark:bg-background rounded-2xl p-6 border border-gray-100 dark:border-border shadow-sm">
                    ...
                    <div className="space-y-5">
                      ...
                      <div className="pt-2 border-t border-gray-100 dark:border-border flex items-center justify-between">
                  ...
                  <div className="bg-white dark:bg-background rounded-2xl p-6 border border-gray-100 dark:border-border shadow-sm space-y-4">
                    <div>
                ...
                <div className="space-y-3">
                  {loadingPending ? (
                    ...
                    <div key={review.id} className="bg-white dark:bg-background rounded-xl p-5 border border-gray-100 dark:border-border shadow-sm hover:shadow-md transition-shadow cursor-pointer"
          ...
          {activeTab === "completed" && (
            <div className="space-y-3">
              {!completedReviews?.length ? (
                ...
                <div key={review.id} className="bg-white dark:bg-background rounded-xl p-5 border border-gray-100 dark:border-border shadow-sm">
