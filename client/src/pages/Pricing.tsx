...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-800 dark:bg-slate-900">
        ...
        <section className="relative py-20 lg:py-28 overflow-hidden bg-gradient-to-br from-obsidian via-teal-900 to-obsidian">
          ...
          <div className="container relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              {/* Glass badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-md border border-white/60 mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto mb-10">
                {[
                  ...
                  <div 
                    key={i}
                    className="bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-md border border-white/60 rounded-2xl p-4 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 transition-all duration-300"
                  >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/coaches">
                  <Button size="lg" variant="outline" className="border-white/60 text-white hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 px-8">
                    {l.findCoach}
          ...
          <div className="container">
            ...
            <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-700 delay-200 ${
              ...
              {l.valueProps.map((prop, i) => {
                ...
                return (
                  <div                    key={i}
                    className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg hover:border-teal-200 transition-all duration-300 group"
                  ...
                  >
                    ...
                    <p className="text-sm text-black dark:text-white dark:text-white">{prop.description}</p>
                  </div>
                );
              })}
            </div>
        ...
        >
          <div className="container">
            ...
            <div className={`grid md:grid-cols-2 gap-8 max-w-4xl mx-auto transition-all duration-700 ${
              ...
              {/* Coach Sessions Card */}
              <div className="relative bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-3xl p-8 border-2 border-gray-200 dark:border-slate-700 dark:border-slate-700 hover:border-orange-300 transition-all duration-300 hover:shadow-xl group overflow-hidden">
                {/* Glow effect */}
          ...
          <div className="container">
            ...
            <div className={`grid md:grid-cols-3 gap-6 transition-all duration-700 delay-200 ${
              ...
              {l.testimonials.map((testimonial, i) => (
                <div 
                  key={i}
                  className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-all duration-300"
                  style={{ transitionDelay: `${i * 100}ms` }}
                >
                  {/* Stars */}
        ...
        >
          ...
          <div className="container relative z-10">
            ...
            <div className={`max-w-4xl mx-auto transition-all duration-700 delay-200 ${
              ...
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden">
                <div className="p-8 md:p-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    {/* Standard Coaches */}
                    <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100/50 border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 hover:shadow-md transition-all duration-300">
                      <div className="flex items-center gap-3 mb-4">
                        <div className="h-12 w-12 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-9000 flex items-center justify-center shadow-lg shadow-gray-500/25">
          ...
          <div className="container">
            ...
            <div className={`max-w-3xl mx-auto space-y-4 transition-all duration-700 ${
              ...
              {l.faq.map((item, i) => (
                <div 
                  key={i} 
                  className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden hover:border-teal-300 transition-all duration-300 cursor-pointer"
                  style={{ transitionDelay: `${i * 100}ms` }}
