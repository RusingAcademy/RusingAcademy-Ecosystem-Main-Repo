          ...
          <div className="container">
            ...
            <div className={`grid md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-700 delay-200 ${
              ...
              {l.valueProps.map((prop, i) => {
                ...
                return (
                  <div                    key={i}
                    className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg hover:border-teal-200 transition-all duration-300 group"
        ...
        >
          <div className="container">
            ...
            <div className={`grid md:grid-cols-2 gap-8 max-w-4xl mx-auto transition-all duration-700 ${
              ...
              {/* Coach Sessions Card */}
              <div className="relative bg-white dark:bg-slate-900 rounded-3xl p-8 border-2 border-gray-200 dark:border-slate-700 dark:border-slate-700 hover:border-orange-300 transition-all duration-300 hover:shadow-xl group overflow-hidden">
                {/* Glow effect */}
          ...
          <div className="container">
            ...
            <div className={`grid md:grid-cols-3 gap-6 transition-all duration-700 delay-200 ${
              ...
              {l.testimonials.map((testimonial, i) => (
                <div 
                  key={i}
                  className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-slate-700 hover:shadow-lg transition-all duration-300"
                  style={{ transitionDelay: `${i * 100}ms` }}
                >
                  {/* Stars */}
        ...
        >
          ...
          <div className="container relative z-10">
            ...
            <div className={`max-w-4xl mx-auto transition-all duration-700 delay-200 ${
              ...
              <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden">
          ...
          <div className="container">
            ...
            <div className={`max-w-3xl mx-auto space-y-4 transition-all duration-700 ${
              ...
              {l.faq.map((item, i) => (
                <div 
                  key={i} 
                  className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden hover:border-teal-300 transition-all duration-300 cursor-pointer"
                  style={{ transitionDelay: `${i * 100}ms` }}
