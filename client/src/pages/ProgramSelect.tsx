  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        {/* Hero Section — Light */}
        <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-xl p-8 md:p-10 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-white dark:bg-slate-800 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-4 rounded-xl text-center shadow-sm">
              <span className="material-icons" style={{ color: stat.color, fontSize: "22px" }}>{stat.icon}</span>
              <div className="text-sm font-bold text-gray-900 dark:text-gray-100 mt-1">{stat.value}</div>
          ...
          {programs.map((prog) => {
            ...
            return (
              <Link key={prog.id} href={`/programs/${prog.id}`}>
                <div className="group bg-white dark:bg-slate-800 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-lg cursor-pointer">
                  ...
                  <div className="relative h-40 overflow-hidden" style={{
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/20 text-white backdrop-blur-sm">
        ...
        {/* Info Banner */}
        <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 dark:border-slate-700 rounded-2xl p-6 flex items-start gap-4 shadow-sm">
