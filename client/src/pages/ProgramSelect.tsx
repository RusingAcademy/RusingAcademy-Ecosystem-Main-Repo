  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        {/* Hero Section — Light */}
        <div className="bg-white dark:bg-background border border-gray-200 dark:border-border dark:border-border rounded-xl p-8 md:p-10 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-white dark:bg-background border border-gray-200 dark:border-border dark:border-border p-4 rounded-xl text-center shadow-sm">
          ...
          {programs.map((prog) => {
            ...
            return (
              <Link key={prog.id} href={`/programs/${prog.id}`}>
                <div className="group bg-white dark:bg-background border border-gray-200 dark:border-border dark:border-border rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-lg cursor-pointer">
        ...
        {/* Info Banner */}
        <div className="bg-white dark:bg-background border border-gray-200 dark:border-border dark:border-border rounded-2xl p-6 flex items-start gap-4 shadow-sm">
