      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-gray-200 dark:border-white/15 dark:border-white/15 p-4 rounded-xl text-center shadow-sm">
              <span className="material-icons" style={{ color: stat.color, fontSize: "22px" }}>{stat.icon}</span>
              <div className="text-sm font-bold text-gray-900 dark:text-foreground mt-1">{stat.value}</div>
          ...
          {programs.map((prog) => {
            ...
            return (
              <Link key={prog.id} href={`/programs/${prog.id}`}>
                <div className="group bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-gray-200 dark:border-white/15 dark:border-white/15 rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-lg cursor-pointer">
                  ...
                  <div className="relative h-40 overflow-hidden" style={{
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-white/20 dark:bg-white/[0.08] dark:backdrop-blur-md/20 text-white backdrop-blur-sm">
                  ...
                  <div className="p-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2 mb-4">
                      {[
                        ...
                        <div key={s.label} className="text-center p-2 rounded-lg bg-gray-50 dark:bg-white/[0.06] dark:backdrop-blur-sm">
        ...
        {/* Info Banner */}
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border border-gray-200 dark:border-white/15 dark:border-white/15 rounded-2xl p-6 flex items-start gap-4 shadow-sm">
