      ...
      <DashboardLayout>
        <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          {thread.isLoading ? (
            ...
            <>
              <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl p-6 shadow-sm mb-4">
              ...
              <div className="space-y-3 mb-4">
                {r.map((reply) => (
                  <div key={reply.id} className="bg-white dark:bg-slate-900 border border-gray-100 rounded-xl p-4 shadow-sm">
              ...
              {user && (
                <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl p-4 shadow-sm">
                  <textarea
                    ...
                    className="w-full border border-gray-200 dark:border-slate-700 rounded-lg p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-teal-700/30 min-h-[80px]"
                  />
          ...
          <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 w-full max-w-lg shadow-xl">
              ...
              <textarea
                ...
                className="w-full border border-gray-200 dark:border-slate-700 rounded-lg p-3 text-sm resize-none focus:outline-none focus:ring-2 focus:ring-teal-700/30 min-h-[120px]"
              />
            ...
            {(threads.data || []).map((t) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl p-4 shadow-sm hover:shadow-md hover:border-teal-700/30 transition-all"
                >
