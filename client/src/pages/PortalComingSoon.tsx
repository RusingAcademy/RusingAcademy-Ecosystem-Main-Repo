...
const portalConfigs: Record<string, PortalConfig> = {
  ...
  hr: {
    ...
    bgGradient: "linear-gradient(160deg, #eff6ff 0%, var(--semantic-info-light) 40%, #bfdbfe 100%)",
    features: [
    ...
    <div className="min-h-screen flex bg-white dark:bg-slate-900">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h2
            className="text-xl md:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-4"
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-8">
            {config.features.map((f) => (
              <span
                key={f.en}
                className="text-xs px-3 py-1.5 rounded-full text-gray-700 dark:text-gray-300 font-medium bg-white dark:bg-slate-900/80 border border-gray-200 dark:border-slate-700 dark:border-slate-700 shadow-sm"
              >
                {lang === "fr" ? f.fr : f.en}
              </span>
            ))}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-slate-900">
        <div className="w-full max-w-md text-center">
          ...
          <h1
            className="text-lg md:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3"
            style={{ fontFamily: "'Playfair Display', serif" }}
          >
