                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{isEn ? "Practice in French or English" : "Pratiquez en français ou en anglais"}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">{isEn ? "Practice anytime, anywhere" : "Pratiquez à tout moment, n'importe où"}</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
