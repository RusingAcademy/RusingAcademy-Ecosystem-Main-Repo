  ...
  const labels = {
    en: {
      ...
      hero: {
        ...
        description: 'Get personalized coaching from Prof Steven AI. Practice speaking, writing, and reading with real-time feedback.',
    ...
    fr: {
      ...
      hero: {
        ...
        description: 'Obtenez un coaching personnalisé du coach IA Prof Steven. Pratiquez la parole, l\'écriture et la lecture avec des commentaires en temps réel.',
