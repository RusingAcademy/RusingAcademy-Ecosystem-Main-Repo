          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              <div ref={successRate.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{language === "en" ? "Success Rate" : "Taux de réussite"}</div>
              </div>
              <div ref={coaches.ref} className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-cta-2 mb-1">{coaches.count}+</div>
                <div className="text-sm text-black dark:text-white dark:text-white">{language === "en" ? "Expert Coaches" : "Coachs experts"}</div>
              </div>
              <div ref={organizations.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{language === "en" ? "Organizations" : "Organisations"}</div>
              </div>
              <div ref={learners.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{language === "en" ? "Learners Trained" : "Apprenants formés"}</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto">
            ...
            <div className="mt-10 text-center">
              <div className="inline-flex items-center gap-4 px-6 py-3 rounded-full bg-gradient-to-r from-[#E07B39] to-[#2DD4BF] text-white">
                ...
                <span className="w-px h-6 bg-white dark:bg-slate-800 dark:bg-slate-900/30" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {FEATURES.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-bold text-black dark:text-white dark:text-white mb-2">
                ...
                >
                  {pkg.popular && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <span className="px-4 py-1 text-xs font-bold rounded-full bg-cta-2 text-white">
                        {language === "en" ? "POPULAR" : "POPULAIRE"}
                      </span>
                    </div>
                  )}
                  <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-2">
                  ...
                  <div className="mb-4">
                    ...
                    <span className="text-black dark:text-white dark:text-white">{language === "en" ? pkg.periodEn : pkg.periodFr}</span>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {TESTIMONIALS.map((testimonial, index) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="p-6 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm border border-white/60"
                >
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto text-center text-white">
              ...
              <Link href="/rusingacademy/contact">
                <Button 
                  size="lg" 
                  className="rounded-full px-8 h-14 text-lg font-semibold bg-white dark:bg-slate-800 dark:bg-slate-900 text-cta-2 hover:bg-orange-50"
                >
                  {language === "en" ? "Request a Proposal" : "Demander une proposition"}
