  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-stone-50">
      <main id="main-content">
          ...
          <div className="container mx-auto relative z-10">
            ...
            >
              <motion.div variants={fadeInUp}>
                <span className="inline-flex items-center gap-2 mb-6 px-5 py-2.5 rounded-full bg-teal-400/10 border border-teal-400/20 text-black dark:text-white dark:text-white">
              ...
              <motion.h1 
                variants={fadeInUp}
                className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-black dark:text-white dark:text-white"
              >
                {t.title}{" "}
              ...
              <motion.p 
                variants={fadeInUp}
                className="text-lg md:text-xl text-black dark:text-white dark:text-white mb-8 max-w-3xl mx-auto leading-relaxed"
              >
                {t.subtitle}
              </motion.p>
        ...
        {/* Stats Section */}
        <section className="py-8 border-y border-gray-200 dark:border-slate-700 dark:border-slate-700/50 bg-white dark:bg-slate-800 dark:bg-slate-900/50 backdrop-blur-sm">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
              <div ref={departments.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{t.stats[0].label}</div>
              </div>
              <div ref={passRate.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{t.stats[1].label}</div>
              </div>
              <div ref={servants.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{t.stats[2].label}</div>
              </div>
              <div ref={satisfaction.ref} className="text-center">
                ...
                <div className="text-sm text-black dark:text-white dark:text-white">{t.stats[3].label}</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-bold text-black dark:text-white dark:text-white">{t.complianceTitle}</h3>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {t.benefits.map((benefit, index) => (
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1"
                >
                  ...
                  <h3 className="font-bold text-black dark:text-white dark:text-white mb-2">{benefit.title}</h3>
                  <p className="text-sm text-black dark:text-white dark:text-white">{benefit.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-5xl mx-auto">
              {t.paths.map((path, index) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="relative p-4 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 shadow-lg text-center group hover:shadow-xl transition-all"
                >
                  <div 
                  ...
                  <h3 className="font-bold text-black dark:text-white dark:text-white mb-1">{path.path}</h3>
                  <p className="text-sm text-cta-2 font-medium mb-1">{path.level}</p>
                  <p className="text-xs text-black dark:text-white dark:text-white">{path.duration}</p>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {t.packages.map((pkg, index) => (
                ...
                >
                  ...
                  <div className="pt-2">
                    <h3 className="text-xl font-bold text-black dark:text-white dark:text-white">{pkg.name}</h3>
                    <p className="text-sm text-black dark:text-white dark:text-white mb-4">{pkg.size}</p>
                    <div className="mb-6">
                      <span className="text-3xl font-bold text-black dark:text-white dark:text-white">{pkg.price}</span>
                      <span className="text-black dark:text-white dark:text-white">{pkg.period}</span>
                    </div>
                    <ul className="space-y-3 mb-6">
                      {pkg.features.map((feature, i) => (
                        <li key={i} className="flex items-start gap-2 text-sm text-black dark:text-white dark:text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {t.testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ delay: index * 0.1 }}
                  className="p-6 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 shadow-lg"
                >
                  <Quote className="w-8 h-8 text-teal-400/30 mb-4" />
                  <p className="text-black dark:text-white dark:text-white mb-6 italic">"{testimonial.quote}"</p>
                  <div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                >
                  <span className="inline-flex items-center gap-2 mb-6 px-5 py-2.5 rounded-full bg-cta-2/10 border border-cta-2/20 text-black dark:text-white dark:text-white">
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                className="p-8 rounded-3xl bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 shadow-xl"
              >
                <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-2">{t.formTitle}</h3>
                <p className="text-black dark:text-white dark:text-white mb-6">{t.formSubtitle}</p>
                ...
                {formSubmitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-lg font-semibold text-black dark:text-white dark:text-white">{t.formSuccess}</p>
                  </div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Input 
                        ...
                        className="h-12 rounded-xl border-gray-200 dark:border-slate-700 dark:border-slate-700 focus:border-teal-400 focus:ring-teal-400"
                        required 
                      />
                      <Input 
                        type="email" 
                    ...
                    <Textarea 
                      ...
                      className="min-h-[120px] rounded-xl border-gray-200 dark:border-slate-700 dark:border-slate-700 focus:border-teal-400 focus:ring-teal-400"
                      rows={4}
                    />
                    <Button 
                      type="submit" 
