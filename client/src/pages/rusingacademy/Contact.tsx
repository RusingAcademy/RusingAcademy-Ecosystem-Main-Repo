        ...
        <main className="pt-24 pb-20 px-4">
          <div className="container mx-auto max-w-2xl">
            <motion.div
              ...
              className="text-center p-12 rounded-3xl bg-white dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700/50 shadow-xl"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <a href="mailto:b2b@rusingacademy.com" className="text-white/90 hover:text-white">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <a href="tel:+16135551234" className="text-white/90 hover:text-white">
                            +1 (613) 555-1234
                          </a>
                        </div>
                      </div>
                  ...
                  <div className="p-6 rounded-2xl bg-white dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700/50">
              ...
              <div className="lg:col-span-2">
                <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-white dark:bg-slate-900/80 backdrop-blur-sm border border-gray-200 dark:border-slate-700/50 shadow-xl">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-700 focus:border-cta-2 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all"
                    ...
                    <div className="md:col-span-2">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-slate-700 focus:border-cta-2 focus:ring-2 focus:ring-orange-500/20 outline-none transition-all resize-none"
                  ...
                  <div className="mt-8">
                    <Button 
                      type="submit"
                      size="lg"
                      className="w-full bg-cta-2 hover:bg-cta text-white rounded-full h-14 text-lg font-semibold"
                    >
