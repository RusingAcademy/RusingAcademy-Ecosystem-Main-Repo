      ...
      <main id="main-content">
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto text-center">
            <h2 className="text-xl font-semibold text-black dark:text-white dark:text-white mb-6">{t.industriesTitle}</h2>
            <div className="flex flex-wrap justify-center gap-3 max-w-4xl mx-auto">
              {t.industries.map((industry, i) => (
                <motion.span 
                  ...
                  className="px-4 py-2 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/80 border border-gray-200 dark:border-slate-700 dark:border-slate-700/50 text-black dark:text-white dark:text-white text-sm shadow-sm"
                >
                  {industry}
                </motion.span>
              ))}
