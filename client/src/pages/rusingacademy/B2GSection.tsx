    ...
    <section id="b2g" className="scroll-mt-20">
      ...
      <div className="py-16 bg-white dark:bg-slate-800 dark:bg-slate-900">
        <div className="container mx-auto px-6">
          <h3 className="text-3xl font-bold text-foundation text-center mb-12">{t.complianceTitle}</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {t.compliance.map((item, i) => (
              <Card key={i} className="border-gray-200 dark:border-slate-700 dark:border-slate-700 hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h4 className="text-lg font-semibold text-foundation mb-2">{item.title}</h4>
                  <p className="text-black dark:text-white dark:text-white text-sm">{item.desc}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      <div className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <h3 className="text-3xl font-bold text-foundation text-center mb-12">{t.sleTitle}</h3>
            ...
            {t.sleLevels.map((level, i) => (
              <Card key={i} className="border-gray-200 dark:border-slate-700 dark:border-slate-700">
                <CardContent className="p-6">
                  ...
                  <h4 className="text-xl font-bold text-foundation mb-4">{level.title}</h4>
      ...
      {/* Trusted Departments */}
      <div className="py-8 bg-white dark:bg-slate-800 dark:bg-slate-900">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm font-semibold text-black dark:text-white dark:text-white tracking-wider mb-6">{t.trustedBy}</p>
          <div className="flex flex-wrap justify-center gap-3">
            {t.departments.map((dept, i) => (
              <Badge key={i} variant="outline" className="px-4 py-2 text-black dark:text-white dark:text-white border-gray-300">{dept}</Badge>
            ))}
          </div>
        </div>
      </div>
            ...
            {t.testimonials.map((testimonial, i) => (
              <Card key={i} className="border-gray-200 dark:border-slate-700 dark:border-slate-700">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-cta">{testimonial.dept}</p>
                </CardContent>
              </Card>
            ))}
          </div>
