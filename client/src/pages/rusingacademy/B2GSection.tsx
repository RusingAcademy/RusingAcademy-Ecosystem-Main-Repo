  ...
  return (
    <section id="b2g" className="scroll-mt-20">
      ...
      <div className="py-8 bg-white">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm font-semibold text-gray-700 tracking-wider mb-6">{t.trustedBy}</p>
          <div className="flex flex-wrap justify-center gap-3">
            {t.departments.map((dept, i) => (
              <Badge key={i} variant="outline" className="px-4 py-2 text-gray-700 border-gray-300">{dept}</Badge>
            ))}
          </div>
        </div>
      </div>
