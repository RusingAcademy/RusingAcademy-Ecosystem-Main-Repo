            ...
            {t.compliance.map((item, i) => (
              <Card key={i} className="border-gray-200 dark:border-border dark:border-border hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-black dark:text-foreground text-sm">{item.desc}</p>
                </CardContent>
              </Card>
            ))}
          </div>
                ...
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2">
                    {level.features.map((f, j) => (
                      <li key={j} className="flex items-center gap-2 text-sm text-black dark:text-foreground">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {t.departments.map((dept, i) => (
              <Badge key={i} variant="outline" className="px-4 py-2 text-black dark:text-foreground border-gray-300">{dept}</Badge>
            ))}
          </div>
        </div>
      </div>
            ...
            {t.testimonials.map((testimonial, i) => (
              <Card key={i} className="border-gray-200 dark:border-border dark:border-border">
                <CardContent className="p-6">
                  ...
                  <p className="text-black dark:text-foreground italic mb-4">"{testimonial.quote}"</p>
