  ...
  return (
    <section id="b2g" className="scroll-mt-20">
      ...
      <div className="py-8 bg-white dark:bg-slate-900">
        <div className="container mx-auto px-6 text-center">
          <p className="text-sm font-semibold text-black dark:text-white tracking-wider mb-6">{t.trustedBy}</p>
          <div className="flex flex-wrap justify-center gap-3">
            {t.departments.map((dept, i) => (
              <Badge key={i} variant="outline" className="px-4 py-2 text-black dark:text-white border-gray-300">{dept}</Badge>
            ))}
          </div>
        </div>
      </div>
