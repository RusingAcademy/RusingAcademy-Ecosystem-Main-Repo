        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-black dark:text-foreground">Discover Your Path to</span>
              <br />
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-black dark:text-foreground mb-4">
              GC Bilingual Mastery Series
            </h2>
            
            <p className="text-lg md:text-xl text-black dark:text-foreground mb-8 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <div className="text-xs md:text-sm text-black dark:text-foreground">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card key={index} className="relative overflow-hidden border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-black dark:text-foreground text-center">{item.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
                ...
                {pathsFSL.map((path) => (
                  ...
                  >
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <CardDescription className="text-xs text-black dark:text-foreground">
                        {path.level.split(" | ")[0]}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="pb-2">
                      <p className="text-sm font-medium text-black dark:text-foreground mb-3">{path.tagline}</p>
                      
                      {selectedPath === path.id && (
                        <div className="mt-4 space-y-3 animate-in fade-in duration-300">
                          <p className="text-sm text-black dark:text-foreground">{path.description}</p>
                          <div className="space-y-1">
                            <p className="text-xs font-semibold text-black dark:text-foreground">Key Learning Outcomes:</p>
                            <ul className="space-y-1">
                              {path.outcomes.slice(0, 3).map((outcome, i) => (
                                <li key={i} className="flex items-start gap-2 text-xs text-black dark:text-foreground">
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-4 text-xs">
                        <div className="flex items-center gap-1 text-black dark:text-foreground">
                    ...
                    <CardFooter className="flex items-center justify-between pt-2 border-t">
                      <div>
                        <span className="text-2xl font-bold text-black dark:text-foreground">${path.price}</span>
                        <span className="text-sm text-black dark:text-foreground ml-1">CAD</span>
                      </div>
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 mb-4">
                    <p className="text-sm font-semibold text-black dark:text-foreground">Includes:</p>
                    {bundle.paths.map((path, i) => (
                      <div key={i} className="flex items-center gap-2 text-sm text-black dark:text-foreground">
                  ...
                  <div className="space-y-2 pt-4 border-t">
                    {bundle.features.map((feature, i) => (
                      <div key={i} className="flex items-start gap-2 text-sm text-black dark:text-foreground">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {targetProfiles.map((profile, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-sm text-black dark:text-foreground mb-4">{profile.description}</p>
                  <div className="space-y-1">
                    {profile.examples.map((example, i) => (
                      <div key={i} className="flex items-center gap-2 text-xs text-black dark:text-foreground">
