      ...
      sections: [
        {
          ...
          content: `By accessing or using Lingueefy ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Platform. Lingueefy is operated by Rusinga International Consulting Ltd.`,
        },
        {
          title: "2. Description of Service",
          content: `Lingueefy is an online marketplace connecting language learners with coaches specializing in Second Language Evaluation (SLE) preparation for Canadian federal public servants. The Platform also provides AI-powered practice tools ("Prof Steven AI").`,
        },
        {
        ...
        {
          title: "8. Prof Steven AI",
          content: `Prof Steven AI is provided as a supplementary practice tool. While we strive for accuracy, AI-generated content should not be considered official SLE exam preparation material. Results from AI placement tests are estimates and do not guarantee actual SLE exam results.`,
        },
        {
          title: "9. Intellectual Property",
          content: `All content on the Platform, including text, graphics, logos, and software, is the property of Rusinga International Consulting Ltd. or its licensors. You may not reproduce, distribute, or create derivative works without express permission.`,
        },
        {
      ...
      sections: [
        {
          ...
          content: `En accédant ou en utilisant Lingueefy (« la Plateforme »), vous acceptez d'être lié par ces Conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser la Plateforme. Lingueefy est exploité par Rusinga International Consulting Ltd.`,
        },
        {
          title: "2. Description du service",
          content: `Lingueefy est un marché en ligne reliant les apprenants de langues avec des coachs spécialisés dans la préparation à l'Évaluation de langue seconde (ELS) pour les fonctionnaires fédéraux canadiens. La Plateforme fournit également des outils de pratique alimentés par l'IA (« Prof Steven IA »).`,
        },
        {
        ...
        {
          title: "8. Prof Steven IA",
          content: `Prof Steven IA est fourni comme outil de pratique supplémentaire. Bien que nous nous efforcions d'être précis, le contenu généré par l'IA ne doit pas être considéré comme du matériel officiel de préparation à l'examen ELS. Les résultats des tests de classement IA sont des estimations et ne garantissent pas les résultats réels de l'examen ELS.`,
        },
        {
          title: "9. Propriété intellectuelle",
          content: `Tout le contenu de la Plateforme, y compris les textes, graphiques, logos et logiciels, est la propriété de Rusinga International Consulting Ltd. ou de ses concédants de licence. Vous ne pouvez pas reproduire, distribuer ou créer des œuvres dérivées sans autorisation expresse.`,
        },
        {
