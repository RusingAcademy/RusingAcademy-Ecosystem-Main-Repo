      ...
      <div
        className={cn(
          ...
          isRecording
            ...
            : "bg-slate-200 dark:bg-[#0a6969] text-slate-600 dark:text-white/90"
        )}
      >
      ...
      {items.map((item) => {
        ...
        return (
          <div key={item.key} className="flex flex-col items-center gap-1">
            ...
            <span className="text-[10px] text-slate-500 dark:text-[#67E8F9] text-center leading-tight">
              {item.label}
            </span>
          </div>
        );
              ...
              {(["B", "C"] as ExamLevel[]).map((level) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    <Target className={cn("h-5 w-5", config.level === level ? "text-blue-400" : "text-white/60")} />
              ...
              {examPhases.map((p) => {
                ...
                return (
                  <div key={p} className="p-4 rounded-xl bg-[#0a4040]/50 border border-[#0a6969]">
                    ...
                    <p className="text-[11px] text-white/70 leading-tight">{pl.desc}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="grid grid-cols-3 gap-4 mb-8">
            ...
            <div className="p-6 rounded-xl bg-[#0a4040]/50 border border-[#0a6969] text-center">
              ...
              <p className="text-sm text-white/60">{l.minutes}</p>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className={cn(
                ...
                msg.role === "user"
                  ...
                  : "bg-[#0a4040] border border-[#0a6969] text-slate-200"
              )}>
