    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          ...
          {/* Tabs */}
          <div className="flex gap-1 mb-8 bg-white dark:bg-slate-900 rounded-xl p-1 border border-gray-100 shadow-sm w-fit">
          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-gray-100 shadow-sm text-center col-span-1">
                ...
                <div className="col-span-2 bg-white dark:bg-slate-900 rounded-2xl p-6 border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-gray-100 shadow-sm text-center">
          ...
          {activeTab === "skills" && (
            <div className="space-y-6">
              ...
              {skills.map((skill, i) => (
                <div key={i} className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          {activeTab === "trends" && (
            <div className="space-y-6">
              ...
              {readingTrend && readingTrend.length > 1 ? (
                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 border border-gray-100 shadow-sm text-center text-gray-400">
