    ...
    <div className="flex h-screen bg-gray-50 dark:bg-white/[0.06] dark:backdrop-blur-sm">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          ...
          {/* Tabs */}
          <div className="flex gap-1 mb-8 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl p-1 border border-gray-100 dark:border-white/15 shadow-sm w-fit">
          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-8 border border-gray-100 dark:border-white/15 shadow-sm text-center col-span-1">
                ...
                <div className="col-span-2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-white/15 shadow-sm">
                  <h3 className="font-semibold text-gray-900 dark:text-foreground mb-4">Skill Breakdown</h3>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-5 border border-gray-100 dark:border-white/15 shadow-sm text-center">
              ...
              {badges.length > 0 && (
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-white/15 shadow-sm">
                  <h3 className="font-semibold text-gray-900 dark:text-foreground mb-4">Earned Badges</h3>
                  <div className="flex flex-wrap gap-3">
                    {badges.map((b: any, i: number) => (
                      <div key={i} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md border border-gray-100">
          ...
          {activeTab === "skills" && (
            <div className="space-y-6">
              ...
              {skills.map((skill, i) => (
                <div key={i} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-white/15 shadow-sm">
                        ...
                        {grammarTopicStats.map((ts: any, j: number) => (
                          <div key={j} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-bold text-gray-700 dark:text-muted-foreground w-10 text-right">{ts.avgScore}%</span>
                            </div>
                          </div>
                        ))}
                      </div>
          ...
          {activeTab === "trends" && (
            <div className="space-y-6">
              ...
              {readingTrend && readingTrend.length > 1 ? (
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-white/15 shadow-sm">
                  <h3 className="font-semibold text-gray-900 dark:text-foreground mb-4">Reading Score Trend</h3>
                ...
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-8 border border-gray-100 dark:border-white/15 shadow-sm text-center text-gray-400">
                  ...
                  {[
                    ...
                    return (
                      <div key={i} className="flex items-center gap-3">
                        <span className="text-sm font-medium text-gray-700 dark:text-muted-foreground w-20">{s.name}</span>
                        <div className="flex-1 h-6 bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 rounded-full overflow-hidden">
              ...
              {/* Recommendations */}
              <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-6 border border-gray-100 dark:border-white/15 shadow-sm">
                <h3 className="font-semibold text-gray-900 dark:text-foreground mb-4">Personalized Recommendations</h3>
                <div className="space-y-3">
