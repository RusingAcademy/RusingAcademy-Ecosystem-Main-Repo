    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          ...
          {/* Tabs */}
          <div className="flex gap-1 mb-8 bg-white dark:bg-background rounded-xl p-1 border border-gray-100 dark:border-border shadow-sm w-fit">
          ...
          {activeTab === "overview" && (
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="col-span-2 bg-white dark:bg-background rounded-2xl p-6 border border-gray-100 dark:border-border shadow-sm">
          ...
          {activeTab === "skills" && (
            <div className="space-y-6">
              ...
              {skills.map((skill, i) => (
                <div key={i} className="bg-white dark:bg-background rounded-2xl p-6 border border-gray-100 dark:border-border shadow-sm">
                  ...
                  {[
                    ...
                    return (
                      <div key={i} className="flex items-center gap-3">
                        ...
                        <div className="flex-1 h-6 bg-gray-100 dark:bg-card rounded-full overflow-hidden">
