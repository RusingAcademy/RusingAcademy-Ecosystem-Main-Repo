                ...
                <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-gray-100 dark:border-slate-700 shadow-sm">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {badges.map((b: any, i: number) => (
                      <div key={i} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 dark:bg-slate-900 border border-gray-100">
                        ...
                        {grammarTopicStats.map((ts: any, j: number) => (
                          <div key={j} className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm font-bold text-gray-700 dark:text-gray-300 w-10 text-right">{ts.avgScore}%</span>
                            </div>
                          </div>
                        ))}
                      </div>
                  ...
                  {[
                    ...
                    return (
                      <div key={i} className="flex items-center gap-3">
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300 w-20">{s.name}</span>
