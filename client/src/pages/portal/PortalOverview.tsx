    ...
    <PortalLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-teal-700 rounded-2xl p-6 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-1/2 w-32 h-32 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-full translate-y-1/2" />
          ...
          <div className="relative z-10">
            <div className="flex items-start justify-between">
              ...
              <div className="hidden md:flex items-center gap-3 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 backdrop-blur-sm rounded-xl p-4">
                <div className="text-center">
                  <p className="text-lg md:text-2xl lg:text-3xl font-bold">45%</p>
                  <p className="text-xs text-blue-200">Niveau B</p>
                </div>
                <div className="w-px h-12 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/20" />
                <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
              {quickStats.map((stat) => (
                <div key={stat.label} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 backdrop-blur-sm rounded-xl p-3 flex items-center gap-3">
            ...
            <Card className="border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-3">
                {upcomingSessions.map((session) => (
                  <div key={session.id} className={`p-4 rounded-xl border-2 transition-all ${session.isLive ? "border-emerald-200 bg-emerald-50" : "border-slate-200 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 hover:border-slate-300"}`}>
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-4 text-xs text-slate-500">
                          ...
                          <span className="px-2 py-0.5 bg-slate-100 dark:bg-white/[0.06] dark:backdrop-blur-sm rounded text-slate-600">{session.platform}</span>
                        </div>
                      </div>
                      {session.isLive ? (
