            ...
            <Card className="border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-3">
                {upcomingSessions.map((session) => (
                  <div key={session.id} className={`p-4 rounded-xl border-2 transition-all ${session.isLive ? "border-emerald-200 bg-emerald-50" : "border-slate-200 bg-white dark:bg-slate-800 hover:border-slate-300"}`}>
