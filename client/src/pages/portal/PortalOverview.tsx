    ...
    <PortalLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-teal-700 rounded-2xl p-6 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-background/5 rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-1/2 w-32 h-32 bg-white dark:bg-background/5 rounded-full translate-y-1/2" />
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
              {quickStats.map((stat) => (
                <div key={stat.label} className="bg-white dark:bg-background/10 backdrop-blur-sm rounded-xl p-3 flex items-center gap-3">
            ...
            <Card className="border-slate-200 shadow-sm">
              ...
              <CardContent className="space-y-3">
                {upcomingSessions.map((session) => (
                  <div key={session.id} className={`p-4 rounded-xl border-2 transition-all ${session.isLive ? "border-emerald-200 bg-emerald-50" : "border-slate-200 bg-white dark:bg-card hover:border-slate-300"}`}>
