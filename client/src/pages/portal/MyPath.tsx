                  ...
                  <CardContent className="pt-0">
                    <div className="border-t border-slate-200 pt-4 space-y-2">
                      {unit.modules.map((module) => {
                        ...
                        return (
                          <div key={module.id} className={cn("flex items-center gap-4 p-3 rounded-lg transition-all", isModuleActive && "bg-amber-50 border border-orange-100", isModuleCompleted && "bg-white", !isModuleLocked && !isModuleCompleted && !isModuleActive && "hover:bg-white dark:bg-card cursor-pointer", isModuleLocked && "opacity-50")}>
