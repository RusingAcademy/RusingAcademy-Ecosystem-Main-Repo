        ...
        >
          <div className="container">
            <div className={`relative overflow-hidden rounded-3xl transition-all duration-700 ${
              ...
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-background/10 rounded-full blur-3xl" />
              ...
              <div className="relative p-12 md:p-16 text-center text-white">
                ...
                <Link href="/coaches">
                  <Button size="lg" className="bg-white dark:bg-background text-teal-700 hover:bg-white dark:bg-background/90 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    {l.ctaButton}
