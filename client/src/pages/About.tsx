...
export default function About() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-teal-50/30 via-white to-teal-50/20">
      <SEO title="About Us" description="Learn about RusingÂcademy's mission to democratize bilingual training for Canadian public servants through expert coaching and innovative technology." canonical="/about" />
        ...
        >
          <div className="container">
            <div className={`relative overflow-hidden rounded-3xl transition-all duration-700 ${
              ...
              {/* Decorative elements */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-full blur-3xl" />
              ...
              <div className="relative p-12 md:p-16 text-center text-white">
                ...
                <Link href="/coaches">
                  <Button size="lg" className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md text-teal-700 hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/90 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                    {l.ctaButton}
