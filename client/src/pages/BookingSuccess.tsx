              ...
              {sessionData ? (
                <div className="space-y-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
                      <Calendar className="h-5 w-5 text-black dark:text-foreground" />
                      <div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
                      <Clock className="h-5 w-5 text-black dark:text-foreground" />
                      <div>
                    ...
                    <div className="flex items-center gap-3 p-3 bg-muted/50 rounded-lg">
                      <DollarSign className="h-5 w-5 text-black dark:text-foreground" />
                      <div>
              ...
              <ol className="space-y-4">
                {[l.step1, l.step2, l.step3, l.step4].map((step, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-black dark:text-foreground">{step}</span>
                  </li>
                ))}
              </ol>
            </CardContent>
