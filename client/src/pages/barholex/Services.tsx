            ...
            <div className="max-w-5xl mx-auto">
              ...
              >
                <Link href="/barholex/contact">
                  <Button 
                    size="lg" 
                    className="rounded-full px-8 h-14 text-lg font-semibold bg-gradient-to-r from-barholex-gold to-amber-600 text-black dark:text-foreground hover:from-[#B8962E] hover:to-barholex-gold shadow-lg shadow-amber-500/20"
                  >
              ...
              {SERVICES.map((service, index) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all ${
                    activeService === index
                      ? "text-black dark:text-foreground shadow-lg"
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-4">
                  ...
                  <Link href="/barholex/contact">
                    <Button 
                      className="w-full mt-6 rounded-xl h-12 font-semibold text-black dark:text-foreground"
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
                ...
                {PROCESS.map((step, index) => (
                  ...
                  >
                    {/* Step Number */}
                    <div className="relative z-10 w-24 h-24 rounded-full bg-gradient-to-br from-barholex-gold to-amber-600 text-black dark:text-foreground font-bold text-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-amber-500/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/barholex/portfolio">
                  <Button 
                    size="lg" 
                    variant="outline"
                    className="rounded-full px-8 h-14 text-lg font-semibold border-black/30 text-black dark:text-foreground hover:bg-black/10"
                  >
