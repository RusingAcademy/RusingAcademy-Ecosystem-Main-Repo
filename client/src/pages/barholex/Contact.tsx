                ...
                <div className="lg:col-span-1">
                  <div className="sticky top-24 space-y-6">
                    ...
                    <motion.div
                      ...
                      className="p-6 rounded-2xl bg-gradient-to-br from-barholex-gold to-amber-600 text-black dark:text-white dark:text-white"
                    >
                      ...
                      <div className="space-y-5">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <a href="mailto:hello@barholexmedia.com" className="text-black dark:text-white dark:text-white/80 hover:text-black dark:text-white dark:text-white transition-colors">
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <a href="tel:+16135551234" className="text-black dark:text-white dark:text-white/80 hover:text-black dark:text-white dark:text-white transition-colors">
                              +1 (613) 555-1234
                            </a>
                          </div>
                        </div>
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-black dark:text-white dark:text-white/80">
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ delay: 0.1 }}
                      className="p-6 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm border border-white/60"
                    >
                      ...
                      <div className="space-y-3">
                        {projectTypes.slice(0, 5).map((type) => (
                          <div key={type.value} className="flex items-center gap-3 text-sm text-white/90 hover:text-white transition-colors">
                            <type.icon className="w-4 h-4 text-barholex-gold" />
                    ...
                    >
                      {TRUST_SIGNALS.map((signal, index) => (
                        <div
                          key={index}
                          className="flex items-center gap-3 p-3 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/60"
                        >
                          <signal.icon className="w-5 h-5 text-barholex-gold" />
                  ...
                  <form onSubmit={handleSubmit} className="p-8 md:p-10 rounded-3xl bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/60">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/90 mb-2">
                          {language === "en" ? "Your Name" : "Votre nom"} <span className="text-barholex-gold">*</span>
                        </label>
                        <input
                          type="text"
                          name="name"
                          ...
                          className="w-full px-4 py-3.5 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/60 text-white placeholder-white/50 focus:border-barholex-gold focus:ring-2 focus:ring-amber-500/20 outline-none transition-all"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/90 mb-2">
                          {language === "en" ? "Email Address" : "Adresse courriel"} <span className="text-barholex-gold">*</span>
                        </label>
                        <input
                          type="email"
                          name="email"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/90 mb-2">
                          {language === "en" ? "Project Type" : "Type de projet"} <span className="text-barholex-gold">*</span>
                        </label>
                        <select
                          name="projectType"
                          required
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3.5 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/60 text-white focus:border-barholex-gold focus:ring-2 focus:ring-amber-500/20 outline-none transition-all"
                        >
                      ...
                      <div>
                        ...
                        >
                          ...
                          {budgets.map((budget) => (
                            <option key={budget.value} value={budget.value} className="bg-obsidian">
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-sm font-medium text-white/90 mb-2">
                          {language === "en" ? "Project Details" : "Détails du projet"} <span className="text-barholex-gold">*</span>
                        </label>
                        <textarea
                          name="message"
                          rows={5}
                          ...
                          onChange={handleChange}
                          className="w-full px-4 py-3.5 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/60 text-white placeholder-white/50 focus:border-barholex-gold focus:ring-2 focus:ring-amber-500/20 outline-none transition-all resize-none"
                    ...
                    <div className="mt-8">
                      <Button 
                        type="submit"
                        size="lg"
                        className="w-full bg-gradient-to-r from-barholex-gold to-amber-600 hover:from-[#B8962E] hover:to-barholex-gold text-black dark:text-white dark:text-white rounded-full h-14 text-lg font-semibold shadow-lg shadow-amber-500/20"
                      >
                        {language === "en" ? "Send Message" : "Envoyer le message"}
                        <Send className="ml-2 h-5 w-5" />
                      </Button>
                      
                      <p className="text-center text-sm text-black dark:text-white dark:text-white mt-4">
                        {language === "en" 
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className="p-6 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 border border-white/60"
                  >
