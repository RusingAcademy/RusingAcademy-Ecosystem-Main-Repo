  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#062b2b] via-gray-950 to-[#041e1e] text-white">
      ...
      <main id="main-content">
        ...
        <section className="py-8 px-4 sticky top-0 z-20 bg-[#062b2b]/80 backdrop-blur-xl border-b border-white/60">
              ...
              <div className="relative">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    exit={{ opacity: 0, x: -50 }}
                    className="p-8 md:p-12 rounded-3xl bg-gradient-to-br from-white/5 to-white/0 border border-white/60 backdrop-blur-sm"
                  >
                ...
                <div className="flex justify-center gap-4 mt-8">
                  <button
                    ...
                    className="w-12 h-12 rounded-full bg-white/5 border border-white/60 flex items-center justify-center hover:bg-white/10 transition-colors"
                  >
