  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#062b2b] via-gray-950 to-[#041e1e] text-white">
      <main id="main-content">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="flex flex-wrap justify-center gap-4">
                ...
                <Link href="/barholex/portfolio">
                  <Button size="lg" variant="outline" className="gap-2 px-8 h-12 text-base border-2 border-white/60 text-white hover:bg-white/10 rounded-full">
        ...
        {/* Stats Section */}
        <section className="py-8 border-y border-white/60 bg-white/5 backdrop-blur-sm">
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-[#062b2b] to-[#041e1e]">
          <div className="container mx-auto">
            ...
            <div className="text-center mt-10">
              <Link href="/barholex/portfolio">
                <Button variant="outline" className="border-white/60 text-white hover:bg-white/10 rounded-full px-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
              {CLIENTS.map((client, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  className="px-6 py-3 rounded-full bg-white/5 border border-white/60 text-white/90 text-sm"
                >
