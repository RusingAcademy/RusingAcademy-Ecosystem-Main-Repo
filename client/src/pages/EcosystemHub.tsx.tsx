            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-lg text-slate-700 leading-relaxed">
                  {language === "en" ? (
                    <>
                      <strong className="text-slate-900">RusingAcademy</strong> was created to break through these three walls, using a structured methodology that accelerates learning{" "}
                      <strong className="text-amber-600">3 to 4 times faster</strong> than traditional approaches.
                    </>
                  ) : (
                    <>
                      <strong className="text-slate-900">RusingAcademy</strong> a été créée pour briser ces trois murs, grâce à une méthodologie structurée qui accélère l'apprentissage{" "}
