...
function ChallengeCard({ challenge, isFr }: { challenge: {
  ...
  return (
    <div className={`bg-white border border-gray-200 rounded-xl p-5 transition-all duration-300 hover:shadow-md ${challenge.isCompleted ? "ring-1 ring-[var(--semantic-success, #10b981)]/30" : ""}`}
  ...
  return (
    <DashboardLayout>
      <div className="max-w-[900px] space-y-5" role="main" aria-label={t("challenges.title")}>
        {/* Header */}
        <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl p-6 md:p-8 shadow-sm">
        ...
        {challengesQuery.isLoading ? (
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl p-8 text-center shadow-sm" role="status">
