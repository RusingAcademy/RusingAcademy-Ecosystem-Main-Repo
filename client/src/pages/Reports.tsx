        ...
        {activeTab === "sle" && (
          <div className="space-y-6">
            ...
            <div className="glass-card rounded-xl p-6 text-center">
              <h3 className="text-sm font-semibold text-gray-900 dark:text-foreground mb-4">SLE Readiness Score</h3>
                ...
                {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, i) => {
                  ...
                  return (
                    <div key={day} className="text-center">
                      ...
                      <p className="text-[10px] font-medium text-gray-700 dark:text-muted-foreground mt-1">{val}</p>
                    </div>
                  );
                })}
              </div>
