          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <motion.p
                ...
                className="text-lg lg:text-xl leading-relaxed mb-4 md:mb-6 lg:mb-10 text-black dark:text-white"
              >
                {t.hero.subtitle}
              </motion.p>
                ...
                <button
                  ...
                  className={`flex items-center gap-3 px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                    activeExpertise === index
                      ...
                      : 'bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 hover:border-gray-300'
                  }`}
                  style={{
