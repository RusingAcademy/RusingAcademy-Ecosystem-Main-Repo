        ...
        <div className="max-w-6xl mx-auto p-6">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8 md:py-12 lg:py-16">
              ...
              <h3 className="text-lg font-semibold text-gray-700 dark:text-muted-foreground mb-2">No notes yet</h3>
...
function NoteCard({ note, onEdit, onDelete, onTogglePin }: {
  ...
  return (
    <div className={`${colorClasses.bg} border ${colorClasses.border} rounded-2xl p-5 transition-all hover:shadow-md group relative`}>
      ...
      <h3 className="text-sm font-bold text-gray-900 dark:text-foreground mb-2 pr-16 mt-1">{note.title}</h3>
