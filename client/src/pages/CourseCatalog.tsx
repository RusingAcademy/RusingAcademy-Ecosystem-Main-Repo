  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        {/* Decorative orbs */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-full -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-full translate-x-1/3 translate-y-1/3" />
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-48 bg-gradient-to-br from-indigo-900/20 to-[#2EC4B6]/20 overflow-hidden">
                    ...
                    {/* Level badge */}
                    {course.level && (
                      <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-xs font-bold bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/90 text-indigo-900 backdrop-blur-sm">
