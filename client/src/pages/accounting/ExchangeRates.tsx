  ...
  return (
    <div className="p-6 max-w-[1100px] mx-auto">
      ...
      <div className="qb-card mb-6 border-l-4 border-l-[#0077C5]">
        <h3 className="text-sm font-bold text-gray-700 dark:text-muted-foreground mb-3 flex items-center gap-2">
      ...
      {showCreate && (
        <div className="qb-card mb-6 border-2 border-green-600">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-foreground mb-4">Add Exchange Rate</h3>
