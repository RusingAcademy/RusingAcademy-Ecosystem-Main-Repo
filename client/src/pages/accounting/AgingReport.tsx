  ...
  return (
    <div className="p-6 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 gap-3 mb-6">
        {buckets.map((b) => (
          <div key={b} className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-4 text-center">
          ...
          <tbody>
            {isLoading ? (
              ...
              Object.entries(
                ...
                return (
                  <tr key={name} className="border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50">
