    ...
    <div className="p-6">
      ...
      {currentFiling && (
        <div className="qb-card mb-6 max-w-lg">
          ...
          <h2 className="text-lg font-semibold text-gray-800 dark:text-foreground mb-1">{currentFiling.agency || "CRA"}</h2>
          <div className="text-lg md:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-foreground mb-1">${Number(currentFiling.amountOwing || 0).toFixed(2)}</div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1 block">Period Start</label>
                <input type="date" value={prepareStart} onChange={e => setPrepareStart(e.target.value)}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1 block">Period End</label>
