    ...
    <div className="p-6 max-w-[900px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {(isNew || isEditing) && (
            <>
              <button className="qb-btn-outline flex items-center gap-1" onClick={() => isNew ? navigate("/suppliers") : setIsEditing(false)}>
                <X size={14} /> Cancel
              </button>
        ...
        {!isNew && s && (
          <div>
            <div className="qb-card">
              ...
              <p className="text-lg md:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">${Number(s.balance || 0).toFixed(2)}</p>
