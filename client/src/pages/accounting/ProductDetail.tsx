    ...
    <div className="p-6 max-w-[700px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate("/products-services")} className="p-2 hover:bg-gray-100 rounded-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            {isEditing ? (
              ...
              <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${p?.isTaxable ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}>
