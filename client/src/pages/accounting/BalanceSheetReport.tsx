      ...
      <div className="mb-3">
        ...
        {items.map((a, i) => (
          <div key={i} className="flex justify-between py-1 text-sm pl-8">
            ...
            <span className="text-gray-800 font-mono">{fmt(a.amount)}</span>
          </div>
        ))}
        <div className="flex justify-between py-1 text-sm font-medium pl-4 border-t border-gray-100">
          ...
          <span className="text-gray-800 font-mono">{fmt(sectionTotal)}</span>
        </div>
      </div>
    );
  };
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
            ...
            <button
              className={`p-2 ${viewMode === "chart" ? "bg-gray-100 text-gray-800" : "text-gray-400 hover:text-gray-600"}`}
            ...
            <div className="qb-card">
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-between py-2 text-sm font-bold border-t-2 border-gray-300 mt-2">
                  ...
                  <span className="text-gray-900 font-mono">{fmt(bs.totalAssets)}</span>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-between py-2 text-sm font-bold border-t-2 border-gray-300 mt-2">
                  ...
                  <span className="text-gray-900 font-mono">{fmt(bs.totalLiabilities)}</span>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex justify-between py-2 text-sm font-bold border-t-2 border-gray-300 mt-2">
                  ...
                  <span className="text-gray-900 font-mono">{fmt(bs.totalEquity)}</span>
                </div>
              </div>
