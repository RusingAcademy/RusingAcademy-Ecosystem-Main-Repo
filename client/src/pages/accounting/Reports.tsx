      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            <button className="px-3 py-1.5 bg-gray-100 rounded-md font-medium text-gray-800">Standard reports</button>
            <button className="px-3 py-1.5 text-gray-500 hover:bg-gray-50 rounded-md" onClick={() => toast("Feature coming soon")}>Custom reports</button>
            <button className="px-3 py-1.5 text-gray-500 hover:bg-gray-50 rounded-md" onClick={() => toast("Feature coming soon")}>Management reports</button>
          </div>
        </div>
      </div>
