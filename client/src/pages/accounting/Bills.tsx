          ...
          <tbody>
            {isLoading ? (
              ...
              paginated.map((bill: any) => (
                <tr key={bill.id} className="border-b border-gray-100 dark:border-white/15 hover:bg-gray-50 dark:bg-white/[0.06] dark:backdrop-blur-sm">
                  ...
                  <td className="px-4 py-3">
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[bill.status] || "bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-gray-600"}`}>
                      {bill.status}
                    </span>
                  </td>
      ...
      <Dialog open={payBill !== null} onOpenChange={() => setPayBill(null)}>
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1 block">Payment Amount</label>
              <input
                type="number"
                step="0.01"
                value={payAmount}
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1 block">Payment Account</label>
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1 block">Payment Date</label>
              <input
                type="date"
                value={payDate}
