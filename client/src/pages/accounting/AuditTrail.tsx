...
function getActionColor(action: string): string {
  ...
  return "bg-gray-100 dark:bg-slate-800 text-gray-600";
}
  ...
  return (
    <div className="p-6 max-w-[1100px] mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 mb-6">
        <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-3 text-center">
      ...
      {/* Filters */}
      <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-4 mb-6">
      ...
      {isLoading ? (
        ...
        <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 text-center py-12">
            ...
            <div key={date}>
              ...
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700 dark:border-slate-700 overflow-hidden">
                {entries.map((entry: any) => {
                  ...
                  return (
                    <div key={entry.id} className="border-b border-gray-100 dark:border-slate-700 last:border-0">
                      <div
                        className="flex items-center gap-3 px-4 py-2.5 hover:bg-gray-50 dark:bg-slate-900 cursor-pointer"
                      ...
                      {/* Expanded Details */}
                      {isExpanded && details && (
                        <div className="px-4 py-3 bg-gray-50 dark:bg-slate-900 border-t border-gray-100">
