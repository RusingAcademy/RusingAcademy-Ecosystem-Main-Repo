      ...
      {showNewForm && (
        <div className="bg-white dark:bg-background rounded-lg border border-gray-200 dark:border-border dark:border-border p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1">Account</label>
              <select
                value={newAccountId}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1">Statement Date</label>
              <input
                type="date"
                value={statementDate}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-muted-foreground mb-1">Statement Ending Balance</label>
              <input
                type="number"
                step="0.01"
