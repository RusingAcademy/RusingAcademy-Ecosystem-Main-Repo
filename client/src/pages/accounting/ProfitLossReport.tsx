        ...
        <>
          ...
          {viewMode === "chart" && monthlyData && (
            <div className="qb-card mb-6">
              ...
              <h3 className="text-sm font-semibold text-gray-700 mt-6 mb-4">Net Profit Trend</h3>
              <div className="h-48">
                <ResponsiveContainer width="100%" height="100%">
                ...
                {pnl.income.length === 0 ? (
                  ...
                  pnl.income.map((acct: any, i: number) => (
                    <div key={i} className="flex justify-between py-1.5 text-sm">
                      <span className="text-gray-700 pl-4">{acct.name}</span>
                      <span className="text-gray-800 font-mono">{fmt(acct.amount)}</span>
                    </div>
                  ))
                )}
