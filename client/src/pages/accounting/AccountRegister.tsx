    ...
    <div className="p-6 max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate("/chart-of-accounts")} className="p-2 hover:bg-gray-100 dark:bg-card rounded-lg">
      ...
      <div className="qb-card">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <select className="border border-gray-200 dark:border-border dark:border-border rounded-lg px-3 py-1.5 text-sm">
