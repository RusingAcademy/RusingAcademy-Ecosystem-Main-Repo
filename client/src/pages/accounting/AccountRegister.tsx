    ...
    <div className="p-6 max-w-[1000px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate("/chart-of-accounts")} className="p-2 hover:bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 rounded-lg">
      ...
      <div className="qb-card">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            <select className="border border-gray-200 dark:border-white/15 dark:border-white/15 rounded-lg px-3 py-1.5 text-sm">
