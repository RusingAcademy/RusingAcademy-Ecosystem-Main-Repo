      ...
      <Dialog open={showTransfer} onOpenChange={setShowTransfer}>
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1 block">From Account</label>
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1 block">To Account</label>
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 mb-1 block">Memo</label>
