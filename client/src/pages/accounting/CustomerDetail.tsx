    ...
    <div className="p-6 max-w-[1000px] mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          {(isNew || isEditing) && (
            <>
              <button className="qb-btn-outline flex items-center gap-1" onClick={() => isNew ? navigate("/customers") : setIsEditing(false)}>
                <X size={14} /> Cancel
              </button>
              <button
        ...
        {!isNew && c && (
          <div>
            <div className="qb-card">
              ...
              <p className="text-3xl font-bold text-gray-900 mb-2">${Number(c.balance || 0).toFixed(2)}</p>
              <p className="text-xs text-gray-500">Outstanding balance</p>
              <hr className="my-4" />
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-gray-500">Invoices</span>
                  <span className="text-gray-800 font-medium">{(invoices as any[])?.length || 0}</span>
                </div>
                <div className="flex justify-between">
