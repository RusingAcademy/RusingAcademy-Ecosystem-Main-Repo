            ...
            <tbody>
              {lineItems.map((line, idx) => (
                <tr key={line.id} className="border-b border-gray-100">
                  ...
                  <td className="py-3 text-sm text-gray-700 text-right">{line.quantity || "1"}</td>
                  <td className="py-3 text-sm text-gray-700 text-right">{fmt(line.rate)}</td>
                  <td className="py-3 text-sm text-gray-500 text-right">{line.taxCode || "—"}</td>
                  <td className="py-3 text-sm font-medium text-gray-800 text-right">{fmt(line.amount)}</td>
                </tr>
              ))}
            </tbody>
          </table>
