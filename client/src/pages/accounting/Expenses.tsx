          ...
          <tbody>
            {paginated.map((exp: any) => {
              return (
                <tr
                  key={exp.id}
                  className={`hover:bg-gray-50 cursor-pointer ${selectedIds.has(exp.id) ? "bg-blue-50" : ""}`}
                ...
                >
                  ...
                  <td>
                    <button className="p-1 hover:bg-gray-100 rounded" onClick={(e) => { e.stopPropagation(); navigate(`/expenses/${exp.id}`); }}>
