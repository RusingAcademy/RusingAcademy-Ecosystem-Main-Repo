        ...
        <main className="flex-1 flex items-center justify-center py-12">
          <Card className="max-w-md w-full mx-4 text-center">
            <CardContent className="pt-8 pb-8">
              <AlertCircle className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              {loadingUpcoming ? (
                ...
                <Card>
                  <CardContent className="py-12 text-center">
                    ...
                    <p className="text-black dark:text-white dark:text-white mb-4">{l.noUpcoming}</p>
                    <Link href="/coaches">
            ...
            <TabsContent value="past">
              {loadingPast ? (
                                ...
                                <div className="flex items-center gap-3">
                                  <Avatar className="h-12 w-12">
                                    {coach?.photoUrl ? (
                                      ...
                                      <AvatarFallback className="bg-muted text-black dark:text-white dark:text-white">
                                        {coach?.name?.split(" ").map((n: string) => n[0]).join("") || "C"}
                                      </AvatarFallback>
                                    )}
                                  </Avatar>
                ...
                <Card>
                  <CardContent className="py-12 text-center">
                    <History className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
                    <p className="text-black dark:text-white dark:text-white">{l.noPast}</p>
                  </CardContent>
                </Card>
              )}
            </TabsContent>
            ...
            <TabsContent value="cancelled">
              {loadingCancelled ? (
                            ...
                            <div className="flex-1 p-4">
                              <div className="flex items-start justify-between">
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="font-semibold text-black dark:text-white dark:text-white">{coach?.name || "Coach"}</p>
                                    <div className="flex items-center gap-2 text-sm text-black dark:text-white dark:text-white">
                                      <Clock className="h-3 w-3" />
                                      {session.duration || 60} {l.minutes}
                                      <span className="mx-1">•</span>
                ...
                <Card>
                  <CardContent className="py-12 text-center">
                    <XCircle className="h-12 w-12 mx-auto text-black dark:text-white dark:text-white mb-4" />
                    <p className="text-black dark:text-white dark:text-white">{l.noCancelled}</p>
                  </CardContent>
                </Card>
              )}
            </TabsContent>
