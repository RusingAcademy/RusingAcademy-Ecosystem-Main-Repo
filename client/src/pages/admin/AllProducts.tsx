...
const productTypes: { key: ProductType; label: string; icon: React.ElementType; color: string }[] = [
  ...
  { key: "courses", label: "Courses", icon: BookOpen, color: "var(--color-blue-600, var(--color-blue-600, var(--semantic-info)))" },
  { key: "coaching", label: "Coaching", icon: GraduationCap, color: "var(--semantic-success, var(--semantic-success, var(--success)))" },
  { key: "podcasts", label: "Podcasts", icon: Headphones, color: "var(--color-violet-600, var(--color-violet-600, var(--accent-purple)))" },
  { key: "newsletters", label: "Newsletters", icon: Newspaper, color: "var(--semantic-danger, var(--semantic-danger, var(--danger)))" },
