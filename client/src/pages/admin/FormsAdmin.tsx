          ...
          <Card key={form.id} className="hover:shadow-sm transition-shadow">
            <CardContent className="p-4 flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => toast.info("Form builder — launching soon!")}><Edit className="h-4 w-4" /></Button>
                <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => toast.info("Submissions view — launching soon!")}><Eye className="h-4 w-4" /></Button>
