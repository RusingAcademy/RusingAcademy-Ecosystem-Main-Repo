  ...
  return (
    <div className="space-y-6">
      ...
      <Card><CardContent className="p-4"><p className="text-sm font-medium mb-3">Offer Types</p><div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
        {[{ icon: DollarSign, label: "One-Time", desc: "Single payment", color: "var(--semantic-success, var(--semantic-success, var(--success)))" },{ icon: Clock, label: "Subscription", desc: "Recurring billing", color: "var(--color-blue-600, var(--color-blue-600, var(--semantic-info)))" },{ icon: Percent, label: "Payment Plan", desc: "Split payments", color: "var(--color-violet-600, var(--color-violet-600, var(--accent-purple)))" },{ icon: Gift, label: "Free", desc: "Lead magnet", color: "var(--semantic-danger, var(--semantic-danger, var(--danger)))" },{ icon: Package, label: "Bundle", desc: "Multiple products", color: "#ea580c" }].map(t => (
