  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          { label: "Total Users", value: stats.total, icon: Users, color: "var(--color-blue-600, var(--color-blue-600, var(--semantic-info)))" },
          { label: "Admins", value: stats.admins, icon: Shield, color: "var(--semantic-danger, var(--semantic-danger, var(--danger)))" },
          { label: "Coaches", value: stats.coaches, icon: GraduationCap, color: "var(--color-violet-600, var(--color-violet-600, var(--accent-purple)))" },
          { label: "Learners", value: stats.learners, icon: UserCheck, color: "var(--semantic-success, var(--semantic-success, var(--success)))" },
        ].map((s) => (
          <Card key={s.label}>
