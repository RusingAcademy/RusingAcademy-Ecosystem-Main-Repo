...
const STEP_COLORS: Record<string, string> = {
  ...
  delay: "bg-teal-800/10 text-black dark:text-foreground border-gray-500/20",
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              ...
              {steps.map((step, idx) => {
                ...
                const colorClass = STEP_COLORS[step.type] ?? "bg-teal-800/10 text-black dark:text-foreground border-gray-500/20";
                return (
                  <div key={step.id}>
                    <div className="flex justify-center py-1">
                      <ArrowRight className="h-4 w-4 text-black/60 dark:text-foreground/60 rotate-90" />
                    </div>
            ...
            <CardContent>
              {!stats?.recentOnboardings || (stats.recentOnboardings as any[]).length === 0 ? (
                <div className="text-center py-8">
                  <Users className="h-10 w-10 mx-auto text-black/40 dark:text-foreground/40 mb-2" />
