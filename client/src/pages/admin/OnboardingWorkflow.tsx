...
const STEP_COLORS: Record<string, string> = {
  ...
  delay: "bg-teal-800/10 text-black dark:text-white border-gray-500/20",
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              ...
              {steps.map((step, idx) => {
                ...
                const colorClass = STEP_COLORS[step.type] ?? "bg-teal-800/10 text-black dark:text-white border-gray-500/20";
                return (
                  <div key={step.id}>
