...
export default function InvoicesAdmin() {
  ...
  const statusColors: Record<string, string> = { paid: "bg-green-100 text-green-700", sent: "bg-blue-100 text-blue-700", draft: "bg-gray-100 dark:bg-slate-800 text-gray-700", overdue: "bg-red-100 text-red-700", cancelled: "bg-gray-100 dark:bg-slate-800 text-gray-500" };
