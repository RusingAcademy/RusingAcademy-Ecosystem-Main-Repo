  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: ui.totalUsers, value: totalUsers, icon: Users, color: "#2563eb", sub: `${totalLearners} ${ui.learners}` },
          { label: ui.activeCoaches, value: activeCoaches, icon: GraduationCap, color: "#059669", sub: `${pendingCoaches} ${ui.pending}` },
          { label: ui.sessions, value: sessionsThisMonth, icon: Calendar, color: "#7c3aed", sub: a.sessionGrowth ? `${a.sessionGrowth > 0 ? "+" : ""}${a.sessionGrowth}%` : "" },
          { label: ui.revenue, value: `$${(revenue / 100).toLocaleString()}`, icon: DollarSign, color: "#dc2626", sub: a.revenueGrowth ? `${a.revenueGrowth > 0 ? "+" : ""}${a.revenueGrowth}%` : "" },
        ].map((s) => (
