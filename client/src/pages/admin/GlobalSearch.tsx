  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 text-sm text-black dark:text-white bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors w-full max-w-sm"
      >
                      ...
                      {(results as any[]).map((r: any, idx: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-xs px-2 py-0.5 rounded-full bg-gray-100 text-black dark:text-white capitalize">
