...
const SECTION_TYPES = [
  ...
  { type: "text_block", label: "Text Block", icon: Type, desc: "Rich text content section", color: "bg-teal-800" },
  ...
  { type: "spacer", label: "Spacer", icon: Box, desc: "Vertical spacing block", color: "bg-teal-800" },
];
...
const SECTION_TEMPLATES: Record<string, any> = {
  ...
  text_block: {
    ...
    textColor: "var(--brand-obsidian, var(--brand-obsidian, #1a1a2e))",
    paddingTop: 48,
    paddingBottom: 48,
  },
  features: {
...
function SortableSidebarItem({ section, isSelected, onSelect, onToggleVisibility, onDuplicate, onDelete, onCopyToPage, onShowHistory, onSaveAsTemplate }: {
  ...
  return (
    <div
      ...
      onClick={onSelect}
    >
      <div {...attributes} {...listeners} className="cursor-grab active:cursor-grabbing p-0.5 -ml-1 text-cyan-300 hover:text-black dark:text-white dark:text-white">
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[10px] text-cyan-300">{typeInfo?.label}</p>
      </div>
      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
        <button onClick={(e) => { e.stopPropagation(); onToggleVisibility(); }} className="p-1 rounded hover:bg-gray-200" title={section.isVisible === false || section.isVisible === 0 ? "Show" : "Hide"}>
          {section.isVisible === false || section.isVisible === 0 ? <EyeOff className="h-3 w-3 text-cyan-300" /> : <Eye className="h-3 w-3 text-black dark:text-white dark:text-white" />}
        </button>
        <button onClick={(e) => { e.stopPropagation(); onDuplicate(); }} className="p-1 rounded hover:bg-gray-200" title="Duplicate">
          <Copy className="h-3 w-3 text-black dark:text-white dark:text-white" />
        </button>
        ...
        return (
          <div className="text-center max-w-4xl mx-auto px-6">
            ...
            <div className="relative z-10">
              ...
              {content.ctaText && (
                <button className="px-6 py-3 bg-white dark:bg-slate-800 dark:bg-slate-900/20 backdrop-blur-sm border border-white/60 text-white rounded-lg font-medium hover:bg-white dark:bg-slate-800 dark:bg-slate-900/30 transition-colors">
                  {content.ctaText}
                </button>
              )}
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f: any, i: number) => (
                <div key={i} className="p-5 rounded-xl border bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((t: any, i: number) => (
                <div key={i} className="p-5 border rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm">
        ...
        return (
          <div className="text-center max-w-3xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {content.ctaText && <button className="px-6 py-3 bg-white dark:bg-slate-800 dark:bg-slate-900 text-indigo-700 rounded-lg font-semibold hover:bg-gray-100 dark:bg-slate-800 transition-colors">{content.ctaText}</button>}
              {content.secondaryCtaText && <button className="px-6 py-3 border border-white/60 text-white rounded-lg font-medium hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 transition-colors">{content.secondaryCtaText}</button>}
            </div>
          </div>
        );
      case "faq": {
        ...
        return (
          <div className="text-center max-w-xl mx-auto px-6">
            ...
            <div className="flex gap-2">
              <div className="flex-1 h-10 bg-white dark:bg-slate-800 dark:bg-slate-900/20 rounded-lg border border-white/60" />
              <button className="px-5 py-2 bg-white dark:bg-slate-800 dark:bg-slate-900 text-indigo-700 rounded-lg text-sm font-semibold">{content.buttonText || "Subscribe"}</button>
            </div>
          </div>
        );
      case "divider":
    ...
    >
      ...
      {(section.isVisible === false || section.isVisible === 0) && (
        <div className="absolute inset-0 z-10 bg-obsidian/50 flex items-center justify-center">
          <Badge variant="outline" className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-black dark:text-white dark:text-white"><EyeOff className="h-3 w-3 mr-1" /> Hidden</Badge>
        </div>
      )}
      {renderContent()}
    </div>
...
function SectionEditorPanel({ section, onUpdate, onClose, onMediaLibraryOpen, onConfigureAnimation }: {
  ...
  const [localData, setLocalData] = useState<any>({
    ...
    backgroundColor: section.backgroundColor || "var(--color-white, #ffffff)",
    textColor: section.textColor || "var(--brand-obsidian, var(--brand-obsidian, #1a1a2e))",
  ...
  return (
    <div className="h-full flex flex-col bg-white dark:bg-slate-800 dark:bg-slate-900">
      {/* Header */}
        ...
        <div className="p-4 space-y-5">
          ...
          <Tabs defaultValue="content" className="w-full">
            ...
            <TabsContent value="content" className="space-y-4 mt-3">
              ...
              {section.sectionType !== "divider" && section.sectionType !== "spacer" && (
                <>
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium">Title <span className="text-cyan-300">(EN | FR)</span></Label>
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-medium">Subtitle <span className="text-cyan-300">(EN | FR)</span></Label>
              ...
              {(section.sectionType === "hero" || section.sectionType === "cta") && (
                <div className="space-y-3 p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
                  <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">CTA Button</Label>
                  <div className="space-y-1.5">
              ...
              {section.sectionType === "text_block" && (
                <div className="space-y-1.5">
                  <Label className="text-xs font-medium">Content <span className="text-cyan-300">(Rich Text)</span></Label>
                  <RichTextEditor
              ...
              {section.sectionType === "features" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Feature Items</Label>
              ...
              {section.sectionType === "testimonials" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Testimonials</Label>
              ...
              {section.sectionType === "faq" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">FAQ Items</Label>
              ...
              {section.sectionType === "stats" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Stats</Label>
              ...
              {section.sectionType === "video" && (
                <div className="space-y-3 p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
                  <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Video Settings</Label>
                  <div className="space-y-1.5">
              ...
              {section.sectionType === "pricing_table" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Pricing Plans</Label>
              ...
              {section.sectionType === "team" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Team Members</Label>
                    <Button size="sm" variant="outline" className="h-6 text-xs" onClick={() => {
                      setLocalData((d: any) => ({
                        ...d,
            ...
            <TabsContent value="style" className="space-y-4 mt-3">
              <div className="space-y-3">
                <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Colors</Label>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label className="text-xs">Background</Label>
                    <div className="flex items-center gap-2">
                      <input type="color" value={localData.backgroundColor || "var(--color-white, #ffffff)"} onChange={(e) => setLocalData((d: any) => ({ ...d, backgroundColor: e.target.value }))} className="w-8 h-8 rounded border cursor-pointer" />
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <input type="color" value={localData.textColor || "var(--brand-obsidian, var(--brand-obsidian, #1a1a2e))"} onChange={(e) => setLocalData((d: any) => ({ ...d, textColor: e.target.value }))} className="w-8 h-8 rounded border cursor-pointer" />
              ...
              <div className="space-y-3">
                <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Spacing</Label>
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
              ...
              <div className="space-y-2">
                <Label className="text-xs font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">Animation</Label>
                <div className="flex items-center gap-2">
              ...
              <StylePresetsPanel
                ...
                currentStyles={{
                  backgroundColor: localData.backgroundColor || "var(--color-white, #ffffff)",
                  textColor: localData.textColor || "var(--brand-obsidian, var(--brand-obsidian, #1a1a2e))",
...
export default function VisualEditor({ pageId, onBack }: { pageId: number; onBack: () => void }) {
  ...
  if (!mounted) return null;
   ...
   if (pageQuery.isLoading) {
    return createPortal(
      <div className="fixed inset-0 z-[100] bg-white dark:bg-slate-800 dark:bg-slate-900 flex items-center justify-center">
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] bg-white dark:bg-slate-800 dark:bg-slate-900 flex flex-col">
      {/* ─── Top Toolbar ─── */}
      <div className="h-14 border-b bg-white dark:bg-slate-800 dark:bg-slate-900 flex items-center justify-between px-4 shrink-0 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-cyan-300">/p/{page.slug}</p>
          </div>
      ...
      <div className="flex-1 flex overflow-hidden">
                ...
                <div className="p-3 space-y-1.5">
                  {sections.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-xs text-cyan-300">No sections yet</p>
        ...
        <div className="flex-1 bg-gray-100 dark:bg-slate-800 overflow-auto flex justify-center" onClick={() => setSelectedSectionId(null)}>
          <div
            className="bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-lg my-4 overflow-auto transition-all duration-300"
            style={{
              width: previewWidth,
          ...
          >
            {sections.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full min-h-[60vh] text-cyan-300">
        ...
        {selectedSection && (
          <div className="w-80 border-l bg-white dark:bg-slate-800 dark:bg-slate-900 shrink-0 overflow-hidden">
            <SectionEditorPanel
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-black dark:text-white dark:text-white">Status: {page?.status || "draft"}</p>
              </div>
              <Badge>Active</Badge>
            </div>
            <div className="flex gap-2">
            ...
            <ScrollArea className="max-h-[300px]">
              <div className="space-y-2">
                {versionsQuery.isLoading ? (
                  <div className="flex items-center gap-2 text-cyan-300 py-4 justify-center"><Loader2 className="h-4 w-4 animate-spin" /> Loading...</div>
                  ...
                  (versionsQuery.data as any[]).map((v: any) => (
                    <div key={v.id} className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 dark:bg-slate-900 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {v.note && <p className="text-xs text-black dark:text-white dark:text-white truncate">{v.note}</p>}
