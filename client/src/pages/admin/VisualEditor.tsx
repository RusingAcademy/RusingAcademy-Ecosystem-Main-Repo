        ...
        return (
          <div className="text-center max-w-3xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {content.ctaText && <button className="px-6 py-3 bg-white dark:bg-slate-900 text-indigo-700 rounded-lg font-semibold hover:bg-gray-100 transition-colors">{content.ctaText}</button>}
