...
const SECTION_TEMPLATES: Record<string, any> = {
  hero: {
    ...
    textColor: "var(--color-white, var(--text-inverse))",
    paddingTop: 80,
    paddingBottom: 80,
  },
  text_block: {
    ...
    backgroundColor: "var(--color-white, var(--text-inverse))",
...
function SortableSidebarItem({ section, isSelected, onSelect, onToggleVisibility, onDuplicate, onDelete, onCopyToPage, onShowHistory, onSaveAsTemplate }: {
  ...
  return (
    <div
      ...
      onClick={onSelect}
    >
      <div {...attributes} {...listeners} className="cursor-grab active:cursor-grabbing p-0.5 -ml-1 text-cyan-300 hover:text-black">
      ...
      <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
        <button onClick={(e) => { e.stopPropagation(); onToggleVisibility(); }} className="p-1 rounded hover:bg-gray-200" title={section.isVisible === false || section.isVisible === 0 ? "Show" : "Hide"}>
          {section.isVisible === false || section.isVisible === 0 ? <EyeOff className="h-3 w-3 text-cyan-300" /> : <Eye className="h-3 w-3 text-black" />}
        </button>
        ...
        return (
          <div className="text-center max-w-4xl mx-auto px-6">
            ...
            <div className="relative z-10">
              ...
              {content.ctaText && (
                <button className="px-6 py-3 bg-white backdrop-blur-sm border border-white/60 text-gray-800 rounded-lg font-medium hover:bg-gray-50:bg-background/30 transition-colors">
                  {content.ctaText}
                </button>
              )}
            </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((f: any, i: number) => (
                <div key={i} className="p-5 rounded-xl border bg-white backdrop-blur-sm">
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {testimonials.map((t: any, i: number) => (
                <div key={i} className="p-5 border rounded-xl bg-white backdrop-blur-sm">
        ...
        return (
          <div className="text-center max-w-3xl mx-auto px-6">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              {content.secondaryCtaText && <button className="px-6 py-3 border border-white/60 text-white rounded-lg font-medium hover:bg-white transition-colors">{content.secondaryCtaText}</button>}
            </div>
          </div>
        );
      case "faq": {
        ...
        return (
          <div className="text-center max-w-xl mx-auto px-6">
            ...
            <div className="flex gap-2">
              <div className="flex-1 h-10 bg-white rounded-lg border border-white/60" />
          ...
          <Tabs defaultValue="content" className="w-full">
            ...
            <TabsContent value="style" className="space-y-4 mt-3">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-2">
                      <input type="color" value={localData.backgroundColor || "var(--color-white, var(--text-inverse))"} onChange={(e) => setLocalData((d: any) => ({ ...d, backgroundColor: e.target.value }))} className="w-8 h-8 rounded border cursor-pointer" />
              ...
              <StylePresetsPanel
                ...
                currentStyles={{
                  backgroundColor: localData.backgroundColor || "var(--color-white, var(--text-inverse))",
