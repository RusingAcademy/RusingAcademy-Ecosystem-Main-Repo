...
export default function HowItWorks() {
  ...
  const labels = {
    en: {
      ...
      step4Desc: "Practice with your coach and Prof Steven AI. Track your progress and get ready to pass your SLE exam.",
      ...
      aiSection: "Practice 24/7 with Prof Steven AI",
      ...
      tryAI: "Try Prof Steven AI",
      getStarted: "Get Started",
      becomeCoach: "Become a Coach",
      faqTitle: "Frequently Asked Questions",
      faq1Q: "How much does it cost?",
      faq1A: "Coach rates vary from $40-$100+ per hour. Trial sessions are typically discounted. Prof Steven AI practice is included with your account.",
      ...
      faq4Q: "How is Prof Steven AI different from ChatGPT?",
      faq4A: "Prof Steven AI is specifically trained for Canadian federal SLE preparation. It understands the exam format, scoring criteria, and provides feedback calibrated to Treasury Board standards.",
    },
    fr: {
      ...
      step4Desc: "Pratiquez avec votre coach et Prof Steven AI. Suivez vos progrès et préparez-vous à réussir votre examen ELS.",
      ...
      aiSection: "Pratiquez 24/7 avec Prof Steven AI",
      ...
      tryAI: "Essayer Prof Steven AI",
      getStarted: "Commencer",
      becomeCoach: "Devenir coach",
      faqTitle: "Questions fréquemment posées",
      faq1Q: "Combien ça coûte?",
      faq1A: "Les tarifs des coachs varient de 40$ à 100$+ par heure. Les sessions d'essai sont généralement à prix réduit. La pratique avec Prof Steven AI est incluse avec votre compte.",
      ...
      faq4Q: "En quoi Prof Steven AI est-il différent de ChatGPT?",
      faq4A: "Prof Steven AI est spécifiquement formé pour la préparation ELS fédérale canadienne. Il comprend le format d'examen, les critères de notation et fournit des commentaires calibrés selon les normes du Conseil du Trésor.",
    },
  };
