  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FDFBF7] via-white to-[#F0EDE5] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        {/* Additional links */}
        <div className="mt-6 text-center text-sm text-black dark:text-foreground">
          <p>
        ...
        {/* Benefits */}
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 text-center text-xs text-black dark:text-foreground">
