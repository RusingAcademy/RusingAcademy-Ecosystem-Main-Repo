          ...
          <div className="container relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
                <span className="text-black dark:text-foreground">{l.title}</span>
              </h1>

              {/* Subtitle */}
              <p className="text-lg sm:text-xl text-black dark:text-foreground max-w-2xl mx-auto mb-8">
                {l.subtitle}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
                {l.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-2 text-sm text-black dark:text-foreground">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="name" className="text-black dark:text-foreground">{l.name}</Label>
                          <Input
                            id="name"
                            name="name"
                            value={formData.name}
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="email" className="text-black dark:text-foreground">{l.email}</Label>
                          <Input
                            id="email"
                            name="email"
                            type="email"
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="phone" className="text-black dark:text-foreground">{l.phone}</Label>
                          <Input
                            id="phone"
                            name="phone"
                            type="tel"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="brand" className="text-black dark:text-foreground">{l.brand}</Label>
                          <Select 
                            name="brand" 
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="subject" className="text-black dark:text-foreground">{l.subject}</Label>
                        <Select 
                          name="subject" 
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="text-black dark:text-foreground">{l.message}</Label>
                        <Textarea
                          id="message"
                          name="message"
                ...
                <Card className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border-slate-200 shadow-lg shadow-slate-200/50">
                  ...
                  <CardContent className="space-y-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-foreground">{l.emailUs}</p>
                        <a
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-foreground">{l.phoneUs}</p>
                        <a
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-foreground">{l.officeHours}</p>
                        <p className="text-black dark:text-foreground text-sm">{l.officeHoursValue}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-foreground">{l.location}</p>
                        <p className="text-black dark:text-foreground text-sm">{l.locationValue}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                      ...
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-foreground group-hover:text-teal-700 transition-colors">{l.faqTitle}</h4>
                            <p className="text-sm text-black dark:text-foreground">{l.faqDescription}</p>
                          </div>
                    ...
                    <Card className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border-slate-200 hover:border-violet-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-foreground group-hover:text-violet-700 transition-colors">{l.coachSupport}</h4>
                            <p className="text-sm text-black dark:text-foreground">{l.coachSupportDesc}</p>
                          </div>
                    ...
                    <Card className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border-slate-200 hover:border-amber-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-foreground group-hover:text-amber-700 transition-colors">{l.b2b}</h4>
                            <p className="text-sm text-black dark:text-foreground">{l.b2bDesc}</p>
                          </div>
