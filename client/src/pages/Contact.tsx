...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white dark:bg-slate-800 dark:bg-slate-900">      <main id="main-content" className="flex-1">
          ...
          <div className="container relative z-10">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
                <span className="text-black dark:text-white dark:text-white">{l.title}</span>
              </h1>

              {/* Subtitle */}
              <p className="text-lg sm:text-xl text-black dark:text-white dark:text-white max-w-2xl mx-auto mb-8">
                {l.subtitle}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-4 sm:gap-6">
                {l.features.map((feature, index) => (
                  <div key={index} className="flex items-center gap-2 text-sm text-black dark:text-white dark:text-white">
          ...
          <div className="container">
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-2">
                <Card className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 shadow-lg shadow-slate-200/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-2xl text-black dark:text-white dark:text-white">{l.formTitle}</CardTitle>
                    <CardDescription className="text-black dark:text-white dark:text-white">{l.formDescription}</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="name" className="text-black dark:text-white dark:text-white">{l.name}</Label>
                          <Input
                            id="name"
                            name="name"
                            value={formData.name}
                            ...
                            className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 focus:border-teal-500 focus:ring-teal-500"
                            required
                          />
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="email" className="text-black dark:text-white dark:text-white">{l.email}</Label>
                          <Input
                            id="email"
                            name="email"
                            type="email"
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="phone" className="text-black dark:text-white dark:text-white">{l.phone}</Label>
                          <Input
                            id="phone"
                            name="phone"
                            type="tel"
                        ...
                        <div className="space-y-2">
                          <Label htmlFor="brand" className="text-black dark:text-white dark:text-white">{l.brand}</Label>
                          <Select 
                            name="brand" 
                            value={formData.brand}
                            onValueChange={(value) => setFormData({ ...formData, brand: value })}
                          >
                            <SelectTrigger id="brand" className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="subject" className="text-black dark:text-white dark:text-white">{l.subject}</Label>
                        <Select 
                          name="subject" 
                          ...
                          required
                        >
                          <SelectTrigger id="subject" className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="message" className="text-black dark:text-white dark:text-white">{l.message}</Label>
                        <Textarea
                          id="message"
                          name="message"
                          ...
                          rows={6}
                          className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 focus:border-teal-500 focus:ring-teal-500 resize-none"
                          required
                        />
                      </div>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 shadow-lg shadow-slate-200/50">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-lg text-black dark:text-white dark:text-white">{l.contactInfo}</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-white dark:text-white">{l.emailUs}</p>
                        <a
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-white dark:text-white">{l.phoneUs}</p>
                        <a
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-white dark:text-white">{l.officeHours}</p>
                        <p className="text-black dark:text-white dark:text-white text-sm">{l.officeHoursValue}</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="font-medium text-sm text-black dark:text-white dark:text-white">{l.location}</p>
                        <p className="text-black dark:text-white dark:text-white text-sm">{l.locationValue}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <div className="space-y-4">
                  <h3 className="text-sm font-semibold text-black dark:text-white dark:text-white uppercase tracking-wider">{l.quickLinks}</h3>
                  
                  <Link href="/faq">
                    <Card className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 hover:border-teal-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-white dark:text-white group-hover:text-teal-700 transition-colors">{l.faqTitle}</h4>
                            <p className="text-sm text-black dark:text-white dark:text-white">{l.faqDescription}</p>
                          </div>
                  ...
                  <Link href="/become-a-coach">
                    <Card className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 hover:border-violet-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-white dark:text-white group-hover:text-violet-700 transition-colors">{l.coachSupport}</h4>
                            <p className="text-sm text-black dark:text-white dark:text-white">{l.coachSupportDesc}</p>
                          </div>
                  ...
                  <Link href="/for-business">
                    <Card className="bg-white dark:bg-slate-800 dark:bg-slate-900 border-slate-200 hover:border-amber-300 hover:shadow-md transition-all duration-300 cursor-pointer group">
                      <CardContent className="p-5">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            <h4 className="font-semibold text-black dark:text-white dark:text-white group-hover:text-amber-700 transition-colors">{l.b2b}</h4>
                            <p className="text-sm text-black dark:text-white dark:text-white">{l.b2bDesc}</p>
                          </div>
        ...
        <section className="py-16 lg:py-24 bg-gradient-to-br from-foundation to-teal-700">
          <div className="container">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl p-6 lg:p-8 shadow-xl">
