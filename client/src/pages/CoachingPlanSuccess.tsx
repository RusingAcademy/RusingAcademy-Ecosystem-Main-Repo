      ...
      <main className="flex-1 py-6 md:py-8 lg:py-12">
        <div className="container max-w-3xl mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 bg-gradient-to-r from-teal-700 to-cta bg-clip-text text-transparent">
              {l.title}
            </h1>
            <p className="text-black dark:text-foreground text-lg">{l.subtitle}</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    <div className="flex items-center gap-3 p-4 bg-teal-50 dark:bg-teal-950/30 rounded-xl">
                      ...
                      <div>
                        <p className="text-sm text-black dark:text-foreground">{l.sessions}</p>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-amber-50 dark:bg-amber-950/30 rounded-xl">
                      ...
                      <div>
                        <p className="text-sm text-black dark:text-foreground">{l.validity}</p>
                    ...
                    <div className="flex items-center gap-3 p-4 bg-emerald-50 dark:bg-emerald-950/30 rounded-xl">
                      ...
                      <div>
                        <p className="text-sm text-black dark:text-foreground">{l.price}</p>
          ...
          <div className="mb-8 p-4 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 border border-emerald-200 dark:border-emerald-800 rounded-xl">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-black dark:text-foreground">{l.guaranteeText}</p>
              </div>
            </div>
          </div>
              ...
              <ol className="space-y-4">
                {[l.step1, l.step2, l.step3, l.step4].map((step, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-black dark:text-foreground pt-1">{step}</span>
                  </li>
                ))}
              </ol>
            </CardContent>
