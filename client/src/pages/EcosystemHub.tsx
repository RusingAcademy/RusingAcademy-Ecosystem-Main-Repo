...
function EcosystemSection({ language }: { language: string }) {
  const pillars = [
    ...
    },
    {
      ...
      image: "/images/hub/Lingueefy2.jpg",
      link: "/",
    },
    {
      id: "studio",
      ...
      image: "/images/hub/BarholexMedia.jpg",
      link: "/barholex",
    },
  ];
  ...
  const offers = [
    {
      ...
      image: "/images/hub/StevenClass.jpeg",
    ...
    },
    {
      ...
      image: "/images/hub/Steven&Sue-Anne.jpg",
    ...
    },
    {
      ...
      image: "/images/hub/video-equipment.jpg",
      ctaEn: "Learn more",
  ...
  const testimonials = [
    {
      ...
      image: "/images/hub/MithulaNaik.webp",
    ...
    },
    {
      ...
      image: "/images/hub/JenaCameron.webp",
    ...
    },
    {
      ...
      image: "/images/hub/EdithBramwell.webp",
    ...
    <section className="py-24 px-4 bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <img
              src="/images/hub/StevenClass.jpeg"
              alt="Steven teaching"
...
function TeamSection({ language }: { language: string }) {
  const team = [
    ...
    },
    {
      ...
      image: "/images/hub/ErikaSeguin-WebHeadshot.jpeg",
