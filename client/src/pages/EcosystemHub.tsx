...
function TrilemmeSection({ language }: { language: string }) {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 lg:py-24 px-4 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto">
        ...
        >
          <p className="text-black dark:text-foreground text-sm md:text-base leading-relaxed">
            {language === "en"
...
function TargetAudienceSection({ language }: { language: string }) {
  ...
  return (
    <section className="py-10 sm:py-12 md:py-16 lg:py-24 px-4 bg-gradient-to-b from-obsidian to-teal-900">
      <div className="container mx-auto">
        {/* Section Context */}
        <motion.div
          initial="hidden"
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-black dark:text-foreground leading-relaxed italic">
              ...
              <div className="flex items-center gap-4">
                {testimonial.image ? (
                  ...
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-slate-200 to-slate-300 flex items-center justify-center">
                    <Users className="w-6 h-6 text-black dark:text-foreground" />
                  </div>
                )}
                <div className="flex-1">
                  <h4 className="font-semibold text-black dark:text-foreground">{testimonial.name}</h4>
    ...
    <section className="py-10 sm:py-12 md:py-16 lg:py-24 px-4 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          variants={staggerContainer}
          className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8"
        >
          {team.map((member, index) => (
            ...
            >
              ...
              {/* Content */}
              <div className="p-6">
                <h3 className="text-lg font-bold text-black dark:text-foreground mb-1">{member.name}</h3>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                {openIndex === index ? (
                  <ChevronUp className="w-5 h-5 text-black dark:text-foreground flex-shrink-0" aria-hidden="true" />
                ) : (
                  <ChevronDown className="w-5 h-5 text-black dark:text-foreground flex-shrink-0" aria-hidden="true" />
                )}
              </button>
              {openIndex === index && (
