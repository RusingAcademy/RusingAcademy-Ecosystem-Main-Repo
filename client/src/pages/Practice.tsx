          ...
          <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    {examTypes.map((exam) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <p className="text-sm text-slate-700 dark:text-[#67E8F9]">{exam.desc}</p>
                          {isSelected && (
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <span className="text-sm text-slate-700">{lvl.passingScore}% {l.passingScore}</span>
                          </div>
                          <p className="text-sm text-slate-700 dark:text-[#67E8F9] mb-3">{lvl.desc}</p>
                          {selectedType && (
            ...
            <div className="space-y-6">
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {[l.tip1, l.tip2, l.tip3, l.tip4].map((tip, i) => (
                      <li key={i} className="flex items-start gap-2 text-sm text-slate-700 dark:text-[#67E8F9]">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-slate-700 dark:text-[#67E8F9] text-center py-4">
                    {l.noResults}
                  </p>
                </CardContent>
              </Card>
