    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-[#0d1020] to-[#080a14] text-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-6 md:px-8 lg:px-12">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 mb-6">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button
                size="lg"
                variant="outline"
                className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 text-white border-white/60 px-8 py-6 text-base font-bold rounded-xl hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 transition-all"
              >
          ...
          >
            {communityStats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60"
              >
      ...
      <section className="relative z-10 max-w-[1280px] mx-auto px-6 pb-8">
        <div className="flex justify-center">
          <div className="inline-flex bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-2xl p-2 border border-white/60">
            {[
                ...
                {events.map((event) => {
                  ...
                  return (
                    <motion.div
                      key={event.id}
                      whileHover={{ y: -5 }}
                      className="group relative p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 hover:border-teal-400/30 transition-all"
                    >
                      {/* Event type badge */}
                      <div 
                      ...
                      {event.maxCapacity && (
                        <div className="absolute bottom-0 left-0 right-0 h-1 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-b-2xl overflow-hidden">
                          <div 
                ...
                {forumCategories.map((category) => {
                  ...
                  return (
                    <Link key={category.id} href={`/community/category/${category.id}`}>                    <motion.div
                      whileHover={{ y: -5 }}
                      className="group p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 hover:border-white/60 transition-all cursor-pointer"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {resources.map((resource) => (
                <motion.div
                  key={resource.id}
                  whileHover={{ y: -5 }}
                  className="group p-6 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 hover:border-white/60 transition-all"
                >
                  <div className="flex items-start gap-4">
                    <div 
                      className="p-3 rounded-xl"
            ...
            >
              <div className="flex items-center justify-between mb-6">
                ...
                <button
                  ...
                  className="p-2 rounded-lg hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 transition-colors"
                >
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 focus:border-teal-400 focus:outline-none text-white placeholder-white/40"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full px-4 py-3 rounded-xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border border-white/60 focus:border-teal-400 focus:outline-none text-white placeholder-white/40 resize-none"
                  />
                </div>
                ...
                <div className="flex gap-3 pt-2">
                  <Button
                    variant="outline"
                    onClick={() => setShowNewThreadModal(false)}
                    className="flex-1 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 border-white/60 text-white hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10"
                  >
