...
function BookHero({ item, language }: { item: LibraryItem; language: string }) {
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24 lg:py-28">
      ...
      />
      <div className="absolute top-1/2 left-1/3 w-[400px] h-[400px] bg-white dark:bg-slate-800 dark:bg-slate-900/[0.02] rounded-full blur-3xl" />
      ...
      <div className="container mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            >
              ...
              <div className="absolute top-3 left-3 flex flex-col gap-2">
                ...
                {item.is_featured && (
                  <Badge className="bg-white dark:bg-slate-800 dark:bg-slate-900/20 backdrop-blur-sm text-white border-0 text-xs font-semibold shadow-md">
          ...
          <motion.div
            ...
            className="flex-1"
          >
            <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/[0.07] backdrop-blur-xl border border-white/10 rounded-2xl p-6 md:p-8 lg:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
              {/* Meta badges */}
              ...
              <div className="flex flex-wrap items-center gap-4 mb-8 text-sm text-white/50">
                ...
                <span className="w-1 h-1 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/30" />
                <span className="flex items-center gap-1.5">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full border-white/20 text-white hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 gap-2 transition-all duration-200"
                  onClick={() => {
                    if (navigator.share) {
                      navigator.share({
                        title: title,
            ...
            >
              {benefits.map((benefit, i) => (
                <motion.li
                  ...
                  className="flex items-start gap-3 p-4 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900 border border-slate-100 hover:border-teal-500/30 hover:shadow-sm transition-all duration-300 group"
                >
...
export default function BookLandingPage() {
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen bg-white dark:bg-slate-800 dark:bg-slate-900">
        {/* Hero */}
