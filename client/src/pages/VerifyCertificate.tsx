  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        {/* Header */}
        <header className="bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-sm border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-4 py-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-black dark:text-white dark:text-white">RusingAcademy</h1>
                <p className="text-sm text-black dark:text-white dark:text-white">Certificate Verification</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-black dark:text-white dark:text-white mb-4">
              Verify Certificate Authenticity
            </h2>
            <p className="text-black dark:text-white dark:text-white mb-8 max-w-2xl mx-auto">
            ...
            <div className="mt-8">
              {isLoading ? (
                <div className="text-center py-12">
                  ...
                  <p className="mt-4 text-black dark:text-white dark:text-white">Verifying certificate...</p>
                </div>
              ) : error ? (
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl overflow-hidden">
                  ...
                  <div className="bg-green-600 text-white px-6 py-4 flex items-center gap-3">
                    <div className="w-10 h-10 bg-white dark:bg-slate-800 dark:bg-slate-900/20 rounded-full flex items-center justify-center">
                  ...
                  <div className="p-8">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <label className="text-sm font-medium text-black dark:text-white dark:text-white uppercase tracking-wide">
                          Certificate Number
                        </label>
                        <p className="text-lg font-mono text-black dark:text-white dark:text-white mt-1">
                          {params.certificateNumber}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-lg text-black dark:text-white dark:text-white mt-1">
                    ...
                    <div className="mt-8 pt-6 border-t border-green-200">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-black dark:text-white dark:text-white">Prof. Steven Rusinga</p>
                          <p className="text-sm text-black dark:text-white dark:text-white">Founder & Lead Instructor, RusingAcademy</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white dark:text-white mb-2">Secure Verification</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white dark:text-white mb-2">Employer Trusted</h3>
              <p className="text-sm text-black dark:text-white dark:text-white">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white dark:text-white mb-2">Permanent Record</h3>
              <p className="text-sm text-black dark:text-white dark:text-white">
