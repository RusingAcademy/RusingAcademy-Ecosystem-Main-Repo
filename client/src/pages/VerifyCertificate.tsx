      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <main className="max-w-4xl mx-auto px-4 py-6 md:py-8 lg:py-12">
          ...
          <div className="text-center mb-6 md:mb-8 lg:mb-12">
            <h2 className="text-lg md:text-2xl lg:text-3xl font-bold text-black dark:text-foreground mb-4">
            ...
            <div className="mt-8">
              {isLoading ? (
                <div className="text-center py-6 md:py-8 lg:py-12">
                  ...
                  <p className="mt-4 text-black dark:text-foreground">Verifying certificate...</p>
                </div>
              ) : error ? (
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl overflow-hidden">
                  ...
                  <div className="p-8">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <label className="text-sm font-medium text-black dark:text-foreground uppercase tracking-wide">
                          Certificate Number
                        </label>
                        <p className="text-lg font-mono text-black dark:text-foreground mt-1">
                          {params.certificateNumber}
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-lg text-black dark:text-foreground mt-1">
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-foreground mb-2">Secure Verification</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-foreground mb-2">Employer Trusted</h3>
              <p className="text-sm text-black dark:text-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-foreground mb-2">Permanent Record</h3>
              <p className="text-sm text-black dark:text-foreground">
