  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        {/* Header */}
        <header className="bg-white dark:bg-slate-900 shadow-sm border-b border-gray-100">
          <div className="max-w-4xl mx-auto px-4 py-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-black dark:text-white">RusingAcademy</h1>
                <p className="text-sm text-black dark:text-white">Certificate Verification</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="max-w-4xl mx-auto px-4 py-6 md:py-8 lg:py-12">
                ...
                <div className="bg-green-50 border border-green-200 rounded-xl overflow-hidden">
                  ...
                  <div className="p-8">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <label className="text-sm font-medium text-black dark:text-white uppercase tracking-wide">
                          Certificate Number
                        </label>
                        <p className="text-lg font-mono text-black dark:text-white mt-1">
                          {params.certificateNumber}
                        </p>
                      </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-green-200">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-medium text-black dark:text-white">Prof. Steven Rusinga</p>
                          <p className="text-sm text-black dark:text-white">Founder & Lead Instructor, RusingAcademy</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white mb-2">Secure Verification</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white mb-2">Employer Trusted</h3>
              <p className="text-sm text-black dark:text-white">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-black dark:text-white mb-2">Permanent Record</h3>
              <p className="text-sm text-black dark:text-white">
