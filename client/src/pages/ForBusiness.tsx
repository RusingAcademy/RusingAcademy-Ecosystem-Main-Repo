    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 via-white to-slate-50 dark:from-teal-950 dark:via-obsidian dark:to-teal-950">      {/* Hero Section */}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative pt-20 pb-24 md:pt-28 md:pb-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-black dark:text-white/90 mb-4 md:mb-6 lg:mb-10 max-w-3xl mx-auto leading-relaxed">
              {t.subtitle}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8 md:mb-12 lg:mb-16">
              ...
              <Button size="lg" variant="outline" className="border-slate-300 dark:border-slate-600 hover:bg-white dark:bg-slate-900 dark:hover:bg-foundation">
            ...
            {t.packages.map((pkg, i) => (
              <Card key={i} className={`relative border-2 ${pkg.popular ? 'border-teal-500 dark:border-teal-400 shadow-xl shadow-teal-500/10' : 'border-slate-200 dark:border-teal-800'} hover:shadow-lg transition-all duration-300`}>
                ...
                <CardHeader className="text-center pb-4">
                  ...
                  <div className="mt-4">
                    <span className="text-xl md:text-3xl lg:text-4xl font-bold text-teal-600 dark:text-teal-400">{pkg.price}</span>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-r from-teal-600 to-emerald-600">
        <div className="container text-center">
          ...
          <Button size="lg" className="bg-white dark:bg-slate-900 text-teal-700 hover:bg-teal-50 shadow-lg hover:shadow-xl transition-all duration-300 px-8">
