          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-black dark:text-foreground">{t.header.title[l]}</span>
              </div>
              {/* Language Toggle */}
              <Button
                variant="outline"
      ...
      <main className="container mx-auto px-4 py-6 md:py-8 lg:py-12 max-w-4xl">
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl shadow-xl border border-slate-200 dark:border-teal-800 overflow-hidden">
          ...
          <div className="p-8 space-y-8">
            ...
            <section>
              <h2 className="text-xl font-bold text-black dark:text-foreground mb-4 flex items-center gap-2">
                <FileText className="w-5 h-5 text-teal-600" />
                {t.s1.title[l]}
              </h2>
              <p className="text-black dark:text-foreground/90 leading-relaxed mb-4">{t.s1.intro[l]}</p>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {t.s2.items[l].map((item, i) => (
                      <div key={i} className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-teal-800/50 rounded-lg">
                        ...
                        <div>
                          <h4 className="font-semibold text-black dark:text-foreground text-sm">{item.title}</h4>
                          <p className="text-xs text-black dark:text-foreground dark:text-cyan-300">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            {([t.s3, t.s4, t.s5, t.s6] as Array<{ title: Record<string, string>; clauses: Record<string, Array<{ id: string; title: string; body: string }>> }>).map((section, si) => (
              <section key={si}>
                ...
                <div className="space-y-3 text-black dark:text-foreground/90">
            ...
            {/* Section 7 — IP */}
            <section>
              <h2 className="text-xl font-bold text-black dark:text-foreground mb-4">{t.s7.title[l]}</h2>
              <p className="text-black dark:text-foreground/90">{t.s7.body[l]}</p>
            </section>

            {/* Section 8 — Modifications */}
            <section>
              <h2 className="text-xl font-bold text-black dark:text-foreground mb-4">{t.s8.title[l]}</h2>
              <p className="text-black dark:text-foreground/90">{t.s8.body[l]}</p>
            </section>

            {/* Section 9 — Governing Law */}
            <section>
              <h2 className="text-xl font-bold text-black dark:text-foreground mb-4">{t.s9.title[l]}</h2>
              <p className="text-black dark:text-foreground/90">{t.s9.body[l]}</p>
            </section>

            {/* Section 10 — Contact */}
            <section>
              <h2 className="text-xl font-bold text-black dark:text-foreground mb-4">{t.s10.title[l]}</h2>
              <div className="text-black dark:text-foreground/90 space-y-2">
                <p>{t.s10.intro[l]}</p>
            ...
            <section className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-700 rounded-xl p-6">
              ...
              <ul className="space-y-2 text-black dark:text-foreground/90">
            ...
            {/* Legal Notice */}
            <div className="text-center text-xs text-black dark:text-foreground dark:text-cyan-300 pt-4 border-t border-slate-200 dark:border-teal-800">
