  ...
  if (isLoading) {
    return (
      <div className="space-y-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-14 bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 rounded-lg animate-pulse" />
        ))}
      </div>
    );
  }
    ...
    return (
      <div className="space-y-2">
        {placeholderModules.map((mod, i) => (
          <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md hover:bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 transition-colors">
      ...
      {course.modules.map((mod: any, index: number) => (
        <div key={mod.id}>
          <button
            ...
            className="w-full flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-white/[0.08] dark:backdrop-blur-md hover:bg-gray-100 dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 transition-colors text-left"
          >
            {mod.thumbnailUrl ? (
          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8">
                <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 backdrop-blur-sm rounded-xl p-4 text-center">
        ...
        <section className="py-8 md:py-12 lg:py-16 bg-orange-50">
          <div className="container">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-2xl p-8 md:p-10 shadow-lg mb-6 md:mb-8 lg:mb-12">
                <p className="text-lg text-foundation leading-relaxed">
                  {isEn 
              ...
              <div className="bg-foundation rounded-2xl p-8 md:p-10 text-white">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {pathDifferentiators.map((diff, index) => (
                    <div key={index} className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <Card className="border-none shadow-xl overflow-hidden">
                  <div className="bg-gradient-to-r from-foundation to-teal-700 p-6 text-white">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-16 h-16 rounded-full bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/20 flex items-center justify-center">
        ...
        <section id="paths-section" className="py-8 pb-16 bg-orange-50">
          <div className="container">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md p-1.5 gap-1 shadow-sm border border-gray-200 dark:border-white/15 dark:border-white/15">
                <button
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                    selectedPath === path.id
                      ...
                      : "bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-foundation hover:bg-cta/10 border border-gray-200"
                  }`}
                >
              ...
              >
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-lg p-4 shadow-sm">
                  ...
                  {/* Learning Outcomes */}
                  <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl p-6 shadow-sm">
                ...
                <div className="lg:col-span-1">
                  <Card className="sticky top-24 shadow-xl border-none overflow-hidden">
                    <div className={`bg-gradient-to-r ${FREE_ACCESS_MODE ? 'from-emerald-500 to-teal-600' : currentPath.color} p-6 text-white text-center`}>
                      ...
                      {!FREE_ACCESS_MODE && (
                        <Badge className="mt-2 bg-white/15 dark:bg-white/[0.08] dark:backdrop-blur-md/20 text-white backdrop-blur-sm">
