          ...
          <div className="container relative z-10">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8">
                <div className="bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm rounded-xl p-4 text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 pt-4">
                ...
                <Link href="/ecosystem">
                  <Button size="lg" variant="outline" className="border-white/60 text-white hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10">
        ...
        <section className="py-16 bg-orange-50">
          <div className="container">
            <div className="max-w-5xl mx-auto">
              ...
              <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-2xl p-8 md:p-10 shadow-lg mb-12">
                <p className="text-lg text-foundation leading-relaxed">
                  {isEn 
              ...
              <div className="bg-foundation rounded-2xl p-8 md:p-10 text-white">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {pathDifferentiators.map((diff, index) => (
                    <div key={index} className="bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm rounded-xl p-6 text-center">
                ...
                <Card className="border-none shadow-xl overflow-hidden">
                  <div className="bg-gradient-to-r from-foundation to-teal-700 p-6 text-white">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-16 h-16 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/20 flex items-center justify-center">
        ...
        <section id="paths-section" className="py-8 pb-16 bg-orange-50">
          <div className="container">
            ...
            <div className="flex justify-center mb-8">
              <div className="inline-flex rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900 p-1.5 gap-1 shadow-sm border border-gray-200 dark:border-slate-700 dark:border-slate-700">
                <button
              ...
              >
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-lg p-4 shadow-sm">
                  ...
                  {/* Learning Outcomes */}
                  <div className="bg-white dark:bg-slate-800 dark:bg-slate-900 rounded-xl p-6 shadow-sm">
                ...
                <div className="lg:col-span-1">
                  <Card className="sticky top-24 shadow-xl border-none overflow-hidden">
                    <div className={`bg-gradient-to-r ${FREE_ACCESS_MODE ? 'from-emerald-500 to-teal-600' : currentPath.color} p-6 text-white text-center`}>
                      ...
                      {!FREE_ACCESS_MODE && (
                        <Badge className="mt-2 bg-white dark:bg-slate-800 dark:bg-slate-900/20 text-white">
