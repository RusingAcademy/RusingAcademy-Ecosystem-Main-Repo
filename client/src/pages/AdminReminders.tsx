              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-black dark:text-foreground">{totalSent}</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-black dark:text-foreground">{openRate}%</p>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-black dark:text-foreground">{clickRate}%</p>
                    <div className="w-full bg-slate-200 dark:bg-teal-800 rounded-full h-2 overflow-hidden">
                      <div 
                        className="h-full bg-teal-800 dark:bg-slate-400 rounded-full transition-all duration-500"
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between">
                  <div className="space-y-3">
                    ...
                    <p className="text-3xl font-bold text-black dark:text-foreground">{totalFailed}</p>
                    <div className="flex items-center gap-1 text-xs text-black dark:text-foreground dark:text-cyan-300">
