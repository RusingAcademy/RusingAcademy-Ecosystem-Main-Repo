          ...
          <div className="container max-w-6xl mx-auto px-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-black dark:text-white dark:text-white">{c.subtitle}</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container max-w-6xl mx-auto px-4">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
                          ...
                          <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                            <CardContent className="p-4">
                              <div className="flex items-start gap-3">
                                ...
                                <ChevronRight className="h-5 w-5 text-black dark:text-white dark:text-white" />
                              </div>
                            </CardContent>
                          </Card>
                        </Link>
                  ...
                  <CardContent className="space-y-6">
                    {c.profile.sections.map((section, index) => (
                      <div key={index} className="border-b pb-6 last:border-0 last:pb-0">
                        ...
                        <p className="text-black dark:text-white dark:text-white">{section.content}</p>
                      </div>
                    ))}
                  </CardContent>
                </Card>
              ...
              <TabsContent value="sessions" className="space-y-6">
                      ...
                      <div key={index}>
                        ...
                        <ul className="space-y-2">
                          {topic.items.map((item, i) => (
                            <li key={i} className="flex items-start gap-2 text-black dark:text-white dark:text-white">
                ...
                <Card className="border-orange-100 bg-amber-50/50 dark:bg-amber-950/20">
                  <CardHeader>
              ...
              <TabsContent value="payments" className="space-y-6">
                        ...
                        <tbody>
                          {c.payments.commission.tiers.map((tier, index) => (
                            <tr key={index} className="border-b last:border-0">
                              ...
                              <td className="py-3 px-4 text-sm text-black dark:text-white dark:text-white">
                                {tier.note}
                              </td>
                            </tr>
                          ))}
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-black dark:text-white dark:text-white">{c.payments.payouts.content}</p>
                    </CardContent>
                  </Card>
                      ...
                      {c.bestPractices.tips.map((tip, index) => (
                        <Card key={index} className="bg-muted/30">
                          <CardContent className="p-4">
                            ...
                            <p className="text-sm text-black dark:text-white dark:text-white">{tip.description}</p>
                          </CardContent>
                        </Card>
                      ))}
                    </div>
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      {c.faq.questions.map((item, index) => (
                        <AccordionItem key={index} value={`item-${index}`}>
                          ...
                          <AccordionContent className="text-black dark:text-white dark:text-white">
                            {item.a}
                          </AccordionContent>
                        </AccordionItem>
                      ))}
