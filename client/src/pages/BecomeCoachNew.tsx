...
export default function BecomeCoachNew() {
  ...
  if (showApplication && isAuthenticated) {
    return (
      <>
        <div className="container py-8 bg-white dark:bg-slate-800 dark:bg-slate-900 min-h-screen">
  ...
  return (
    <>
      <main className="bg-white dark:bg-slate-800 dark:bg-slate-900">
          ...
          <div className="container relative py-16 md:py-24 px-6 md:px-8 lg:px-12 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="max-w-xl">
                {/* Premium Badge */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm border border-emerald-200 shadow-sm mb-6">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black dark:text-white dark:text-white mb-6 leading-[1.1] tracking-tight">
                  {l.heroTitle}
                  <br />
                ...
                <p className="text-lg md:text-xl text-black dark:text-white dark:text-white mb-10 leading-relaxed">
                  {l.heroLead}
                </p>
                ...
                <div className="space-y-3 mb-10">
                  {l.heroBenefits.map((benefit, i) => {
                    ...
                    return (
                      <div 
                        key={i} 
                        className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/60 backdrop-blur-sm border border-white/80 shadow-sm hover:shadow-md hover:bg-white dark:bg-slate-800 dark:bg-slate-900/80 transition-all duration-300"
                      >
                        <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/20">
                          <Icon className="h-5 w-5 text-white" />
                        </div>
                        <span className="text-black dark:text-white dark:text-white font-medium">{benefit.text}</span>
                      </div>
                    );
                  })}
                </div>
                ...
                <p className="text-sm text-black dark:text-white dark:text-white mb-4 italic">
                  {l.heroAudience}
                </p>

                {/* CTA text with emphasis */}
                <p className="text-black dark:text-white dark:text-white font-semibold flex items-center gap-2">
              ...
              <div className="lg:sticky lg:top-24">
                ...
                <div className="relative">
                  ...
                  <Card className="relative bg-white dark:bg-slate-800 dark:bg-slate-900/90 backdrop-blur-xl shadow-2xl shadow-emerald-900/10 border border-white/70 rounded-2xl overflow-hidden">
                    {/* Coach Image */}
                    ...
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-xs text-black dark:text-white dark:text-white mt-4">
        ...
        <section className="py-24 bg-gradient-to-b from-white to-slate-50">
          <div className="container">
            <div className="text-center mb-20">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black dark:text-white dark:text-white mb-4">{l.howItWorksTitle}</h2>
              <p className="text-lg text-black dark:text-white dark:text-white max-w-2xl mx-auto">{l.howItWorksSubtitle}</p>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
              {l.steps.map((step, i) => (
                ...
                >
                  ...
                  <div className="p-6 md:p-8 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:border-emerald-100 transition-all duration-300">
                    <h3 className="text-2xl font-bold text-black dark:text-white dark:text-white mb-3">{step.title}</h3>
                    <p className="text-black dark:text-white dark:text-white mb-6 leading-relaxed text-lg">{step.description}</p>
        ...
        <section className="py-24 relative overflow-hidden" style={{background: 'linear-gradient(180deg, #f8fafc 0%, #f1f5f9 100%)'}}>
          ...
          <div className="container relative">
            <div className="text-center mb-16">
              <Badge className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-emerald-700 border-emerald-200 shadow-sm mb-4">
                <Award className="h-3 w-3 mr-1" />
                {isEn ? "Join Our Team" : "Rejoignez Notre Équipe"}
              </Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black dark:text-white dark:text-white mb-4">{l.requirementsTitle}</h2>
              <p className="text-lg text-black dark:text-white dark:text-white max-w-2xl mx-auto">{l.requirementsSubtitle}</p>
            </div>

            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* Qualifications */}
              <Card className="group border-0 shadow-xl shadow-slate-200/50 bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-5">{l.qualifications.title}</h3>
                  <ul className="space-y-4">
                    {l.qualifications.items.map((item, i) => (
                      <li key={i} className="flex items-start gap-3">
                        ...
                        <span className="text-black dark:text-white dark:text-white">{item}</span>
                      </li>
                    ))}
                  </ul>
                </CardContent>
              ...
              <Card className="group border-0 shadow-xl shadow-slate-200/50 bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-5">{l.contentNeeded.title}</h3>
                  <ul className="space-y-4">
              ...
              <Card className="group border-0 shadow-xl shadow-slate-200/50 bg-white dark:bg-slate-800 dark:bg-slate-900/80 backdrop-blur-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 rounded-2xl overflow-hidden">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-xl font-bold text-black dark:text-white dark:text-white mb-5">{l.timeline.title}</h3>
                  <ul className="space-y-4">
        ...
        <section className="py-24 bg-gradient-to-br from-obsidian via-teal-900 to-emerald-900 relative overflow-hidden">
          ...
          <div className="container relative">
            <div className="text-center mb-16">
              <Badge className="mb-4 bg-white dark:bg-slate-800 dark:bg-slate-900/10 text-emerald-300 border-emerald-500/30 backdrop-blur-sm">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              {l.safetyItems.map((item, i) => {
                ...
                return (
                  <div key={i} className="group text-center p-8 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/5 backdrop-blur-sm border border-white/60 hover:bg-white dark:bg-slate-800 dark:bg-slate-900/10 hover:border-white/60 transition-all duration-300">
        ...
        <section className="py-24 bg-white dark:bg-slate-800 dark:bg-slate-900 relative">
          <div className="container">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-black dark:text-white dark:text-white">{l.whyJoinTitle}</h2>
              <p className="text-lg text-black dark:text-white dark:text-white max-w-2xl mx-auto">{l.whyJoinSubtitle}</p>
            </div>
                ...
                return (
                  <Card key={i} className={`group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 shadow-lg rounded-2xl overflow-hidden ${bgColors[i]}`}>
                    <CardContent className="p-8">
                      ...
                      <h3 className="font-bold text-xl mb-3 text-black dark:text-white dark:text-white">{benefit.title}</h3>
                      <p className="text-black dark:text-white dark:text-white leading-relaxed">{benefit.description}</p>
                    </CardContent>
                  </Card>
                );
              })}
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-black dark:text-white dark:text-white">{l.earningTitle}</h2>
                  <p className="text-lg text-black dark:text-white dark:text-white mb-8 leading-relaxed">{l.earningSubtitle}</p>
                  ...
                  <div className="space-y-5">
                    {l.earningFeatures.map((feature, i) => {
                      ...
                      const Icon = icons[i];
                      return (
                        <div key={i} className="flex items-center gap-4 p-4 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900 shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl transition-shadow duration-300">
                          <div className={`h-12 w-12 rounded-xl bg-gradient-to-br ${gradients[i]} flex items-center justify-center shadow-lg`}>
                            <Icon className="h-6 w-6 text-white" />
                          </div>
                          <div>
                            <div className="font-bold text-black dark:text-white dark:text-white">{feature.title}</div>
                            <div className="text-sm text-black dark:text-white dark:text-white">{feature.subtitle}</div>
                          </div>
                        </div>
                      );
                    })}
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-emerald-900 via-teal-800 to-obsidian rounded-3xl p-10 text-white shadow-2xl">
                    <div className="flex items-center gap-3 mb-8">
                      <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-800 dark:bg-slate-900/10 flex items-center justify-center">
        ...
        <section className="py-24 bg-gradient-to-b from-white to-slate-50 relative">
          <div className="container">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-black dark:text-white dark:text-white">{l.testimonialsTitle}</h2>
            </div>

            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {l.coachTestimonials.map((testimonial, i) => (
                <Card key={i} className="group border-0 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 rounded-2xl overflow-hidden bg-white dark:bg-slate-800 dark:bg-slate-900">
                  <CardContent className="p-8">
                    {/* Quote icon */}
                    <div className="mb-6">
                    ...
                    {/* Quote */}
                    <p className="text-black dark:text-white dark:text-white mb-8 text-lg leading-relaxed">"{testimonial.quote}"</p>
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                      ...
                      <div>
                        <div className="font-bold text-black dark:text-white dark:text-white">{testimonial.name}</div>
        ...
        <section className="py-24 bg-white dark:bg-slate-800 dark:bg-slate-900">
          <div className="container">
            <div className="text-center mb-16">
              <Badge className="mb-4 bg-white dark:bg-slate-800 dark:bg-slate-900 text-emerald-700 border-emerald-200 shadow-sm">
                <HelpCircle className="h-3 w-3 mr-1" />
                {isEn ? "FAQ" : "FAQ"}
              </Badge>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black dark:text-white dark:text-white mb-4">{l.faqTitle}</h2>
            </div>
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between gap-4">
                      <h3 className="font-bold text-black dark:text-white dark:text-white text-lg">{faq.q}</h3>
                      <div className={cn(
                    ...
                    {expandedFaq === i && (
                      <p className="text-black dark:text-white dark:text-white mt-4 leading-relaxed text-lg border-t border-slate-100 pt-4">{faq.a}</p>
                    )}
                  </CardContent>
                </Card>
              ))}
        ...
        <section className="relative py-20 bg-gradient-to-br from-teal-900 via-teal-800 to-obsidian text-white overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              {!isAuthenticated ? (
                <a href={getSignupUrl()}>
                  <Button size="lg" className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-teal-700 hover:bg-teal-50 shadow-xl gap-2 w-full sm:w-auto">
                    {l.ctaLoginButton}
                ...
                <Button
                  size="lg"
                  className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-teal-700 hover:bg-teal-50 shadow-xl gap-2"
