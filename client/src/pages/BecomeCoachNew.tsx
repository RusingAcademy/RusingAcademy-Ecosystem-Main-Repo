  ...
  return (
    <>
      <main className="bg-white dark:bg-slate-900">
          ...
          <div className="container relative py-16 md:py-24 px-6 md:px-8 lg:px-12 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div className="max-w-xl">
                ...
                <p className="text-lg md:text-xl text-black dark:text-white mb-4 md:mb-6 lg:mb-10 leading-relaxed">
                  {l.heroLead}
                </p>
        ...
        <section className="py-12 md:py-16 lg:py-24 bg-white dark:bg-slate-900 relative">
          <div className="container">
            <div className="text-center mb-8 md:mb-12 lg:mb-16">
        ...
        <section className="py-12 md:py-16 lg:py-24 bg-white dark:bg-slate-900">
          <div className="container">
            <div className="text-center mb-8 md:mb-12 lg:mb-16">
