                ...
                <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-xl font-semibold text-black dark:text-foreground">Mon Profil</h1>
                        </div>
                        ...
                        <Card className="bg-white dark:bg-background shadow-sm border-slate-200">
                            <CardContent className="pt-6">
                                <div className="flex flex-col items-center text-center">
                                    ...
                                    <div className="flex items-center gap-2 mt-3 text-sm text-black dark:text-foreground">
                                ...
                                <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100">
                                    <div className="text-center">
                                        ...
                                        <p className="text-2xl font-bold text-black dark:text-foreground">0</p>
                                        <p className="text-xs text-black dark:text-foreground">Cours</p>
                                    </div>
                                    <div className="text-center">
                                        ...
                                        <p className="text-2xl font-bold text-black dark:text-foreground">0</p>
                                        <p className="text-xs text-black dark:text-foreground">Sessions</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white dark:bg-background shadow-sm border-slate-200 mt-6">
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs text-black dark:text-foreground">Nom complet</p>
                                        <p className="text-sm font-medium text-black dark:text-foreground">{user.fullName || "Non défini"}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Mail className="h-4 w-4 text-cyan-300" />
                                    <div>
                                        <p className="text-xs text-black dark:text-foreground">Email</p>
                                        <p className="text-sm font-medium text-black dark:text-foreground">{user.emailAddresses[0]?.emailAddress}</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    <Calendar className="h-4 w-4 text-cyan-300" />
                                    <div>
                                        <p className="text-xs text-black dark:text-foreground">Date d'inscription</p>
