...
const StatCard = ({ title, value, icon }: { title: string; value: string | number; icon: string }) => (
  <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl border border-gray-200 dark:border-white/15 dark:border-white/15 p-6 shadow-sm">
...
const SessionCard = ({ session }: { session: Session }) => {
  ...
  return (
    <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md rounded-xl border border-gray-200 dark:border-white/15 dark:border-white/15 p-6 hover:shadow-md transition-shadow">
      ...
      <div className="mt-4 flex space-x-3">
        ...
        <button className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 dark:text-muted-foreground rounded-lg hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md text-sm font-medium">
          Notes
        </button>
      </div>
    </div>
  ...
  return (
    <PortalLayout>
      <div className="min-h-screen bg-white dark:bg-white/[0.08] dark:backdrop-blur-md">
        <div className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md border-b border-gray-200 dark:border-white/15 dark:border-white/15">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 lg:px-8 py-8">
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900 dark:text-foreground mb-4">Sessions Aujourd'hui</h2>
