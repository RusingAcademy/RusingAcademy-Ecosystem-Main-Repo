...
const StatCard = ({ title, value, icon }: { title: string; value: string | number; icon: string }) => (
  <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-6 shadow-sm">
...
const SessionCard = ({ session }: { session: Session }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 dark:border-slate-700 p-6 hover:shadow-md transition-shadow">
      ...
      <div className="mt-4 flex space-x-3">
        ...
        <button className="flex-1 px-4 py-2 border border-gray-300 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-white dark:bg-slate-900 text-sm font-medium">
          Notes
        </button>
      </div>
    </div>
  ...
  return (
    <PortalLayout>
      <div className="min-h-screen bg-white dark:bg-slate-900">
        <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700 dark:border-slate-700">
