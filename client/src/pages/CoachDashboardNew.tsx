...
const StatCard = ({ title, value, icon }: { title: string; value: string | number; icon: string }) => (
  <div className="bg-white dark:bg-background rounded-xl border border-gray-200 dark:border-border dark:border-border p-6 shadow-sm">
...
const SessionCard = ({ session }: { session: Session }) => {
  ...
  return (
    <div className="bg-white dark:bg-background rounded-xl border border-gray-200 dark:border-border dark:border-border p-6 hover:shadow-md transition-shadow">
  ...
  return (
    <PortalLayout>
      <div className="min-h-screen bg-white dark:bg-background">
        <div className="bg-white dark:bg-background border-b border-gray-200 dark:border-border dark:border-border">
