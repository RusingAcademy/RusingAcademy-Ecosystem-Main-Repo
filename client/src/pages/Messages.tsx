        ...
        <main className="container mx-auto px-4 py-16">
          <Card className="max-w-md mx-auto">
            <CardContent className="p-8 text-center">
              <MessageSquare className="h-12 w-12 mx-auto mb-4 text-black dark:text-white dark:text-white" />
            ...
            <div className="flex h-[600px]">
              ...
              <div className={cn(
                ...
                <div className="p-4 border-b space-y-3">
                  <div className="relative">
                    <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-black dark:text-white dark:text-white" />
                    <Input
                ...
                <ScrollArea className="flex-1">
                  {conversationsLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-8 text-black dark:text-white dark:text-white">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between gap-2">
                                ...
                                <span className="text-xs text-black dark:text-white dark:text-white whitespace-nowrap">
                                  {formatMessageDate(new Date(conv.lastMessageAt))}
                                </span>
                              </div>
                              <div className="flex items-center justify-between gap-2 mt-0.5">
                                <p className="text-sm text-black dark:text-white dark:text-white truncate">
                                  {conv.lastMessage}
                                </p>
                                {conv.unreadCount > 0 && (
              ...
              <div className={cn(
                ...
                {selectedConversation ? (
                  <>
                    ...
                    {showSearch && (
                      <div className="p-3 border-b bg-muted/30">
                        ...
                        {messageSearchQuery && (
                          <p className="text-xs text-black dark:text-white dark:text-white mt-2">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div className={cn(
                                    ...
                                    <span className={cn(
                                      "text-xs",
                                      isOwn ? "text-primary-foreground/70" : "text-black dark:text-white dark:text-white"
                                    )}>
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-black dark:text-white dark:text-white">
