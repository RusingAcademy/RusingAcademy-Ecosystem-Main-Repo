...
const categories = [
  { name: "Tutoring Sessions", color: "var(--brand-teal, var(--teal))" },
  { name: "Events", color: "var(--semantic-success, var(--success))" },
  { name: "Deadlines", color: "var(--semantic-danger, var(--danger))" },
  { name: "Holidays", color: "var(--semantic-warning, var(--warning))" },
];
      ...
      <div className="max-w-[1200px]">
        ...
        <div className="glass-card rounded-xl overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <button aria-label="Action" onClick={prevMonth} className="p-1 hover:bg-gray-100 dark:bg-slate-800 rounded">
              <span className="material-icons text-gray-500">chevron_left</span>
            </button>
            <h2 className="text-lg font-medium text-gray-800">
              {MONTHS[month]} {year}
            </h2>
            <button aria-label="Action" onClick={nextMonth} className="p-1 hover:bg-gray-100 dark:bg-slate-800 rounded">
