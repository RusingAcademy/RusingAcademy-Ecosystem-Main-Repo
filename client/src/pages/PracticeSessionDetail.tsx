      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            <Link href="/practice-history">
              <Button variant="ghost" className="text-white hover:bg-white dark:bg-background/10">
          ...
          <Button
            variant="outline"
            className="border-white/60 text-white hover:bg-white dark:bg-background/10"
        ...
        {/* Session Info Card */}
        <Card className="bg-white dark:bg-background/5 border-white/60 mb-6">
          <CardContent className="p-6">
            ...
            {stats.avgScore > 0 && (
              <div className="mt-4">
                ...
                <Progress value={stats.avgScore} className="h-2 bg-white dark:bg-background/10" />
              </div>
            )}
          </CardContent>
        </Card>
