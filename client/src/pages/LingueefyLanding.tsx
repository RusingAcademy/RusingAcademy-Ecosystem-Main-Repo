        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              <span className="text-black dark:text-foreground">{c.hero.title}</span>
              <br />
            ...
            <p className="text-lg md:text-xl text-black dark:text-foreground mb-4 md:mb-6 lg:mb-10 max-w-2xl mx-auto leading-relaxed">
              {c.hero.description}
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl mx-auto">
              {c.hero.stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-sm text-black dark:text-foreground">{stat.label}</div>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-foreground mb-4">{c.learningPath.title}</h2>
            <p className="text-xl text-black dark:text-foreground max-w-2xl mx-auto">{c.learningPath.subtitle}</p>
          </div>
          ...
          <div className="max-w-5xl mx-auto mb-8 md:mb-12 lg:mb-16">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white dark:bg-background rounded-3xl p-8 border-2 border-slate-200 hover:border-teal-400 transition-all duration-300 hover:shadow-xl group">
                ...
                <h3 className="text-2xl font-bold text-black dark:text-foreground mb-3">{c.learningPath.marketplace.title}</h3>
                <p className="text-black dark:text-foreground mb-6">{c.learningPath.marketplace.description}</p>
                <ul className="space-y-3 mb-8">
                  {c.learningPath.marketplace.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-3 text-black dark:text-foreground">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-50/50 rounded-3xl p-8 border-2 border-orange-100 hover:border-cta-2 transition-all duration-300 hover:shadow-xl group relative">
                ...
                <h3 className="text-2xl font-bold text-black dark:text-foreground mb-3">{c.learningPath.plans.title}</h3>
                <p className="text-black dark:text-foreground mb-6">{c.learningPath.plans.description}</p>
                <ul className="space-y-3 mb-8">
          ...
          <div id="pricing-plans" className="max-w-6xl mx-auto">
            <div className="text-center mb-6 md:mb-8 lg:mb-12">
              <h3 className="text-2xl md:text-3xl font-bold text-black dark:text-foreground mb-3">{c.learningPath.pricing.title}</h3>
              <p className="text-lg text-black dark:text-foreground">{c.learningPath.pricing.subtitle}</p>
            </div>
              ...
              {c.learningPath.pricing.plans.map((plan, index) => (
                ...
                >
                  ...
                  <CardContent className="p-8">
                    <h4 className="text-xl font-bold text-black dark:text-foreground mb-2">{plan.name}</h4>
                    <p className="text-black dark:text-foreground text-sm mb-6">{plan.description}</p>
                    
                    <div className="mb-6">
                      <span className="text-xl md:text-3xl lg:text-4xl font-bold text-black dark:text-foreground">{plan.price}</span>
                      <span className="text-black dark:text-foreground ml-2">{plan.period}</span>
                    </div>
                    
                    <ul className="space-y-3 mb-8">
                      {plan.features.map((feature, i) => (
                        <li key={i} className="flex items-start gap-3 text-black dark:text-foreground text-sm">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-slate-50 via-white to-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-foreground mb-4">{c.transformation.title}</h2>
            <p className="text-xl text-black dark:text-foreground max-w-2xl mx-auto">{c.transformation.subtitle}</p>
          </div>
                ...
                <div className="space-y-6">
                  {c.transformation.before.items.map((item, index) => (
                    <div key={index} className="flex items-center gap-4 group">
                      ...
                      <span className="text-lg text-black dark:text-foreground font-medium">{item.text}</span>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  >
                    <CardContent className="p-8">
                      ...
                      <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-2 text-black dark:text-foreground text-sm">
                      ...
                      <h3 className="text-2xl font-bold text-black dark:text-foreground mb-3">{level.name}</h3>
                      <p className="text-black dark:text-foreground mb-6 leading-relaxed">{level.description}</p>
                      
                      {/* Skills List */}
                      <div className="space-y-3 mb-8">
                        <p className="text-sm font-semibold text-black dark:text-foreground uppercase tracking-wider">You'll master:</p>
                        {level.skills.map((skill, i) => (
                          <div key={i} className="flex items-start gap-3">
                            <CheckCircle className={`w-5 h-5 ${colors.check} flex-shrink-0 mt-0.5`} />
                            <span className="text-black dark:text-foreground text-sm">{skill}</span>
                          </div>
                        ))}
                      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 lg:mb-12">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-foreground mb-2">{c.coaches.title}</h2>
              <p className="text-xl text-black dark:text-foreground">{c.coaches.subtitle}</p>
            </div>
            <Link href="/coaches">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="w-10 h-10 bg-white dark:bg-background/90 rounded-full flex items-center justify-center hover:bg-white dark:bg-background transition-colors">
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-black dark:text-foreground">{coach.rating}</span>
                        <span className="text-black dark:text-foreground">({coach.reviews} reviews)</span>
                      </div>
                      <div className="text-right">
                        <span className="text-2xl font-bold text-black dark:text-foreground">${coach.price}</span>
                        <span className="text-black dark:text-foreground">/hr</span>
                      </div>
                    </div>
      ...
      <section className="py-20 md:py-28 bg-white dark:bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-foreground mb-4">{c.services.title}</h2>
            <p className="text-xl text-black dark:text-foreground">{c.services.subtitle}</p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className="p-8">
                    ...
                    <h3 className="text-2xl font-semibold text-black dark:text-foreground mb-3">{service.title}</h3>
                    <p className="text-black dark:text-foreground mb-6">{service.description}</p>
                    <ul className="space-y-3">
                      {service.features.map((feature, i) => (
                        <li key={i} className="flex items-center text-black dark:text-foreground">
      ...
      <section className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12 lg:mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-black dark:text-foreground mb-4">{c.testimonials.title}</h2>
            <p className="text-xl text-black dark:text-foreground">{c.testimonials.subtitle}</p>
          </div>
            ...
            {c.testimonials.items.map((testimonial, index) => (
              ...
              >
                <CardContent className="p-8">
                  ...
                  {/* Quote */}
                  <p className="text-black dark:text-foreground mb-6 italic leading-relaxed">"{testimonial.quote}"</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <div className="font-semibold text-black dark:text-foreground">{testimonial.name}</div>
            ...
            {c.faq.items.map((item, index) => (
              <Card key={index} className="border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                <CardContent className="p-0">
                  ...
                  >
                    <span className="font-semibold text-black dark:text-foreground pr-4">{item.question}</span>
                    <ChevronDown 
                      className={`w-5 h-5 text-black dark:text-foreground transition-transform flex-shrink-0 ${
                        openFaq === index ? 'rotate-180' : ''
                      }`} 
                    />
                  </button>
                  {openFaq === index && (
                    <div className="px-6 pb-6 text-black dark:text-foreground leading-relaxed">
                      {item.answer}
                    </div>
                  )}
                </CardContent>
