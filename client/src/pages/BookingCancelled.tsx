        ...
        <div className="container max-w-lg mx-auto px-4">
          <Card className="text-center">
            <CardContent className="pt-8 pb-8">
              ...
              <p className="text-lg text-black dark:text-foreground mb-2">{l.subtitle}</p>
              <p className="text-black dark:text-foreground mb-8">{l.description}</p>
              ...
              <div className="border-t pt-6">
                <div className="flex items-center justify-center gap-2 text-black dark:text-foreground mb-3">
                  <HelpCircle className="h-4 w-4" />
                  <span className="font-medium">{l.needHelp}</span>
                </div>
                <p className="text-sm text-black dark:text-foreground mb-4">{l.helpText}</p>
                <Link href="/contact">
