    ...
    <div className="min-h-full animate-pulse">
      ...
      <div className="bg-gradient-to-br from-foundation via-teal-700 to-foundation px-6 py-12">
        <div className="max-w-4xl mx-auto">
          <Skeleton className="w-full h-48 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/10 mb-6" />
          <Skeleton className="h-8 w-2/3 bg-white dark:bg-slate-800 dark:bg-slate-900/10 mb-3" />
          <Skeleton className="h-4 w-1/2 bg-white dark:bg-slate-800 dark:bg-slate-900/10 mb-6" />
          <Skeleton className="h-10 w-40 bg-white dark:bg-slate-800 dark:bg-slate-900/10 rounded-lg" />
        </div>
      </div>
      {/* Content skeleton */}
          ...
          {course.thumbnailUrl || (course as any).heroImageUrl ? (
            ...
            <div className="bg-gradient-to-br from-foundation via-teal-700 to-foundation relative">
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white dark:bg-slate-800 dark:bg-slate-900/5 rounded-full blur-2xl" />
              </div>
  ...
  return (
    <>
      ...
      >
        ...
        {!course.thumbnailUrl && !(course as any).heroImageUrl && (
          <div className="flex-shrink-0">
            <div className="w-20 h-20 rounded-2xl bg-white dark:bg-slate-800 dark:bg-slate-900/10 backdrop-blur-sm ring-2 ring-white/20 flex items-center justify-center shadow-xl">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            <Badge className="bg-white dark:bg-slate-800 dark:bg-slate-900/15 text-white border-white/60 backdrop-blur-sm text-xs">
      ...
      >
        ...
        {isAuthenticated && hasStarted && (
          <>
            <Separator orientation="vertical" className="h-4 bg-white dark:bg-slate-800 dark:bg-slate-900/20" />
            <span className="flex items-center gap-1.5">
      ...
      >
        {isAuthenticated && resumeTarget ? (
          ...
          <Button
            size="lg"
            className="bg-white dark:bg-slate-800 dark:bg-slate-900 text-foundation hover:bg-white dark:bg-slate-800 dark:bg-slate-900/90 shadow-lg shadow-white/25"
