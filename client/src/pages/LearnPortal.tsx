    ...
    <TooltipProvider delayDuration={200}>
      <div className="flex items-center gap-0.5 mt-1.5">
        ...
        {lessonActivities.filter((a: any) => a.slotIndex > 7).length > 0 && (
          <div className="w-6 h-6 rounded-md bg-slate-100 dark:bg-white/[0.08] dark:backdrop-blur-md flex items-center justify-center text-[10px] font-bold text-muted-foreground">
    ...
    <div className="min-h-full animate-pulse">
      ...
      <div className="bg-gradient-to-br from-foundation via-teal-700 to-foundation px-6 py-6 md:py-8 lg:py-12">
        <div className="max-w-4xl mx-auto">
          <Skeleton className="w-full h-48 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 mb-6" />
          <Skeleton className="h-8 w-2/3 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 mb-3" />
          <Skeleton className="h-4 w-1/2 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 mb-6" />
          <Skeleton className="h-10 w-40 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 rounded-lg" />
        </div>
      </div>
      {/* Content skeleton */}
          ...
          {course.thumbnailUrl || (course as any).heroImageUrl ? (
            ...
            <div className="bg-gradient-to-br from-foundation via-teal-700 to-foundation relative">
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/5 rounded-full blur-2xl" />
              </div>
  ...
  return (
    <>
      ...
      >
        ...
        {!course.thumbnailUrl && !(course as any).heroImageUrl && (
          <div className="flex-shrink-0">
            <div className="w-20 h-20 rounded-2xl bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/10 backdrop-blur-sm ring-2 ring-white/20 flex items-center justify-center shadow-xl">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            <Badge className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/15 text-white border-white/60 backdrop-blur-sm text-xs">
      ...
      >
        ...
        {isAuthenticated && hasStarted && (
          <>
            <Separator orientation="vertical" className="h-4 bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/20" />
            <span className="flex items-center gap-1.5">
      ...
      >
        {isAuthenticated && resumeTarget ? (
            ...
            <Button
              ...
              className={`shadow-lg transition-all hover:shadow-xl ${
                isComplete
                  ...
                  : "bg-white dark:bg-white/[0.08] dark:backdrop-blur-md dark:border-white/15 text-foundation hover:bg-white/90 shadow-white/25 hover:shadow-white/30"
              }`}
              onClick={() =>
          ...
          <Button
            size="lg"
            className="bg-white dark:bg-white/[0.08] dark:backdrop-blur-md text-foundation hover:bg-white dark:bg-white/[0.08] dark:backdrop-blur-md/90 shadow-lg shadow-white/25"
