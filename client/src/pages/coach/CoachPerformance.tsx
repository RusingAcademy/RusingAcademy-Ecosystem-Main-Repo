      ...
      <div className="max-w-7xl mx-auto" role="main" aria-label={lang === "fr" ? "Performance du coach" : "Coach Performance"}>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            ...
            <MetricRing value={totalStudents > 0 ? Math.min(Math.round((totalStudents / (totalStudents + 2)) * 100), 100) : 0} label={lang === "fr" ? "Rétention" : "Retention"} color="#2563eb" loading={isLoading} />
            <MetricRing value={avgRating > 0 ? Math.round(avgRating * 20) : 0} label={lang === "fr" ? "Note globale" : "Overall Rating"} color="#d97706" loading={isLoading} />
          </div>
        </div>
