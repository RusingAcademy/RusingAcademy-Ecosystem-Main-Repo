  ...
  return (
    <CoachLayout>
      <div className="max-w-7xl mx-auto" role="main" aria-label={lang === "fr" ? "Performance du coach" : "Coach Performance"}>
        ...
        {/* Performance Rings */}
        <div className="bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-6 mb-6">
          ...
          <div className="bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-5">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.label} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-background rounded-lg">
                  ...
                  {isLoading ? (
                    <div className="h-6 w-16 bg-gray-100 dark:bg-card rounded animate-pulse" />
                  ) : (
          ...
          <div className="bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-5">
            ...
            {learnersQuery.isLoading ? (
              <div className="space-y-3">
                {[1, 2, 3, 4].map((i) => <div key={i} className="h-14 bg-gray-50 dark:bg-background rounded-lg animate-pulse" />)}
              </div>
            ) : learners.length === 0 ? (
              ...
              <div className="space-y-3">
                {learners.slice(0, 6).map((learner: any, i: number) => {
                  ...
                  return (
                    <div key={learner.id || i} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-background rounded-lg">
        ...
        <div className="mt-6 bg-white dark:bg-background rounded-xl border border-gray-100 dark:border-border p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              <div key={h.label} className="text-center p-4 bg-gray-50 dark:bg-background rounded-lg">
                {isLoading ? (
                  <div className="h-8 w-16 mx-auto bg-gray-100 dark:bg-card rounded animate-pulse" />
                ) : (
