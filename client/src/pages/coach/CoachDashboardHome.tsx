            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                <Link key={action.label} href={action.href}>
                  <button className="w-full flex flex-col items-center gap-2 p-4 bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-700 hover:shadow-md transition-all group">
