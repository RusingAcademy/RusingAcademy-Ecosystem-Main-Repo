          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              <input type="text" value={search} onChange={e => setSearch(e.target.value)}
                ...
                className="pl-9 pr-4 py-2 text-sm border border-gray-200 dark:border-slate-700 rounded-lg focus:ring-2 focus:ring-[var(--color-violet-600, var(--color-violet-600, #7c3aed))]/20 focus:border-violet-600 outline-none w-48" />
            </div>
          </div>
        </div>
