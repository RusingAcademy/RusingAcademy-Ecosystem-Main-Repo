      ...
      <div className="max-w-7xl mx-auto" role="main" aria-label={lang === "fr" ? "Revenus du coach" : "Coach Revenue"}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          {[
            ...
            <div key={kpi.label} className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 p-5 hover:shadow-md transition-shadow">
                    ...
                    <tbody>
                      {ledger.map((entry: any, i: number) => (
                        <tr key={entry.id || i} className="border-b border-gray-50 last:border-0 hover:bg-gray-50">
                          ...
                          <td className="py-3 text-sm text-gray-700 capitalize">{entry.transactionType || entry.type || "—"}</td>
