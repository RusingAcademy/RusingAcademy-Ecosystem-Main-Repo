    ...
    <div className="bg-white rounded-xl border border-gray-100 p-5">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-1">
          <button aria-label="Action" onClick={prevMonth} className="p-1 hover:bg-gray-100 rounded"><span className="material-icons text-lg text-gray-500">chevron_left</span></button>
          <button aria-label="Action" onClick={nextMonth} className="p-1 hover:bg-gray-100 rounded"><span className="material-icons text-lg text-gray-500">chevron_right</span></button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            ...
            {isLoading ? (
              ...
              <div className="text-center py-6 md:py-8 lg:py-12 bg-white rounded-xl border border-gray-100">
