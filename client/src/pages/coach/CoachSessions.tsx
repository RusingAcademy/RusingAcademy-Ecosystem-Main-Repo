    ...
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-700 p-5">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-1">
          <button aria-label="Action" onClick={prevMonth} className="p-1 hover:bg-gray-100 dark:bg-slate-800 rounded"><span className="material-icons text-lg text-gray-500">chevron_left</span></button>
          <button aria-label="Action" onClick={nextMonth} className="p-1 hover:bg-gray-100 dark:bg-slate-800 rounded"><span className="material-icons text-lg text-gray-500">chevron_right</span></button>
        </div>
      </div>
            ...
            {isLoading ? (
              ...
              <div className="space-y-3">
                {filtered.map((session: any) => {
                  ...
                  return (
                    <div key={session.id} className="bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-700 p-4 hover:shadow-md transition-shadow flex items-center gap-4">
